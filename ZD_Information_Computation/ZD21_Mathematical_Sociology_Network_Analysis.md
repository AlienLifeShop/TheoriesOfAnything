# ZD21 — Mathematical Sociology and Network Analysis
...
> **Cross-References:** [V45 — Mathematical Economics](../V_Mathematics_Information/V45_Mathematical_Economics.md) · [ZD02 — Information Theory](V06_Information_Theory.md) · [ZD19 — Game of Life](V60_Conway_Game_of_Life_Recreational_Math.md) · [T08 — Behavioral Psychology](../T_Psychology_Social/T08_Psychology_Belief_Conspiracy.md) · [ZB33 — Biological Networks](../ZB_Ecology_Biology/ZB33_Biological_Networks_Systems_Biology.md)
...
- **[V45 — Mathematical Economics](../V_Mathematics_Information/V45_Mathematical_Economics.md):** Game theory, mechanism design, and market networks
- **[ZD02 — Information Theory](V06_Information_Theory.md):** Information flow and entropy in network structures
- **[ZD19 — Game of Life](V60_Conway_Game_of_Life_Recreational_Math.md):** Complex behavior from simple rules — network automata
- **[T08 — Behavioral Psychology](../T_Psychology_Social/T08_Psychology_Belief_Conspiracy.md):** Individual behavior in social contexts
- **[ZB33 — Biological Networks](../ZB_Ecology_Biology/ZB33_Biological_Networks_Systems_Biology.md):** Shared network mathematics across biological and social systems
- **[V46 — Nonlinear Dynamics](../V_Mathematics_Information/V46_Nonlinear_Dynamics_Bifurcation.md):** Cascades, tipping points, and phase transitions in social systems
