# ZD19 — Conway's Game of Life and Recreational Mathematics
...
> **Cross-References:** [ZD02 — Information Theory](V06_Information_Theory.md) · [ZD18 — Lambda Calculus](V59_Lambda_Calculus_Functional_Programming.md) · K03 — Emergence · [V46 — Nonlinear Dynamics](../V_Mathematics_Information/V46_Nonlinear_Dynamics_Bifurcation.md) · [ZB33 — Biological Networks](../ZB_Ecology_Biology/ZB33_Biological_Networks_Systems_Biology.md)
> **Reliability Tier:** Tier 1 (well-documented, peer-reviewed)
> **Last Updated:** Mar 07, 2026 | **Source Count:** 10 | **Weighted Score:** 15 | **Source Confidence:** [2/5] | **Confidence:** High (well-documented, peer-reviewed)
...
- **Rules (B3/S23):** Birth rule: dead cell with exactly 3 live neighbors becomes alive; survival rule: live cell with 2 or 3 live neighbors survives; death: all other live cells die (underpopulation if <2, overpopulation if >3); deterministic, synchronous updating; Conway selected rules specifically to make behavior unpredictable — tried many rule sets before settling on B3/S23
...
2. Berlekamp, E. R., Conway, J. H., & Guy, R. K. (2001). *Winning Ways for Your Mathematical Plays*, 2nd ed. A K Peters.
3. Wolfram, S. (2002). *A New Kind of Science*. Wolfram Media.
4. Rendell, P. (2011). "A Universal Turing Machine in Conway's Game of Life." *Proceedings of the 2011 International Conference on High Performance Computing & Simulation*, 764–772.
...
8. Hales, T. (2005). "A Proof of the Kepler Conjecture." *Annals of Mathematics*, 162(3), 1065–1185.
...
- **[ZD02 — Information Theory](V06_Information_Theory.md):** Computational universality and information processing in CAs
- **[ZD18 — Lambda Calculus](V59_Lambda_Calculus_Functional_Programming.md):** Equivalent models of computation — CAs are Turing-complete
- **K03 — Emergence:** Game of Life as paradigmatic example of emergence
- **[V46 — Nonlinear Dynamics](../V_Mathematics_Information/V46_Nonlinear_Dynamics_Bifurcation.md):** Edge of chaos, complex systems behavior
- **[ZB33 — Biological Networks](../ZB_Ecology_Biology/ZB33_Biological_Networks_Systems_Biology.md):** Self-organization and network dynamics in biological systems
- **[ZA39 — Unification Physics](../ZA_Physics_Quantum/ZA39_Unification_Physics_Theory_of_Everything.md):** Digital physics and fundamental computation hypotheses
