# ZD15 — Mathematical Modeling and Simulation
...
> **Cross-References:** [V24 — Differential Equations](../V_Mathematics_Information/V24_Differential_Equations_Modeling_Change.md) · [ZD13 — Numerical Methods](V44_Numerical_Methods_Computation.md) · [V26 — Probability Theory](../V_Mathematics_Information/V26_Probability_Theory_Randomness_Bayes.md) · [Q19 — Cosmological Redshift](../Q_Cosmology_Physics/Q19_Cosmological_Redshift_Hubble_Law.md) · [ZB27 — Ecological Succession](../ZB_Ecology_Biology/ZB27_Ecological_Succession.md)
...
1. Kermack, W. O. and McKendrick, A. G. "A Contribution to the Mathematical Theory of Epidemics." *Proceedings of the Royal Society A*, vol. 115, 1927, pp. 700–721.
2. Lotka, A. J. *Elements of Physical Biology*. Williams & Wilkins, 1925.
3. Box, G. E. P. "Science and Statistics." *Journal of the American Statistical Association*, vol. 71, 1976, pp. 791–799.
4. Strogatz, S. H. *Nonlinear Dynamics and Chaos*. Perseus Books, 2nd edition, 2015.
5. Oreskes, N. et al. "Verification, Validation, and Confirmation of Numerical Models in the Earth Sciences." *Science*, vol. 263, 1994, pp. 641–646.
6. Gillespie, D. T. "Exact Stochastic Simulation of Coupled Chemical Reactions." *Journal of Physical Chemistry*, vol. 81, 1977, pp. 2340–2361.
7. Meadows, D. H. et al. *The Limits to Growth*. Universe Books, 1972.
8. Railsback, S. F. and Grimm, V. *Agent-Based and Individual-Based Modeling: A Practical Introduction*. Princeton University Press, 2nd edition, 2019.
...
|-------------|-----------|
| [V24 — Differential Equations](../V_Mathematics_Information/V24_Differential_Equations_Modeling_Change.md) | ODEs and PDEs are the primary mathematical tools for continuous modeling |
| [ZD13 — Numerical Methods](V44_Numerical_Methods_Computation.md) | Numerical methods solve the equations arising from mathematical models |
| [V26 — Probability Theory](../V_Mathematics_Information/V26_Probability_Theory_Randomness_Bayes.md) | Stochastic models and Monte Carlo methods rely on probability theory |
| [Q19 — Cosmological Redshift](../Q_Cosmology_Physics/Q19_Cosmological_Redshift_Hubble_Law.md) | Cosmological models use mathematical frameworks to predict observable quantities |
| [ZB27 — Ecological Succession](../ZB_Ecology_Biology/ZB27_Ecological_Succession.md) | Ecological succession models use Lotka-Volterra dynamics and individual-based simulations |
