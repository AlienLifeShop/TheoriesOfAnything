...
| Aspect | Simulation Parallel |
|--------|-------------------|
| **The phenomenon** | Reality is not determined until observed (G01) |
...
- He claimed he remembered a different past that had been "patched"
- Dismissed as madness at the time, his descriptions match the "Mandela Effect" and modern simulation arguments decades before Bostrom, Musk, or Tegmark popularized them
- Dick's speech predates the widespread personal computer era
...
**Note:** G02 previously covered Greek, Indian, Buddhist, Aboriginal proto-simulation traditions but missed this canonical Chinese example — significant given C12 (Chinese Dragon Mythology) exists in the project.
...
**Note on Carroll:** G02 previously listed Carroll's name in Arguments AGAINST without detailing his argument. The resolution conundrum and self-refutation comprise a philosophically significant two-pronged objection — the simulation must be either too perfect to detect or too imperfect to exist undetected.
...
|-------|--------------------------|
| **Non-human intelligence** (B01, B02) | Gods/Anunnaki/Watchers may be avatars of the simulators, advanced NPCs, or administrator accounts |
...
- Gates, S.J. (2010). "Symbols of Power: Adinkras and the Nature of Reality." *Physics World*.

### Detection
- Beane, S.R., Davoudi, Z., & Savage, M.J. (2014). "Constraints on the Universe as a Numerical Simulation." *European Physical Journal A*, 50, 148.
