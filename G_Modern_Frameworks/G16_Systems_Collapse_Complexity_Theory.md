# G16 — Systems Collapse and Complexity Theory Applied to Civilizations
...
> **Cross-References:** F08, E01, E12, E13, E14, S07, G15, Q14, R05, O05
...
- **Self-organization**: order arising without centralized control (→ G15)
...
- **Norse Ragnarök**: the destruction and renewal of the cosmos (→ C28, Baldr's return after Ragnarök)
...
- **G15** — Self-Organization and Emergence: the theoretical foundations (Prigogine, Bénard cells, BZ reaction, Kauffman) for understanding how complex systems form, maintain themselves, and transition between states
- **Q14** — Arrow of Time and Entropy: thermodynamic foundations for understanding why complex systems require energy throughput and tend toward collapse without it
...
*Document G16 — Part of the Theories of Everything project*
