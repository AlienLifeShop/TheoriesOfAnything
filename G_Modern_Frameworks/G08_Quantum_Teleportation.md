# G08 — Quantum Teleportation & Non-Local Transfer
## Moving Information Without Moving Through Space
...
**Source Agreement:** Consolidated from Wikipedia research on Quantum Teleportation, cross-referenced with G01 (quantum mechanics overview) and project ancient source files.
...
**Cross-references:** [G01_Quantum_Mechanics_Ancient_Knowledge.md](G01_Quantum_Mechanics_Ancient_Knowledge.md) | [G02_Simulation_Theory.md](G02_Simulation_Theory.md) | [G04_Telepathy_Research.md](G04_Telepathy_Research.md) | [G07_Collective_Consciousness.md](G07_Collective_Consciousness.md) | [A08_Hermetic_Tradition.md](../A_Foundations/A08_Hermetic_Tradition.md) | [D10_Sacred_Geometry.md](../D_Sites_and_Artifacts/D10_Sacred_Geometry.md)
...
Three particles in GHZ state achieve perfect coordination without communication (probability 1 vs. classical maximum 3/4). Named "quantum pseudo-telepathy" — directly parallels siddhi/iddhi traditions (G04, C11). Source: GHZ-Mermin 1990; Brassard-Broadbent-Tapp 2005.

### 1.7 Free Will Theorem (Conway-Kochen 2006)

If experimenters have "free will" to choose measurement settings, then particles must also have "free will" (non-deterministic responses). Parallels Sumerian "Tablet of Destinies" question — are outcomes predetermined (A06)?
...
| **Sumerian** | Enki's ME transfer | Divine programs (ME) transferred between cities/beings without physical transport (see A06) |
...
This maps eerily onto the Bennett protocol: entangled pair → Bell measurement → classical channel → state reconstruction. See [G04_Telepathy_Research.md](G04_Telepathy_Research.md) for Project Stargate's remote viewing experiments, which claimed operationally useful intelligence from "non-local perception."

### 4.3 The Anunnaki Communication Question

If the beings described in Sumerian texts (A01, B02) possessed advanced quantum technology:
- **ME transfer** between Eridu, Uruk, and other cities could represent **quantum state teleportation** of encoded information
- The **Tablet of Destinies** (see A01) — described as containing all universal laws — could represent a **quantum database** distributed non-locally
...
- [ ] Cross-reference with G04 — do Project Stargate remote viewing protocols describe a form of consciousness teleportation?
