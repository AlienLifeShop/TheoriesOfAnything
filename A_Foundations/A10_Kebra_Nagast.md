...
- **Composition:** the surviving text was compiled ~1314-1322 CE during the reign of Amda Seyon I (1314-1344), the first great emperor of the restored Solomonic dynasty
  ...
  - **Structure:** 117 chapters, combining narrative, prophecy, genealogy, and theological argument
- **Primary purpose:** to LEGITIMIZE the Solomonic dynasty by establishing:
  1. Ethiopia's divine election as the "New Israel"
  2. The transfer of the Ark of the Covenant from Jerusalem to Aksum
  3. The direct bloodline from Solomon → Menelik I → Ethiopian emperors
...
- **Part I — Makeda and Solomon:**
  ...
  - She returns to Ethiopia pregnant → gives birth to Menelik I (also called Bayna-Lehkem / Ibn al-Hakim — "Son of the Wise")
- **Part II — Menelik and the Ark:**
  - At age 22, Menelik travels to Jerusalem to meet Solomon
  - Solomon anoints Menelik king of Ethiopia
  - Menelik's companions (sons of Israelite elders) steal the Ark of the Covenant → replace it with a replica
  - They bring the Ark to Ethiopia (the land of "Zion")
  - When Solomon discovers the theft, he is devastated but accepts it as God's will — the glory has passed from Israel to Ethiopia
- **Part III — Theological Framework:**
  - Ethiopia is the "New Zion" — God's covenant has been transferred from Israel to Ethiopia
...
- **Biblical reference:** 1 Kings 10:1-13 and 2 Chronicles 9:1-12 record the Queen of Sheba visiting Solomon, but give NO name and provide limited detail
  ...
  - Gives him 120 talents of gold, spices, and precious stones
  - Solomon gives her "all she desired and asked for" — the Hebrew is ambiguous (sexual connotation possible)
- **Location of "Sheba" — debated:**
  - **South Arabian Sheba (Saba):** the Sabaean kingdom in modern Yemen — the strongest candidate based on linguistics (Sheba/Saba), archaeological evidence (wealthy incense trade kingdom, 8th-2nd centuries BCE), and inscription evidence
  - **Ethiopian Sheba:** Ethiopian tradition identifies Sheba with the ancient Ethiopian state of D'mt (which DID have cultural connections with South Arabia — shared Semitic languages, monumental architecture, similar script)
  - **The two are NOT mutually exclusive:** the Red Sea is narrow at the Strait of Mandeb (Bab-el-Mandeb, ~30 km); South Arabian and Ethiopian/Eritrean cultures were interconnected, and the same queen could theoretically have ruled territories on both sides
- **Archaeological evidence:**
  - The Sabaean kingdom in Yemen is well-attested (Ma'rib dam, inscriptions, temples)
...
- **Claimed lineage:** Solomon → Menelik I → ... → Haile Selassie (225th in the line)
  ...
  - **Haile Selassie (r. 1930-1974):** the last emperor, styled himself "Conquering Lion of the Tribe of Judah, Elect of God, and King of Kings of Ethiopia"
- **Historical assessment:**
  - The 225-generation genealogy is almost certainly a political-religious construction, not a literal family tree
...
- **Ethiopian tradition asserts the Ark is in the Church of Our Lady Mary of Zion, Aksum:**
  ...
  - NO ONE except the Guardian is permitted to see the Ark — not bishops, not the Patriarch, not the Emperor (when the monarchy existed)
  - Every Ethiopian Orthodox church contains a **tabot** — a replica of the Tablets of the Law, kept in the Holy of Holies (maqdas) and central to the liturgy
- **Is the Ark really there?**
...
- **Broader Judaic practices in Ethiopian Christianity:**
  ...
  - Saturday AND Sunday Sabbath observance
...
- **The Kebra Nagast functions identically to other founding myths:**
  ...
  - British: Geoffrey of Monmouth links British kings to Troy → Brutus
  - **Ethiopian:** Kebra Nagast links emperors to Solomon → divinely chosen nation
- **The transfer-of-divine-favor motif** (Israel → Ethiopia) parallels:
...
- **The Rastafari movement (1930s, Jamaica) adopted the Kebra Nagast as a central scripture:**
  ...
  - The Solomonic genealogy of Haile Selassie → connection to King David → messianic lineage
  - **This reinterpretation gave the Kebra Nagast global significance** beyond Ethiopian religious tradition
...
|---|-------------|----------|--------|---------|
| 1 | Church of Our Lady Mary of Zion, Aksum | A10_aksum_church_001.jpg | Wikimedia Commons | CC BY-SA |
| 2 | Kebra Nagast manuscript page (Ge'ez) | A10_kebra_nagast_ms_002.jpg | British Library | Fair Use |
| 3 | Queen of Sheba visiting Solomon (painting) | A10_queen_sheba_003.jpg | Public Domain art | Public Domain |
| 4 | Haile Selassie coronation | A10_selassie_004.jpg | Public Domain | Public Domain |
...
|-------------|-----------|
| [B04 — Solomon and the Jinn](../B_Beings_and_Entities/B04_Solomon_and_the_Jinn.md) | Solomon as supernatural king |
| [C17 — Sacred Kingship](../C_Global_Traditions/C17_Sacred_Kingship_Divine_Rulership.md) | Divine dynasty legitimation |
| [B06 — Dynastic Serpent Lineage](../B_Beings_and_Entities/B06_Dynastic_Serpent_Lineage.md) | Royal descent from supernatural beings |
| [C05 — Credo Mutwa African](../C_Global_Traditions/C05_Credo_Mutwa_African_Traditions.md) | African sacred traditions |
| [A03 — Nag Hammadi](../A_Foundations/A03_Nag_Hammadi_Gnostic_Texts.md) | Alternative Christian traditions |
| [H01 — Suppression](../H_Suppression_and_Thesis/H01_Suppression_of_Ancient_Knowledge.md) | Non-Western knowledge traditions marginalized |
