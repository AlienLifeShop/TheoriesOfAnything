...
- **Composition history:**
  ...
  - **Expanded to "Bharata":** (~24,000 verses) — expanded narrative with more characters and episodes
  - **Final "Mahabharata":** (~100,000 verses) — the full text we have today, with philosophical, didactic, and encyclopedic material added. Final form ~4th century CE but with layers spanning 800 years
  - The text itself acknowledges this layering: "What is found here may be found elsewhere. What is not found here will not be found elsewhere."
- **Structure:** 18 books (parvas):
  1. Adi Parva (origins) → 18. Svargarohanika Parva (ascent to heaven)
  - Plus the Harivamsa (appendix on Krishna's life)
- **Manuscripts:** thousands of manuscripts in Sanskrit and regional languages; critical edition by the Bhandarkar Oriental Research Institute (Pune, 1919-1966) — 19 volumes, the most comprehensive critical apparatus of any ancient text
- **Historicity of the Kurukshetra War:**
  - Traditional date: 3102 BCE (beginning of Kali Yuga)
  - Archaeological/astronomical calculations: various dates proposed from ~1400-900 BCE
...
- **The Kauravas (100 brothers):** led by Duryodhana
  - Sons of Dhritarashtra (blind king)
- **The conflict:** Duryodhana refuses to return the Pandavas' kingdom after their exile → diplomatic efforts fail → 18-day war at Kurukshetra
- **Key characters:**
  - **Krishna:** avatar (incarnation) of the supreme god Vishnu; serves as Arjuna's charioteer and divine advisor
  - **Bhishma:** grandfather figure, the greatest warrior, who fights for the Kauravas despite knowing their cause is unjust
  - **Drona:** weapons teacher of both Pandavas and Kauravas; fights for the Kauravas
  - **Karna:** Arjuna's unknown half-brother, the tragic hero who fights for the Kauravas out of loyalty to Duryodhana
- **The Bhagavad Gita (Book 6, chapters 23-40):**
  - Arjuna, seeing his relatives and teachers on the opposing side, refuses to fight
  - Krishna reveals: the real Self (Atman) is immortal; all beings are already dead in the cosmic plan; Arjuna must fulfill his duty (dharma) as a warrior without attachment to results
...
- **The war's devastation:**
  ...
  - The Kaurava side: annihilated
  - **The victory is pyrrhic:** Yudhishthira is so disgusted by the carnage that he initially refuses to rule
- **Post-war events:**
  - Yudhishthira performs the horse sacrifice (ashvamedha) — ancient validation of sovereignty
  - Krishna is eventually killed by a hunter's arrow (aimed at his foot — his only vulnerable spot, like Achilles)
  - After Krishna's death, the current age (Kali Yuga — age of darkness) begins
...
- **The Mahabharata contains within it virtually ALL of Hindu philosophy:**
  ...
  - The Shanti Parva (Book of Peace, ~25,000 verses of dharma, governance, philosophy)
  - The Anushasana Parva (Book of Instructions — ethics, duties, metaphysics)
  - Stories within stories: Nala and Damayanti, Shakuntala, Savitri, the churning of the ocean
- **Yuga cosmology:**
  - Time is cyclical, divided into four ages (yugas): Satya (truth), Treta, Dvapara, Kali
  - Each age is progressively shorter and more corrupt
  - The Mahabharata war marks the transition from Dvapara to Kali Yuga (the current, darkest age)
  - A full cycle (mahayuga) = 4,320,000 years; cosmic destruction and renewal repeat eternally
- **Dharma as central theme:**
  - The epic constantly asks: What is the right thing to do when all choices lead to suffering?
  - Characters face impossible moral dilemmas — and even the righteous make terrible choices
  - **This moral complexity distinguishes the Mahabharata from most ancient epics:** there are no simple heroes or villains
...
|---|---|---|
| **Brahmastra** | Multiple | Infallible weapon that never misses; cannot be countered; destroys everything in its path |
| **Brahmashirastra** | Ashwatthama | 4× the power of Brahmastra; creates a blinding pillar of fire; devastates the earth |
| **Pashupatastra** | Arjuna (from Shiva) | Can destroy creation itself; used only as last resort |
| **Narayanastra** | Ashwatthama | Fires millions of projectiles simultaneously; can only be used ONCE; resistance increases its power |
| **Agneyastra** | Multiple | Fire weapon; creates conflagration |
| **Varunastra** | Multiple | Water weapon; causes floods |
| **Vayavyastra** | Multiple | Wind weapon; creates tornadoes |
| **Sammohanastra** | Arjuna | Causes mass unconsciousness |
...
- **The Mahabharata describes several flying vehicles (vimanas):**
  ...
  - Cities that float in the sky ("triple cities" or Tripura — destroyed by Shiva)
...
- **The epic contains extensive Naga (serpent/dragon being) content:**
  ...
  - Bhima marries a Naga princess in some traditions
  - The Naga king Vasuki serves as the rope in the cosmic churning of the ocean (Samudra Manthana)
  - **Nagas are NOT simply animals** in the Mahabharata — they are intelligent, shape-shifting beings with their own kingdoms (in the underworld, Patala), armies, and political interests (see C11, B01)
...
- **Some scholars argue the epic encodes memories of real historical events:**
  ...
  - Astronomical alignments described in the text have been used to propose specific dates (ranging from 3102 BCE to ~900 BCE)
  - **The archaeological evidence from Hastinapura (BB Lal):** flood layers matching the epic's account of flooding that caused the capital to be abandoned; Painted Grey Ware pottery consistent with the epic's historical period
...
|---|-------------|----------|--------|---------|
| 1 | Krishna and Arjuna on chariot (painting) | A11_krishna_arjuna_001.jpg | Public Domain art | Public Domain |
| 2 | Battle of Kurukshetra (miniature painting) | A11_kurukshetra_002.jpg | Razmnama manuscript | Public Domain |
| 3 | Mahabharata manuscript page (Sanskrit) | A11_mahabharata_ms_003.jpg | National Museum Delhi | Fair Use |
| 4 | Map of Kurukshetra region | A11_kurukshetra_map_004.jpg | Adapted | Fair Use |
