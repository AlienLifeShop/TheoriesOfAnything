...
- **The Poetic Edda (Elder Edda):**
  ...
  - **Key mythological poems:**
    ...
    - *Hávamál* ("Sayings of the High One") — wisdom poetry attributed to Odin
    - *Grímnismál* — Odin describes the cosmological geography of the nine worlds
    - *Vafþrúðnismál* — Odin and the giant Vafþrúðnir exchange cosmic knowledge
    - *Lokasenna* — Loki's flyting (verbal combat) with the gods
  - **Heroic poems:** Sigurðr cycle (basis for Wagner's Ring Cycle), Helgi poems, Hamðismál
- **The Prose Edda (~1220 CE):**
  - Written by Snorri Sturluson (1179-1241), Icelandic chieftain, historian, and poet
  - **Snorri's purpose:** to preserve knowledge of traditional poetry for skalds (court poets) — composed generations AFTER Iceland's conversion to Christianity (999/1000 CE)
  - **Structure:**
...
- **The Void — Ginnungagap:**
  ...
  - The cow **Auðumbla** also formed → she nourished Ymir with her milk; she licked salty ice blocks → from the ice emerged **Búri** (first god)
- **The creation sacrifice:**
  - Odin, Vili, and Vé (grandsons of Búri) killed Ymir
  - From his body: the earth (flesh), oceans (blood), mountains (bones), sky (skull), clouds (brains), trees (hair)
  - **The world is literally made from a sacrificed being** — paralleling Vedic Purusha Sukta (RV 10.90), Babylonian Tiamat (killed by Marduk, body forms the world), and Chinese Pangu
- **Human creation:**
  - Odin found two pieces of driftwood (or tree trunks) → created Ask (ash tree, male) and Embla (elm?, female)
...
- **Yggdrasil — the World Tree:**
  ...
  - **Three roots, each reaching a different well:**
    1. **Urðarbrunnr** (Well of Fate) — tended by the three Norns (Urðr, Verðandi, Skuld = Past, Present, Future)
    2. **Mímisbrunnr** (Mímir's Well) — well of wisdom; Odin sacrificed one eye to drink from it
    3. **Hvergelmir** — the spring from which all rivers flow; the serpent Niðhöggr gnaws at this root
  - **Creatures on Yggdrasil:** eagle at the top (with hawk Veðrfölnir between its eyes), Niðhöggr at the bottom, four stags grazing on the branches, Ratatoskr the squirrel carrying messages between eagle and serpent
  - **Odin's self-sacrifice ON Yggdrasil:**
    - "I know that I hung on a wind-swept tree / nine long nights / wounded with a spear, dedicated to Odin / myself to myself / on that tree of which no man knows / from where its roots run" (Hávamál 138)
    - He hung for 9 nights, pierced by his own spear, without food or water → gained the runes (secret knowledge)
    - **Parallels to:** crucifixion narrative; shamanic initiation (death-rebirth); visionary quest through suffering
- **The Nine Worlds:**
  - **Asgard:** realm of the Æsir gods (Odin, Thor, etc.)
  - **Vanaheim:** realm of the Vanir gods (Freyr, Freyja, Njörðr)
  - **Midgard:** human world ("Middle Earth" — Tolkien borrowed this)
  - **Jötunheim:** realm of the giants (Jötnar)
  - **Alfheim:** realm of the light elves
  - **Svartalfheim/Nidavellir:** realm of dwarves (dark elves)
  - **Niflheim:** primordial cold/mist realm, includes Hel (realm of the dead)
  - **Muspellheim:** primordial fire realm
...
|---|---|---|
| **Odin** | Wisdom, war, death, poetry, runes, seiðr (magic) | Sacrificed eye for wisdom; hanged on Yggdrasil for runes; gathers warriors (einherjar) in Valhalla for Ragnarök |
| **Thor** | Thunder, storms, protection, strength | Wielder of Mjölnir (hammer); protector of gods and humans; kills Jörmungandr at Ragnarök (and dies) |
| **Freyja** | Love, fertility, war, death, seiðr | Leads the Valkyries; receives half the battle-slain in her hall Fólkvangr; mistress of seiðr magic |
| **Loki** | Trickery, shapeshifting, chaos | Father of Fenrir (wolf), Jörmungandr (world serpent), Hel (death goddess); bound with his son's entrails until Ragnarök |
| **Freyr** | Fertility, peace, prosperity | Vanir god; gave away his sword for love → fights swordless at Ragnarök and falls |
...
- **Precursors:**
  ...
  - The wolves Sköll and Hati finally catch and swallow the sun and moon
  - Stars vanish from the sky
- **The Cataclysm:**
  - Heimdallr blows Gjallarhorn → all worlds tremble
  - **Fenrir** breaks free → jaw touching earth and sky, swallows Odin
  - **Jörmungandr** (Midgard Serpent) rises from the ocean → poisons the sky with venom → battles Thor. Thor slays the serpent but dies from its venom after 9 steps
  - **Loki** leads the forces of chaos (giants, the dead from Hel, the fire giant Surtr)
  - **Surtr** wields a flaming sword → sets the world on fire
  - The earth sinks into the sea
- **Renewal:**
  - The earth rises again from the water, "green and fair"
  - **Líf and Lífþrasir** (two human survivors, hidden in Hoddmímis holt — a grove or inside the World Tree) repopulate the world
...
- **Norse Ragnarök parallels other cyclic cosmologies:**
  ...
  - **Zoroastrian:** final battle (Frashokereti) between good and evil, followed by world renewal
...
- **Jörmungandr — the Midgard Serpent — encircles the entire world, biting its own tail → this is the OUROBOROS, the self-devouring serpent found in:**
  ...
  - Hindu cosmology (Shesha/Ananta supports the world; ouroboros in Vishnu iconography)
  - Aztec (Quetzalcoatl as feathered serpent; serpent wall at Tenochtitlan)
...
- **The "Great Winter" (Fimbulvetr) before Ragnarök may encode memories of real catastrophic cold events:**
  ...
  - Volcanic winters from Laki (1783) and earlier eruptions shaped Icelandic experience of "winters without end"
...
- **Odin's characteristics map onto shamanic practice documented in Siberian and circumpolar traditions:**
  ...
  - Two ravens (Huginn/Muninn = Thought/Memory) → shamanic spirit helpers; flying out to gather information and returning
  - Shape-shifting (Odin takes many forms) → shamanic transformation
  - Seiðr magic → ecstatic/trance practices
...
- **The mythology records a war between two groups of gods (Æsir and Vanir), ending in a truce and hostage exchange:**
  ...
  - **Alternative:** the distinction may be purely mythological, reflecting different aspects of the natural and social world
...
|---|-------------|----------|--------|---------|
| 1 | Yggdrasil World Tree illustration | A12_yggdrasil_001.jpg | Public Domain (Oluf Olufsen Bagge) | Public Domain |
| 2 | Ragnarök battle scene | A12_ragnarok_002.jpg | Public Domain (Emil Doepler) | Public Domain |
| 3 | Codex Regius manuscript page | A12_codex_regius_003.jpg | Árni Magnússon Institute | Fair Use |
| 4 | Jörmungandr ouroboros stone carving | A12_jormungandr_004.jpg | Altuna runestone | Fair Use |
...
|-------------|-----------|
| [C02 — Global Flood](../C_Global_Traditions/C02_Global_Flood_Stories.md) | Ragnarök flood; world sinks into sea |
| [C03 — Flood Serpent Connection](../C_Global_Traditions/C03_Flood_Serpent_Connection.md) | Jörmungandr rises at Ragnarök |
| [B01 — Reptilian Beings](../B_Beings_and_Entities/B01_Reptilian_Beings_Overview.md) | Serpent beings (Jörmungandr, Niðhöggr) |
| [C08 — Cross-Cultural Patterns](../C_Global_Traditions/C08_Cross_Cultural_Patterns.md) | World Tree, creation-destruction cycles |
| [E01 — Younger Dryas](../E_Cataclysms_and_Chronology/E01_Younger_Dryas_Impact.md) | Fimbulvetr as climate catastrophe memory |
| [R05 — Mass Extinctions](../R_Biology_Evolution/R05_Mass_Extinction_Events.md) | Cyclic destruction patterns |
| [D10 — Sacred Geometry](../D_Sites_and_Artifacts/D10_Sacred_Geometry.md) | Nine worlds as cosmological structure |
