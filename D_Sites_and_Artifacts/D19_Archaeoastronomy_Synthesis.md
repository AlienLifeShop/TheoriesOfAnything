# D19 — Archaeoastronomy Synthesis
...
**The world's oldest known monumental architecture — and the most debated candidate for sophisticated pre-Neolithic astronomical knowledge (D01).**
...
- Three "handbag" shapes across the top (see D18)
...
- Evidence of **precessional awareness:** the zodiacal figures are arranged in positions that differ subtly from the sky of 50 BCE, leading some researchers to argue the zodiac records an earlier astronomical epoch
...
- The relationship to precessional number sets (432, 72, 108 — see E14) is suggestive but not conclusively proven
...
- **Casa Rinconada:** a great kiva at Chaco Canyon with a window niche that admits sunlight onto a specific wall niche at summer solstice — though some researchers debate whether this is coincidental rather than intentional
...
- See E14 for full number analysis
...
- This connects to D03 (Sphinx water erosion hypothesis — John Anthony West, Robert Schoch, 1991): if the Sphinx shows water erosion predating ~5000 BCE, it may date to a period consistent with Bauval's precessional date
...
- Robert Schoch (Boston University geologist, 1991): examined the Sphinx enclosure and confirmed the presence of water erosion patterns, estimating a date of ~5000–9000 BCE minimum (D03)
...
| Sphinx = Leo at 10,500 BCE (West/Schoch) | Water erosion is real (D03) but does not require 10,500 BCE; precessional Leo association is speculative |
...
**For the project:**
- D01 (Göbekli Tepe): astronomical function is possible but not proven — the site's importance does not depend on astronomical claims
- D02/D03 (Pyramids, Sphinx): the Great Pyramid's precision is established fact; the 10,500 BCE dating framework is speculative
- E14 (Precessional numbers): the number patterns are genuinely remarkable — whether they encode precession or arise from sexagesimal arithmetic remains the key open question
...
|-------------|-----------|
| [D01 — Göbekli Tepe](../D_Sites_and_Artifacts/D01_Gobekli_Tepe.md) | Pillar 43 astronomical interpretations, Sweatman-Tsikritsis hypothesis |
| [D02 — Pyramids Worldwide](../D_Sites_and_Artifacts/D02_Pyramids_Worldwide.md) | Great Pyramid precision alignment, Bauval's Orion Correlation |
| [D03 — Sphinx Water Erosion](../D_Sites_and_Artifacts/D03_Sphinx_Water_Erosion.md) | Sphinx dating and precessional Age of Leo hypothesis |
| [D05 — Megalithic Engineering](../D_Sites_and_Artifacts/D05_Megalithic_Impossible_Engineering.md) | Construction capabilities of astronomically aligned sites |
| [D18 — Handbag Motif](../D_Sites_and_Artifacts/D18_Handbag_Knowledge_Container.md) | Pillar 43 handbag carvings above astronomical scene |
| [E04 — Younger Dryas](../E_Cataclysms_and_Chronology/E01_Younger_Dryas_Impact.md) | Sweatman's claim that Pillar 43 encodes Younger Dryas date |
| [E11 — Chronology](../E_Cataclysms_and_Chronology/E11_Mathematical_Encoding_Mythology.md) | Timeline of astronomical knowledge development |
| [E14 — Precessional Numbers](../E_Cataclysms_and_Chronology/E14_Kali_Yuga_World_Ages_Mathematics.md) | 72/108/432 number sets and precessional encoding |
...
*Document D19 — Part of the Theories of Everything project*
