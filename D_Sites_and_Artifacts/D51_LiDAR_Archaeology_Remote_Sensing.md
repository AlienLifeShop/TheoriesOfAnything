# D51 — LiDAR Archaeology: Revolutionary Remote Sensing Discoveries

> **Source Count:** 11 | **Weighted Score:** 29 | **Source Confidence:** [3/5] | **Last Updated:** March 8, 2026
...
> **Cross-References:** [D34](D34.md) · [D35](D35.md) · [W03](../W_World_Civilizations/W03.md) · [W11](../W_World_Civilizations/W11.md) · [D13 — Underwater Archaeology](D13_Underwater_Archaeology.md)
...
| # | Description | Filename | Source | License |---|-------------|----------|--------|---------| 1 | LiDAR DEM of Maya structures in Guatemala Petén | lidar_maya_peten.jpg | PACUNAM / Canuto et al. 2018 | Fair Use (research) | 2 | LiDAR map of greater Angkor urban landscape | lidar_angkor_evans.jpg | Evans et al. 2013 / PNAS | Fair Use (research) | 3 | Caracol LiDAR survey showing urban extent | lidar_caracol_chase.jpg | Chase & Chase / Journal of Archaeological Science | Fair Use (research) | 4 | GPR survey results from Falerii Novi | gpr_falerii_novi.jpg | Verdonck et al. 2020 / Antiquity | Fair Use (research) |

---

## BIBLIOGRAPHY

1. Parcak, S. *Satellite Remote Sensing for Archaeology*. London: Routledge, 2009.
2. Chase, A.F. et al. "Airborne LiDAR, Archaeology, and the Ancient Maya Landscape at Caracol, Belize." *Journal of Archaeological Science* 38, no. 2 (2011): 387–398.
3. Evans, D.H. et al. "Uncovering Archaeological Landscapes at Angkor Using Lidar." *Proceedings of the National Academy of Sciences* 110, no. 31 (2013): 12595–12600.
4. Opitz, R.S. and Cowley, D.C. (eds.). *Interpreting Archaeological Topography: Airborne Laser Scanning, 3D Data and Ground Observation*. Oxford: Oxbow Books, 2013.
5. Seales, W.B. et al. "From Damage to Discovery via Virtual Unwrapping: Reading the Scroll from En-Gedi." *Science Advances* 2, no. 9 (2016): e1601247.
6. Evans, D.H. "Airborne Laser Scanning as a Method for Exploring Long-Term Socio-Ecological Dynamics in Cambodia." *Journal of Archaeological Science* 74 (2016): 164–175.
7. Canuto, M.A. et al. "Ancient Lowland Maya Complexity as Revealed by Airborne Laser Scanning of Northern Guatemala." *Science* 361, no. 6409 (2018): eaau0137.
8. de Souza, J.G. et al. "Pre-Columbian Earth-Builders Settled Along the Entire Southern Rim of the Amazon." *Nature Communications* 9 (2018): 1125.
9. Verschoof-van der Vaart, W.B. and Lambers, K. "Learning to Look at LiDAR: The Use of R-CNN in the Automated Detection of Archaeological Objects in LiDAR Data from the Netherlands." *Journal of Computer Applications in Archaeology* 2, no. 1 (2019): 31–40.
10. Inomata, T. et al. "Monumental Architecture at Aguada Fénix and the Rise of Maya Civilization." *Nature* 582 (2020): 530–533.
11. Verdonck, L. et al. "Ground-Penetrating Radar Survey at Falerii Novi: A New Approach to the Study of Roman Cities." *Antiquity* 94, no. 375 (2020): 705–723.

---

## CROSS-REFERENCE INDEX

| Related Doc | Connection |-------------|-----------| [D34](D34.md) | Related archaeological site discoveries enhanced by remote sensing | [D35](D35.md) | Archaeological methodology and fieldwork practices | [W03](../W_World_Civilizations/W03.md) | Maya civilization — primary beneficiary of LiDAR archaeology | [W11](../W_World_Civilizations/W11.md) | Khmer Empire and Angkor — LiDAR-revealed urban extent | [D13 — Underwater Archaeology](D13_Underwater_Archaeology.md) | Side-scan sonar and underwater remote sensing as parallel technologies |
