...
> **Last Updated:** 2026-03-13 28, 2026 | **Source Count:** 5 | **Weighted Score:** 7 | **Source Confidence:** [1/5] | **Confidence:** High (well-documented, peer-reviewed)
...
- Discovered in 2020 during urban construction work in Midyat, southeastern Turkey
- Potentially the **largest underground city ever found** — early estimates suggest it may exceed Derinkuyu in extent [Tier 1–2]
- Contains multi-level rooms, corridors, water channels, and storage areas carved from limestone
- Located in a historically Christian area with Syriac/Assyrian communities
- Excavation and documentation ongoing (2020–2025) under the Midyat Municipality and Turkish Ministry of Culture
- Demonstrates that **major underground cities are still being discovered** — the known inventory is not complete
...
- The ventilation engineering at Derinkuyu is sophisticated for any period
...
- **No historical record** of their construction exists
- Possibly over 2,000 years old
...
- Too narrow for normal human use in many places
- No clear purpose established — not for storage, defense, or drainage
- Researchers propose they may be much older than currently dated
...
- Described as a utopian civilization with advanced technology
- Connected to Buddhist legends of **Shambhala** (Kalachakra Tantra describes a kingdom of enlightened beings)
- Supposedly accessible through tunnels in Tibet and the Himalayas
- The King of Agartha (the "King of the World") rules a vast underground civilization

**Key Variants:**
- **Buddhist tradition**: Underground realms accessible through caves in Tibet
...
- Described as **MORE beautiful than heaven** — jeweled cities, gardens, pleasures
- The *Vishnu Purana* describes these realms in detail
...
- However, VAST natural cave systems are real: Mammoth Cave system (Kentucky) has 400+ miles (650 km) of explored passages
...
- **Cheyenne Mountain Complex** (Colorado, USA) — NORAD headquarters
- **Mount Weather** (Virginia, USA) — Emergency Operations Center
- **Raven Rock Mountain Complex** (Pennsylvania, USA) — Defense facility
...
- **Dulce Base** — Alleged joint human-alien facility, New Mexico; no verified evidence
- **DUMBs** — Phil Schneider (1995) claimed underground military bases with alien inhabitants; died 1996, disputed circumstances; unverified
...
- Permanent multi-generational underground civilization is **biologically implausible for humans** without high technology
- However, **reptiles have different biological needs** — cold-blooded, don't need UV for vitamin D in the same way, handle dark environments more efficiently
- If a reptilian species existed, underground habitation would be biologically **easier** for them than for humans
- Consistent temperature underground suits reptilian metabolism
- Protection from surface catastrophes (floods, impacts, ice ages)
- Access to underground water systems
...
- [ ] Who built the Longyou Grottoes and why is there no historical record?
- [ ] Why does Cappadocia have over 200 underground cities when a few would suffice for occasional refuge?
- [ ] What is the true age of the Erdstall tunnels?
- [ ] What happened in the lowest levels of the Hypogeum of Malta?
- [ ] Are there undiscovered tunnel networks connecting major ancient sites?
- [ ] What technology produced the mirror-polish finish in the Barabar Caves?
...
|----------|---------|------------|
| [J_1_04](../../J_Ancient_Technology/J1_Energy_Acoustic_Advanced/J_1_04_Acoustic_Vibrational_Technology.md) | J_Ancient_Technology | J_1_04 — Acoustic Vibrational Technology |
...
- Turkey Ministry of Culture and Tourism — http://www.kulturvarliklari.gov.tr/
- Wikimedia Commons: Derinkuyu — https://commons.wikimedia.org/wiki/Category:Derinkuyu
- National Speleological Society (NSS) — cave system records
- Cappadocia archaeology and excavation reports
...
- *Kojiki* (Yomi-no-kuni — Shinto underworld)
- Hopi oral tradition (Sipapu / Ant People)
- Saint-Yves d'Alveydre, A. (1886). *Mission de l'Inde en Europe*.
...
| **Cave sacrality** | Caves provoke awe/fear; acoustic properties (→ [J_1_04](../../J_Ancient_Technology/J1_Energy_Acoustic_Advanced/J_1_04_Acoustic_Vibrational_Technology.md)) create altered states | Hypogeum, Lascaux, Chauvet | TIER 1–2 |
...
- **Depth:** 18 stories, ~85 meters deep (deepest of ~200 Cappadoccia underground cities)
- **Capacity:** Estimated 20,000 people with livestock and food storage
- **Engineering features:**
  - 52+ ventilation shafts (deepest: ~55m)
  - Rolling stone doors (up to 500 kg) operable from inside only
  - Connecting tunnel to Kaymaklı underground city (~5 km)
  - Winery, chapel, school, stables, food storage on multiple levels
- **Construction material:** Carved from volcanic tuff (ignite, consolidated ash) — soft enough to excavate with copper/iron tools but hardens upon air exposure
- **Dating controversy:** The deepest levels may be Hittite (~1600–1200 BCE) or earlier; middle levels Phrygian (~800–600 BCE); upper additions Byzantine (~6th–10th c. CE)
- **Cross-References:** D_5_04 (expanded catalog — 40+ sites), D_1_03 (engineering), J_1_04 (underground acoustics)
...
5. *The Ħal Saflieni Hypogeum*. Bloomsbury Academic, 2025. DOI: 10.5040/9798881844745.ch-015
