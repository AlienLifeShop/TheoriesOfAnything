# D40 — Lalibela Rock-Hewn Churches — Ethiopia's New Jerusalem
...
- **Total churches:** 11 rock-hewn churches, divided by the **Yordanos** (Jordan River — named after the biblical Jordan, reinforcing New Jerusalem symbolism):
  - **Northern Group:** Bete Medhane Alem, Bete Maryam, Bete Golgotha, Bete Mikael, Bete Denagel, and Selassie Chapel
  - **Eastern Group:** Bete Gabriel-Rufael, Bete Merkorios, Bete Amanuel, Bete Abba Libanos
  - **Isolated:** **Bete Giyorgis** — connected by a winding rock-cut trench approach
...
- **Classification by type:**
  ...
  - **Cave-type:** Carved into a cliff face with only the facade exposed.
- **Tools:** Iron chisels, hammers, and crowbars — consistent with medieval Ethiopian metallurgical capabilities. Guide marks (chisel channels) visible on trench walls reveal systematic excavation. Wedge holes for controlled rock splitting are visible in some trenches.
...
- **Plan:** A perfect **Greek cross** (equal-armed cruciform) visible from above — the iconic image of Lalibela.
- **Exterior:** Three tiers of decorative window openings on each face in Aksumite-style mullion patterns. Blind arches and pilasters articulate facades.
- **Access:** Approached via a winding, rock-cut trench — the pilgrim's first view is from above, looking down into the carved-out pit.
- **Tradition:** According to the *Gadla Lalibela* ("Acts of Lalibela"), St. George himself appeared on horseback and commanded the construction of this church as the last and finest.

#### Bete Medhane Alem (Church of the Savior of the World)
- **Status:** The **largest rock-hewn church in the world** — approximately 33.5 m × 23.5 m × 11.5 m.
- **Features:** 72 rectangular pillars (36 interior, 36 exterior), a basilica floor plan with five aisles. Phillipson (2009) suggests it was modeled on the original Church of St. Mary of Zion at Aksum (now destroyed).
- **Structural issues:** Several exterior pillars have cracked or collapsed; UNESCO stabilization programs have inserted reinforcements. A controversial protective shelter was erected in the early 2000s.

#### Bete Maryam (Church of the Virgin Mary)
- **Status:** Traditionally considered the **oldest** Lalibela church — the first carved by King Lalibela.
- **Interior:** Richly decorated with painted frescoes (mostly 17th–19th century repaintings over potentially older layers), carved relief crosses, and the **"Pillar of Light" (*Amude Birhan*)** — a mysterious wrapped pillar which tradition says bears an inscription recording past and future of the world, revealed to Lalibela by Christ. The pillar has never been unwrapped for modern inspection.
- **External carved basin:** Identified as the "Pool of Bethesda" — reinforcing Jerusalem parallels.
...
- The site is explicitly conceived as a **replica of Jerusalem and the Holy Land**:
  ...
  - **The Tomb of Adam** — a carved chamber beneath Bete Golgotha
...
- The volcanic tuff, while advantageous for carving, is vulnerable to:
  ...
  - **Thermal cycling** (daily temperature fluctuations causing micro-fracturing)
  - **Salt crystallization** from groundwater wicking through porous tuff
- Several churches show significant deterioration — cracking, surface exfoliation, and structural weakening.
- Controversial **protective shelters** (metal-framed canopy structures) were erected over several churches by the European Union in 2008:
  - Intended to prevent rain damage
  - Criticized for visual intrusiveness and interference with site aesthetics
  - May create heat-trap effects (accelerating thermal cycling)
  - Interfere with the site's visual integrity and photographic documentation
- The relationship between conservation, authenticity, and modern intervention remains a contentious issue in UNESCO heritage management.
- **Italian restoration teams** (ISCR — Instituto Superiore per la Conservazione ed il Restauro) have conducted stone consolidation, drainage improvement, and structural monitoring since the 1990s.
...
- Claims of angelic, alien, or lost-civilization construction misrepresent hagiographic tradition and physical evidence (tool marks, systematic chisel channels) demonstrating human craftsmanship.
- Proposals that Lalibela is tens of thousands of years old contradict all archaeological and radiocarbon evidence.
- Assertions that the churches encode "secret maps" to the Ark of the Covenant have no epigraphic or archaeological support.
- Claims that the churches were carved in a single day or week (misreading of the *Gadla Lalibela*'s angelic assistance motif) are literary, not historical.
...
10. Pankhurst, Richard. *The Ethiopians: A History.* Oxford: Blackwell, 2001.
11. Henze, Paul B. *Layers of Time: A History of Ethiopia.* London: Hurst, 2000.
12. Munro-Hay, Stuart. *Ethiopia, the Unknown Land.* London: I.B. Tauris, 2002.
13. Chojnacki, Stanislaw. *Major Themes in Ethiopian Painting.* Wiesbaden: Franz Steiner, 1983.
14. Plant, Ruth. *Architecture of the Tigre, Ethiopia.* Worcester: Ravens Educational and Development Services, 1985.
15. Marcus, Harold G. *A History of Ethiopia.* Berkeley: University of California Press, 1994.
16. Sergew Hable Selassie. *Ancient and Medieval Ethiopian History to 1270.* Addis Ababa: United Printers, 1972.
17. Fritsch, Emmanuel & Michael Gervers. "Pastophoria and Altars: Interaction in Ethiopian Liturgy and Church Architecture." *Aethiopica* 10 (2007): 7–51.
