# R28 — Animal Navigation and Migration — Magnetism, Stars, and Memory
...
- If confirmed, cryptochrome magnetoreception would represent one of the clearest examples of **quantum biology** — a macroscopic biological function depending on quantum mechanical phenomena at ambient temperature, alongside quantum coherence in photosynthesis (see R31).
...
1. Reppert, S. M., Gegear, R. J. & Merlin, C. (2010). "Navigational mechanisms of migrating monarch butterflies." *Trends in Neurosciences*, 33(9), 399–406.
2. Guerra, P. A., Gegear, R. J. & Reppert, S. M. (2014). "A magnetic compass aids monarch butterfly migration." *Nature Communications*, 5, 4164.
3. Egevang, C. et al. (2010). "Tracking of Arctic terns *Sterna paradisaea* reveals longest animal migration." *PNAS*, 107(5), 2078–2081.
4. Hasler, A. D. & Wisby, W. J. (1951). "Discrimination of stream water by fishes and its relation to parent stream behavior." *American Naturalist*, 85(823), 223–238.
5. Lohmann, K. J. et al. (2001). "Regional magnetic fields as navigational markers for sea turtles." *Science*, 294(5541), 364–366.
...
7. Emlen, S. T. (1970). "Celestial rotation: its importance in the development of migratory orientation." *Science*, 170(3963), 1198–1201.
8. Ritz, T., Adem, S. & Schulten, K. (2000). "A model for photoreceptor-based magnetoreception in birds." *Biophysical Journal*, 78(2), 707–718.
9. Hore, P. J. & Mouritsen, H. (2016). "The radical-pair mechanism of magnetoreception." *Annual Review of Biophysics*, 45, 299–344.
10. Mouritsen, H. (2018). "Long-distance navigation and magnetoreception in migratory animals." *Nature*, 558, 50–59.
11. Blakemore, R. (1975). "Magnetotactic bacteria." *Science*, 190(4212), 377–379.
...
14. Noad, M. J. et al. (2000). "Cultural revolution in whale songs." *Nature*, 408, 537.
15. Foley, C. A. H., Pettorelli, N. & Foley, L. (2008). "Severe drought and calf survival in elephants." *Biology Letters*, 4(5), 541–544.
16. Dacke, M. et al. (2003). "Insect orientation to polarized moonlight." *Nature*, 424, 33.
17. Engels, S. et al. (2014). "Anthropogenic electromagnetic noise disrupts magnetic compass orientation in a migratory bird." *Nature*, 509, 353–356.
18. Chapman, J. W. et al. (2012). "Large-scale seasonal movements of insects." *Science*, 327(5962), 682.
...
21. Ritz, T. et al. (2004). "Resonance effects indicate a radical-pair mechanism for avian magnetic compass." *Nature*, 429, 177–180.
22. Poole, J. H., Payne, K., Langbauer, W. R. & Moss, C. J. (1988). "The social contexts of some very low frequency calls of African elephants." *Behavioral Ecology and Sociobiology*, 22(6), 385–392.
