# R30 — Speciation Mechanisms and Reproductive Isolation
...
> **Cross-References:** R01 — Evolution Overview · [R31 — Primate Evolution](R31_Primate_Evolution_Hominid_Lineage.md) · [ZB25 — Biogeography](R57_Biogeography_Island_Biology.md) · [R36 — Molecular Phylogenetics](R36_Molecular_Phylogenetics_Tree_of_Life.md) · L01 — Genetics Overview
...
|---|-------------|----------|--------|---------|
| 1 | Diagram of allopatric, sympatric, and parapatric speciation modes | — | — | — |

---

## BIBLIOGRAPHY

1. Coyne, J. A. and Orr, H. A. *Speciation.* Sinauer Associates, 2004.
2. Mayr, E. *Systematics and the Origin of Species.* Columbia University Press, 1942.
3. Nosil, P. *Ecological Speciation.* Oxford University Press, 2012.
4. Barluenga, M. et al. "Sympatric Speciation in Nicaraguan Crater Lake Cichlid Fish." *Nature*, vol. 439, 2006, pp. 719–723.
5. Lamichhaney, S. et al. "Evolution of Darwin's Finches and Their Beaks Revealed by Genome Sequencing." *Nature*, vol. 518, 2015, pp. 371–375.
6. Liscovitch-Brauer, N. "Rapid Speciation and Gene Flow in African Cichlids." *Molecular Ecology*, vol. 29, 2020, pp. 4820–4834.
7. Orr, H. A. "The Population Genetics of Speciation: The Evolution of Hybrid Incompatibilities." *Genetics*, vol. 139, 1995, pp. 1805–1813.
8. Seehausen, O. et al. "Genomics and the Origin of Species." *Nature Reviews Genetics*, vol. 15, 2014, pp. 176–192.
9. Soltis, D. E. et al. "Polyploidy and Angiosperm Diversification." *American Journal of Botany*, vol. 96, 2009, pp. 336–348.
10. Noor, M. A. F. "Speciation Driven by Natural Selection in *Drosophila*." *Nature*, vol. 375, 1995, pp. 674–675.
...
|-------------|-----------|
| R01 — Evolution Overview | Speciation is the macroevolutionary outcome of evolutionary processes described in R01 |
| [R31 — Primate Evolution](R31_Primate_Evolution_Hominid_Lineage.md) | Human-chimp speciation involved complex history with possible post-split gene flow |
| [ZB25 — Biogeography](R57_Biogeography_Island_Biology.md) | Island isolation is the classic driver of allopatric speciation and adaptive radiation |
| [R36 — Molecular Phylogenetics](R36_Molecular_Phylogenetics_Tree_of_Life.md) | Molecular phylogenetics identifies species boundaries and divergence times |
| L01 — Genetics Overview | Genomic tools reveal speciation genes and patterns of reproductive isolation |
