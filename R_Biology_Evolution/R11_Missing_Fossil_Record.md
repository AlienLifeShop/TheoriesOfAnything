# R11 — Missing Fossil Record and Punctuated Equilibrium
...
> **Cross-References:** [R03 — Cambrian Explosion](R03_Cambrian_Explosion.md) · [R05 — Mass Extinction Events](R05_Mass_Extinction_Events.md) · [R08 — Convergent Evolution](R08_Convergent_Evolution_Aquatic_Ape.md) · [M01 — Forbidden Archaeology](../M_Forbidden_Archaeology/M01_OOPArts_Catalog.md) · [R09 — Neanderthal Cognition](R09_Neanderthal_Cognition.md)
...
### 1.1 The Incompleteness of the Fossil Record [5/5 sources]
...
### 1.2 Punctuated Equilibrium [4/5 sources]
...
### 1.3 Documented Transitional Fossils [5/5 sources]
...
### 2.1 Stasis as the Norm [3/5 sources]
...
### 2.2 The Cambrian Explosion as the Extreme Case [4/5 sources]
...
- **See R03 — Cambrian Explosion for full analysis**

### 2.3 The "Pull of the Recent" and Sampling Biases [3/5 sources]
...
### 3.1 "The Gaps Are Real Evidence Against Darwinism" [2/5 sources]
...
### 3.2 Saltation — "Hopeful Monsters" [2/5 sources]
...
### 3.3 Deep Time Amnesia — What We'll Never Know [2/5 sources]
...
### 4.1 "The Fossil Record Proves Earth Is Young" [3/5 sources]
...
### 4.2 "Out-of-Place Fossils Prove Time Travel / Advanced Ancient Civilization" [1/5 sources]
- **Almost all "anomalous" fossil claims are misidentifications, hoaxes, or geological reworking** (fossils eroded from older deposits and redeposited in younger ones). See M01 — Forbidden Archaeology for detailed analysis.
...
|---|-------------|----------|--------|---------|
| 1 | Tiktaalik transitional fossil | R11_tiktaalik_001.jpg | Shubin et al. 2006 | Fair Use |
| 2 | Whale evolution skeletal sequence | R11_whale_evolution_002.jpg | Wikimedia Commons | CC BY-SA 3.0 |
| 3 | Punctuated equilibrium vs gradualism | R11_PE_diagram_003.jpg | Adapted from Gould & Eldredge | Fair Use |
| 4 | Fossil preservation bias infographic | R11_taphonomy_004.jpg | Original | CC BY 4.0 |

---

## BIBLIOGRAPHY

1. Eldredge, N. & Gould, S.J. "Punctuated equilibria: an alternative to phyletic gradualism." In *Models in Paleobiology,* ed. T.J.M. Schopf, 82–115. San Francisco: Freeman, Cooper, 1972.
2. Shubin, N.H. et al. "The pectoral fin of Tiktaalik roseae and the origin of the tetrapod limb." *Nature* 440 (2006): 764–771.
3. Thewissen, J.G.M. et al. "Skeletons of terrestrial cetaceans and the relationship of whales to artiodactyls." *Nature* 413 (2001): 277–281.
4. Hunt, G. "The relative importance of directional change, random walks, and stasis in the evolution of fossil lineages." *PNAS* 104 (2007): 18404–18408.
5. Falk, D. et al. "The brain of LB1, Homo floresiensis." *Science* 308 (2005): 242–245.
6. Foote, M. & Sepkoski, J.J. "Absolute measures of the completeness of the fossil record." *Nature* 398 (1999): 415–417.
7. Cheetham, A.H. "Tempo of evolution in a Neogene bryozoan." *Paleobiology* 12 (1986): 190–202.
8. Gould, S.J. *The Structure of Evolutionary Theory.* Cambridge: Harvard University Press, 2002.
9. Carroll, S.B. *Endless Forms Most Beautiful: The New Science of Evo Devo.* New York: Norton, 2005.
10. Alroy, J. et al. "Phanerozoic trends in the global diversity of marine invertebrates." *Science* 321 (2008): 97–100.
...
|-------------|-----------|
| [R03 — Cambrian Explosion](R03_Cambrian_Explosion.md) | The most dramatic "gap" in evolutionary history |
| [R05 — Mass Extinctions](R05_Mass_Extinction_Events.md) | Extinction resets and recovery patterns |
| [R09 — Neanderthal Cognition](R09_Neanderthal_Cognition.md) | Archaic hominin fossil gaps |
| [R08 — Convergent Evolution](R08_Convergent_Evolution_Aquatic_Ape.md) | Morphological patterns and evolutionary constraints |
| [M01 — Forbidden Archaeology](../M_Forbidden_Archaeology/M01_OOPArts_Catalog.md) | Claims of anomalous fossils |
| [R02 — Brain Evolution](R02_Human_Brain_Evolution.md) | Hominin phylogeny gaps |
