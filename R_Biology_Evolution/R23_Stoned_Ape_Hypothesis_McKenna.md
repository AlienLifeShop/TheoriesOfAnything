# R23 — Stoned Ape Hypothesis — Psilocybin, Cognitive Evolution, and the McKenna Theory
...
- **Eleusinian Mysteries**: the *kykeon* drink may have contained ergot alkaloids (→ K17) — a related psychoactive compound (Wasson, Hofmann, & Ruck, *The Road to Eleusis*, 1978).
...
- Mycologist Paul Stamets (2017 interview with Joe Rogan; expanded in *Fantastic Fungi*, 2019) updated McKenna's hypothesis into a broader "mycological hypothesis" of human evolution:
  ...
  - Mycelial networks form the "neurological network of nature" — fungal decomposition of organic matter created fertile soil that enabled human agriculture (→ G03).
...
- This is intriguing but speculative: language evolution likely required genetic changes (e.g., FOXP2 gene — L09), anatomical developments (descended larynx, hyoid bone), and social complexity that cannot be attributed to a single pharmacological trigger.
...
- R. Gordon Wasson (*Soma: Divine Mushroom of Immortality*, 1968) proposed that the Vedic *soma* — a sacred intoxicant described in over 100 Rig Veda hymns (→ A20) — was the psychoactive mushroom *Amanita muscaria*.
...
- Archaeological evidence from Göbekli Tepe (~9600 BCE, → D03) — the world's oldest known temple — includes no direct evidence of psychedelic use, but the site's apparent ritual purpose in a pre-agricultural society is consistent with the hypothesis.
...
3. Catlow, B. J. et al. (2013). "Effects of psilocybin on hippocampal neurogenesis and extinction of trace fear conditioning." *Experimental Brain Research*, 228, 481–491.
...
5. Griffiths, R. R. et al. (2011). "Psilocybin occasioned mystical-type experiences: immediate and persisting dose-related effects." *Journal of Psychopharmacology*, 218(4), 649–665.
6. Davis, A. K. et al. (2021). "Effects of Psilocybin-Assisted Therapy on Major Depressive Disorder." *JAMA Psychiatry*, 78(5), 481–489.
...
9. Wasson, R. G. (1968). *Soma: Divine Mushroom of Immortality*. Harcourt Brace Jovanovich.
10. Wasson, R. G., Hofmann, A., & Ruck, C. A. P. (1978). *The Road to Eleusis: Unveiling the Secret of the Mysteries*. Harcourt Brace Jovanovich.
11. Stamets, P. (2005). *Mycelium Running: How Mushrooms Can Help Save the World*. Ten Speed Press.
12. Szigeti, B. et al. (2021). "Self-blinding citizen science to explore psychedelic microdosing." *eLife*, 10, e62878.
...
14. Wrangham, R. (2009). *Catching Fire: How Cooking Made Us Human*. Basic Books.
15. Dunbar, R. I. M. (1998). "The Social Brain Hypothesis." *Evolutionary Anthropology*, 6(5), 178–190.
16. de Sahagún, B. (1569/1950–82). *Florentine Codex: General History of the Things of New Spain*. Trans. Anderson & Dibble.
