# R17 — Symbiogenesis — Lynn Margulis and Cooperative Evolution
...
> **Cross-References:** R01, R06, L01, L08, Q02, G07, R18
...
- **Andreas Schimper** (1883) — noted that chloroplasts resemble free-living cyanobacteria and divide independently
- **Konstantin Mereschkowski** (1905) — coined the term "symbiogenesis" and proposed that chloroplasts originated from endosymbiosis; largely ignored
- **Ivan Wallin** (1927) — proposed that mitochondria were once free-living bacteria in *Symbionticism and the Origin of Species*; ridiculed by contemporaries
- **All three were ultimately vindicated** — but recognition came decades later
...
| **Unit of selection** | Gene (Dawkins) or individual | Holobiont — organism + its microbial community (→ L08) |
...
- **Prokaryote-to-prokaryote HGT** is pervasive (antibiotic resistance spreading, metabolic genes exchanged)
- **Prokaryote-to-eukaryote HGT** is documented (e.g., genes from *Wolbachia* bacteria inserted into insect genomes)
- **Endogenous retroviruses** constitute ~8% of the human genome (→ R18)
- **Bdelloid rotifers** — animals that have incorporated ~8% of their genome from bacteria, fungi, and plants via HGT
- The **Tree of Life** is increasingly recognized as a "web" or "network" of life, with extensive lateral gene transfer

### 3.3 Connection to Gaia Theory

Margulis collaborated with **James Lovelock** on the **Gaia hypothesis** (→ G07), which proposes that Earth's biosphere functions as a self-regulating system. Symbiogenesis provides a mechanism: cooperation and mutualism at every biological scale (molecular → cellular → organismal → ecosystem → planetary) create regulatory feedbacks that maintain habitable conditions.
...
3. Sagan, L. (1967). "On the Origin of Mitosing Cells." *Journal of Theoretical Biology*, 14(3), 225-274.
4. Gray, M. W. (2012). "Mitochondrial Evolution." *Cold Spring Harbor Perspectives in Biology*, 4(9), a011403.
5. McFall-Ngai, M., et al. (2013). "Animals in a Bacterial World, a New Imperative for the Life Sciences." *PNAS*, 110(9), 3229-3236.
6. Archibald, J. M. (2014). *One Plus One Equals One: Symbiosis and the Evolution of Complex Life*. Oxford University Press.
7. Keeling, P. J. (2010). "The Endosymbiotic Origin, Diversification and Fate of Plastids." *Philosophical Transactions of the Royal Society B*, 365, 729-748.
8. Woese, C. R. (1977). "Phylogenetic Structure of the Prokaryotic Domain." *PNAS*, 74(11), 5088-5090.
9. Rosenberg, E., & Zilber-Rosenberg, I. (2013). *The Hologenome Concept: Human, Animal and Plant Microbiota*. Springer.
10. Doolittle, W. F. (1999). "Phylogenetic Classification and the Universal Tree." *Science*, 284(5423), 2124-2128.
11. Spang, A., et al. (2015). "Complex Archaea That Bridge the Gap Between Prokaryotes and Eukaryotes." *Nature*, 521, 173-179.
