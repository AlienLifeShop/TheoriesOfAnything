...
> **Cross-References:** [I_2_01](../I2_Government_Programs_Policy/I_2_01_UAP_Government_Disclosure_Timeline.md) ·
...
- **CE-1:** Close visual observation within ~150 meters.
- **CE-2:** Physical effects—ground traces, vehicle interference,
  physiological effects, electromagnetic disturbance.
- **CE-3:** Observation of occupants or entities associated with UAP.

Later extensions by ufologists:
- **CE-4:** Abduction or unwilling transport.
- **CE-5:** Conscious or initiated contact (Greer's addition).
...
- AN1 — Unusual light or unexplained explosion.
- AN2 — Physical entity (UFO with definite shape).
- AN3 — Entity with associated beings.
- AN4 — Witness experiences altered reality or time distortion.
- AN5 — Anomaly results in permanent injury or physiological change.

**Maneuver types (MA1–MA5):**
- MA1 — Distant observation of UAP trajectory.
- MA2 — Physical effects observed at distance.
- MA3 — Entities observed at distance.
- MA4 — Time or reality distortion at distance.
- MA5 — Permanent injury or death at distance.
...
UAP events by:
- **Domain:** Airborne, transmedium, submerged, space, ground-based.
- **Sensor confirmation:** Visual only, single-sensor, multi-sensor,
  radar-visual.
- **Assessment:** Identified, insufficient data, anomalous.
...
- **Multiple simultaneous NHI types:** The phenomenon may involve
...
- **Consciousness-based NHI:** Some NHI may be non-physical,
  existing as consciousness patterns or information structures
  without material bodies, intersecting with panpsychism.

- **NHI with historical religious identity:** Mapping NHI categories
...
- **Temporal NHI:** Some NHI may be future humans or temporal
...
- **Comprehensive NHI species catalogs:** Detailed lists of alien
  species (Greys, Nordics, Reptilians, Arcturians, Pleiadians)
  with defined home planets lack any verifiable basis.

- **NHI diplomatic treaties:** Claims of formal treaties between
  NHI species and world governments have no declassified support.

- **Complete government NHI taxonomy:** Assertions that a validated
...
1. Bracewell, R.N. (1960). *Nature*, 186, 670–671. DOI: 10.1038/186670a0. ISBN: 9780451529060
2. Clancy, S.A. (2005). *Abducted*. Harvard UP.
3. Dolan, R.M. (2009). *UFOs and the National Security State, Vol. 2*.
4. Drake, F. (1961). *Physics Today*, 14(4), 40–46.
...
17. U.S. Congress (2023). *FY2024 NDAA*, Section 1841.
...
20. Wendt, A. & Duvall, R. (2008). *Political Theory*, 36(4), 607–633. DOI: 10.1177/0090591708317902.
...
|----------|-------------|-----------|
| [I_2_01](../I2_Government_Programs_Policy/I_2_01_UAP_Government_Disclosure_Timeline.md) | Framework | Foundational UAP context |
| [I_5_02](../I5_Cultural_Psychological_Phenomena/I_5_02_Alien_Abduction_Phenomenon.md) | Direct | CE-4 encounters/entity types |
| [B_2_01](../../B_Beings_and_Entities/B2_Humanoid_Crypto_Entities/B_2_01_Reptilian_Beings_Overview.md) | Thematic | Cross-cultural entity typology |
| [I_5_06](../I5_Cultural_Psychological_Phenomena/I_5_06_UAP_Consciousness_Interface_Psychic_Component.md) | Direct | Consciousness-based NHI hypotheses |
| [Q_3_03](../../Q_Cosmology_Physics/Q3_Planetary_Solar_Astrobiology/Q_3_03_Exoplanets_Habitable_Zones.md) | Contextual | Exoplanet ETH support |
| [I_2_03](../I2_Government_Programs_Policy/I_2_03_Black_Programs_SAPs_UFO_Coverup.md) | Direct | Government NHI investigation |
| [I_3_03](../I3_Key_Cases_Incidents/I_3_03_Mass_UAP_Sightings_Multi_Witness_Events.md) | Direct | Observational data for classification |
