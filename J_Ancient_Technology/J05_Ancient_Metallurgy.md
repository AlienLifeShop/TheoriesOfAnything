...
- **Bronze (~3,300 BCE):** copper + tin (typically 8-12%). Much harder and more durable than pure copper. The Bronze Age begins.
  - **Tin problem:** tin deposits are RARE and geographically distant from major civilizations. Cornwall (England), Iberia, Afghanistan, Thailand — tin trade networks spanned thousands of km (see F03)
...
- **Connection to J04 — Acoustic Technology:** if sound was used in construction AND metallurgy, it represents a broader "acoustic technology" paradigm in ancient engineering
...
|---|-------------|----------|--------|---------|
| 1 | Delhi Iron Pillar | J05_delhi_iron_pillar_001.jpg | Wikimedia Commons | CC BY-SA 3.0 |
| 2 | Damascus steel watered pattern | J05_damascus_pattern_002.jpg | Wikimedia Commons | CC BY 2.0 |
| 3 | Carbon nanotubes in Damascus steel TEM | J05_damascus_nanotubes_003.jpg | Reibold et al. 2006 (adapted) | Fair Use |
| 4 | Viking Ulfberht sword inscription | J05_ulfberht_inscription_004.jpg | Wikimedia Commons | CC BY-SA 3.0 |
| 5 | Haya furnace reconstruction | J05_haya_furnace_005.jpg | Schmidt 1978 (adapted) | Fair Use |
...
|-------------|-----------|
| [J03 — Lost Material Science](J03_Lost_Material_Science.md) | Roman concrete, Damascus steel — expanded analysis |
| [F03 — Bronze Age Trade](../F_Lost_Connections/F03_Bronze_Age_Trade_Networks.md) | Tin trade networks drove metallurgical development |
| [A04 — Book of Enoch](../A_Foundations/A04_Book_of_Enoch_and_Watchers.md) | Azazel teaching metalworking as "forbidden knowledge" |
| [D05 — Megalithic Engineering](../D_Sites_and_Artifacts/D05_Megalithic_Impossible_Engineering.md) | Stone tools produced the metal tools |
| [C05 — Credo Mutwa](../C_Global_Traditions/C05_Credo_Mutwa_African_Traditions.md) | African metallurgical traditions and Ogun |
| [J04 — Acoustic Technology](../J_Ancient_Technology/J04_Acoustic_Vibrational_Technology.md) | Sound in smelting processes |
| [C08 — Cross-Cultural Patterns](../C_Global_Traditions/C08_Cross_Cultural_Patterns.md) | Universal "divine smith" archetype |
