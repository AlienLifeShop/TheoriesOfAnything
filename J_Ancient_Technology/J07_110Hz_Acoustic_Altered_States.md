# J07 — 110 Hz Resonance and Acoustic Altered States
...
**Newgrange** (Brú na Bóinne complex, County Meath, Ireland) is a passage tomb predating the Egyptian pyramids by ~600 years. While primarily known for its winter solstice alignment (see **E15**), the inner chamber has significant acoustic properties.
...
**Göbekli Tepe** (southeastern Turkey, see **D01**) — the oldest known monumental architecture — includes stone circles with T-shaped pillars that may have acoustic significance.
...
- See **J06** (Sound, Vibration, and Creation) for the broader context of sound-matter interaction in ancient thought
...
- **D15** — Chavín de Huántar: Full archaeological context for Kolar's acoustic research
...
*Document J07 — Part of the Theories of Everything project*
