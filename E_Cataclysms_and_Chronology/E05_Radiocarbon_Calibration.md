...
- **Solar activity** — sunspot cycles modulate cosmic ray flux
- **Earth's magnetic field** — weaker field → more cosmic rays → more ¹⁴C (see E06)
- **Ocean circulation** — the ocean is a massive carbon reservoir
- **Volcanic emissions** — volcanoes release "dead" (¹⁴C-free) CO₂
- **Cosmic events** — supernovae, gamma-ray bursts spike ¹⁴C (e.g., Miyake Events of 774 CE, 993 CE)
...
- Tree rings provide **independent, annual-resolution** chronology
- Each ring = one year; patterns matched across overlapping timber (cross-dating)
- **Bristlecone pine** chronology extends back ~13,000 years (Ferguson, 1969; Salzer et al., 2019)
- **European oak** chronology extends back ~12,460 years (Friedrich et al., 2004)
- By measuring ¹⁴C in tree rings of known calendar age, calibration curves are built year by year
...
- Short-term ¹⁴C fluctuations (~100–200 year timescales) create "wiggles" in the curve
- A single measurement in a wiggly zone can calibrate to **2–3+ possible calendar age ranges**
- Solution: multiple samples in stratigraphic order + Bayesian modeling (§5)
...
- Combines multiple ¹⁴C dates with prior information (stratigraphy, context)
- Builds a **probability model** incorporating:
  - Radiocarbon measurement and uncertainty
  - Calibration curve and uncertainty
  - Stratigraphic relationships (layer A must be older than B)
  - Archaeological constraints
- Result: **posterior probability distribution** for calendar age of each event

### 5.2 OxCal Software
- Developed by **Christopher Bronk Ramsey**, University of Oxford
- Most widely used Bayesian modeling software in archaeology
- Free, public: https://c14.arch.ox.ac.uk/oxcal.html
- Reference: Bronk Ramsey, C. (2009). *Radiocarbon* 51(1), 337–360.

### 5.3 What It Achieves
- **Dramatically tightens date ranges** — ±100 year uncertainty → ±30 years with stratigraphy
- **Identifies outliers** — flags potentially contaminated or reworked dates
- **Estimates phase durations** — how long a construction episode lasted
- Example: Stonehenge chronology refined from "3000–2000 BCE" to precisely dated construction phases constrained to decades
...
| **Archaeomagnetism** | Fired materials | ~10,000 years | Pottery, kilns, hearths (see E06) |
...
- Hogg, A.G., et al. (2020). SHCal20. *Radiocarbon* 62(4), 759–778.
- Heaton, T.J., et al. (2020). Marine20. *Radiocarbon* 62(4), 779–820.

### Bayesian Modeling
- Bronk Ramsey, C. (2009). *Radiocarbon* 51(1), 337–360.
- Buck, C.E., et al. (1991). *Antiquity* 65(249), 808–821.
...
| **Archaeomagnetic dating** | Compares magnetic direction/intensity recorded in heated materials (kilns, hearths) to known geomagnetic secular variation curves | ~10,000 years | Fired structures in situ | Requires regional reference curves; materials must not have moved since firing | Cross-ref E06 |
...
- **No single dating method is sufficient.** The strongest chronological claims in this project are those supported by MULTIPLE INDEPENDENT methods:
  - Göbekli Tepe (D01): Radiocarbon + stratigraphy + typology = VERY SECURE
  - Great Pyramid (D02): Radiocarbon (mortar charcoal, Bonani 2001) + historical records + archaeoastronomy = SECURE but with 100–200 year offsets (old wood problem)
  - Sphinx (D03): Geological stratigraphy ONLY — no datable materials = INSECURE for alternative dating claims
  - Gunung Padang (M02): Radiocarbon from SOIL, not construction materials = HIGHLY QUESTIONABLE
  - Serpent Mound (D06): Multiple conflicting radiocarbon dates from different excavations = DEBATE ONGOING
- **IntCal20 update (2020):** The current calibration curve extends to 55,000 cal BP using tree rings, floating tree-ring sequences, marine corals (U-Th dated), and speleothems. It resolved several problems in IntCal13, particularly in the 40,000–55,000 BP range where ¹⁴C dates are most imprecise.
