# E27 — Doggerland and Sundaland — Drowned Continental Shelves
...
- Given that ~5% of the world's continental shelves were exposed during the LGM, some researchers suggest that **early complex settlements** may exist on now-submerged coastlines
...
|-------------|-----------|
| [E01 — Younger Dryas Impact](../E_Cataclysms_and_Chronology/E01_Younger_Dryas_Impact.md) | Younger Dryas climate reversal and its role in the deglacial sea level curve |
| [F19 — Sundaland and Eden East Hypothesis](../F_Lost_Connections/F19_Sundaland_Eden_East_Hypothesis.md) | Oppenheimer's theory that Sundaland was the cradle of maritime civilization |
| [E10 — Catastrophic Flood Geomorphology](../E_Cataclysms_and_Chronology/E10_Catastrophic_Flood_Geomorphology.md) | Storegga tsunami and catastrophic flooding mechanisms |
| [E18 — Ice Age Civilizations (LGM)](../E_Cataclysms_and_Chronology/E18_Ice_Age_Civilizations_LGM.md) | Human populations on now-submerged continental shelves during the LGM |
| [E22 — Late Antiquity Little Ice Age](../E_Cataclysms_and_Chronology/E22_Late_Antiquity_Little_Ice_Age.md) | Climate oscillation patterns across the Holocene |
