...
## DOCUMENT NAVIGATION
- [§1 The Event — What Happened](#1-the-event--what-happened)
- [§2 Global Consequences](#2-global-consequences)
- [§3 Ragnarök and Mythological Connections](#3-ragnarök-and-mythological-connections)
...
**However**: the precise dating of Teotihuacan's collapse remains debated, with some scholars placing the fire event as late as 600–650 CE. The connection to 536 is plausible but not proven.
...
- **Flood myths → real floods**: The global distribution of flood narratives (see E01, C02) may encode memories of post-glacial sea-level rise, tsunami events, or outburst flooding
...
- **Cargo cults → one-generation mythologization** (see C10): Modern examples show that technology encounters can be mythologized within a single generation
...
- **Younger Dryas** (E01): Impact/climate event → agricultural revolution → flood myths
...
### 4.2 Connection to E01 — Younger Dryas Impact
...
### 4.3 Connection to E09 — Rise and Fall of Civilizations
...
### 4.4 Connection to E12 — Cyclical Destruction and Renewal

The 536 event and Ragnarök fit squarely within E12's framework of cyclical destruction-renewal narratives. The key insight: Ragnarök is one of the few mythological destruction narratives that may be **directly traceable to a specific historical event**. This makes it a critical test case for the broader hypothesis that cyclical destruction myths encode real catastrophes.

### 4.5 Connection to A12 — Norse Eddas

A12 provides the primary textual analysis of the *Poetic Edda* and *Prose Edda*. E13 focuses specifically on the **historical and environmental context** that may underlie the Ragnarök narrative. The two documents should be read together: A12 for textual analysis, E13 for the climate science and archaeological evidence.

### 4.6 Connection to R05 — Mass Extinction Events
...
### 4.7 Connection to C10 — Cargo Cult Analogy
...
- **A12** — Norse Eddas: Primary textual source for Ragnarök, Fimbulvetr, and Surtr narratives; E13 provides the historical/scientific substrate
- **E01** — Younger Dryas Impact: Structural parallel — abrupt climate catastrophe encoding into mythology; both events triggered civilizational transformation
- **E09** — Rise and Fall of Civilizations: Tainter/Turchin frameworks applied to 6th-century collapse dynamics
...
*Document E13 — Part of the Theories of Everything project*
