...
| **~12,800 BP** | **Younger Dryas Event** | Potential airbursts causing cooling/extinction (see E01) | **TIER 2** |
...
|-------------|--------------|---------|----------|-------|
| **Theia Impact** | Planet-scale | ~4,500 | Global | Moon-forming giant impact (see E03) |
...
| **YD Impact(s)** | No crater | ~12,900 BP | Airburst hypothesis; no confirmed crater (see E01) |
...
### GPT5.2 Source URLs
- S1–S16: CNEOS stats, NASA PDCO, DART, ESA Hera, asteroid/meteorite basics, Chicxulub, Tunguska, Chelyabinsk, Earth Impact Database, NEO Surveyor, Congressional NEO Survey Act
