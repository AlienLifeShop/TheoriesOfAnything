...
- **Connection to Younger Dryas Impact Hypothesis (E01):** the same institutional bias that rejected Bretz for 40 years may be affecting reception of the YDIH
...
- **Connection to D13 — Submerged Structures:** documented examples of submerged architecture exist (Yonaguni, Dwarka, Pavlopetri, Doggerland artifacts) — these are only from shallow water. The DEEPER shelves are largely unsurveyed.
...
|---|-------------|----------|--------|---------|
| 1 | Dry Falls aerial photo | E10_dry_falls_001.jpg | Wikimedia Commons | PD (USGS) |
| 2 | Giant ripple marks Camas Prairie | E10_giant_ripples_002.jpg | Wikimedia Commons | CC BY 2.0 |
| 3 | English Channel flood channel sonar | E10_english_channel_003.png | Gupta et al. 2007 (adapted) | Fair Use |
| 4 | Global sea level curve last 20,000 years | E10_sea_level_curve_004.png | Wikimedia Commons | CC BY-SA 4.0 |
...
|-------------|-----------|
| [C02 — Global Flood Stories](../C_Global_Traditions/C02_Global_Flood_Stories.md) | Geological events underlying mythology |
| [E01 — Younger Dryas](E01_Younger_Dryas_Impact.md) | Impact-triggered flooding and ice destabilization |
| [D13 — Submerged Structures](../D_Sites_and_Artifacts/D13_Submerged_Structures_Underwater_Archaeology.md) | Civilizations lost to flooding |
| [C03 — Flood Serpent Connection](../C_Global_Traditions/C03_Flood_Serpent_Connection.md) | Serpentine flood-bringers in myth |
| [E09 — Rise and Fall](E09_Rise_Fall_Civilizations.md) | Flood as civilizational reset event |
| [B07 — Ancient Rulers](../B_Beings_and_Entities/B07_Ancient_Rulers_Lifespans.md) | Pre-flood vs. post-flood Sumerian king lists |
| [F06 — Agricultural Revolution](../F_Lost_Connections/F06_Agricultural_Revolution.md) | Post-flood populations adopt agriculture |
