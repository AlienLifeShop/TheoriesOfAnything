# ZA04 — Gravity, Gravitational Waves, and Anomalous Gravitational Claims
...
> **Cross-References:** Q01, Q02, Q03, S12, J05, Q37
...
> **Last Updated:** Feb 28, 2026 | **Source Count:** 11 | **Weighted Score:** 28 | **Source Confidence:** [3/5] | **Confidence:** High (established physics); Low (anomalous claims)
...
- Unified terrestrial mechanics (falling apples) with celestial mechanics (planetary orbits)
- Enabled prediction of Halley's Comet return, discovery of Neptune (1846) from orbital anomalies of Uranus
- **Limitation**: Gravity acts instantaneously at a distance ("action at a distance") — Newton himself considered this philosophically troubling
...
Key insights:
- **Mass-energy curves spacetime**; objects follow geodesics (straightest possible paths) through curved spacetime
- Gravity is not a "force" in the Newtonian sense but a consequence of geometry
- Predictions confirmed: Mercury's perihelion precession, gravitational lensing (1919 solar eclipse), gravitational redshift, gravitational time dilation (GPS satellites require GR corrections — ~38 μs/day fast without correction)
...
- Critics have noted that extraordinary claims about Gravity, Gravitational Waves, and Anomalous Gravitational Claims require extraordinary evidence, which in many cases has not been provided.
- An opposing view holds that conventional explanations fully account for the phenomena attributed to Gravity, Gravitational Waves, and Anomalous Gravitational Claims.
- Some researchers have attempted to debunk specific claims by pointing to misidentified artifacts, mistranslations, or misinterpreted data.
- Alternative explanations grounded in mainstream science are available for most phenomena associated with Gravity, Gravitational Waves, and Anomalous Gravitational Claims.
...
- Critics argue that selection bias and confirmation bias may distort the analysis of evidence related to Gravity, Gravitational Waves, and Anomalous Gravitational Claims.
...
| Document | Connection |
|----------|------------|
| [Q01 — Cosmology Overview](../Q_Cosmology_Physics/Q01_Anthropic_Principle_Fine_Tuning.md) | Gravitational structure of the universe |
| [Q02 — Cosmological Models](../Q_Cosmology_Physics/Q02_Big_Bang_Alternative_Cosmologies.md) | Dark energy, cosmological constant |
| [Q03 — Quantum Theory](../Q_Cosmology_Physics/Q03_Ancient_Cosmologies_Compared.md) | Quantum gravity problem |
| [S12 — Energy Futures](../S_Future_Technology/S12_Energy_Futures_Fusion_Thorium.md) | Exotic energy claims; zero-point energy |
| [Q37 — Plasma Cosmology](../Q_Cosmology_Physics/Q37_Plasma_Cosmology_Electric_Universe.md) | Alternative gravity/cosmology models |
...
2. Abbott, B. P., et al. (LIGO/Virgo Collaboration). (2016). "Observation of Gravitational Waves from a Binary Black Hole Merger." *Physical Review Letters*, 116(6), 061102. ISBN: 9789996324147. DOI: 10.1142/9789814699662_0011
3. Abbott, B. P., et al. (2017). "GW170817: Observation of Gravitational Waves from a Binary Neutron Star Inspiral." *Physical Review Letters*, 119(16), 161101. ISBN: 9789996324147. DOI: 10.1103/physrevd.97.043015
4. Rovelli, C. (2004). *Quantum Gravity*. Cambridge University Press.
5. Milgrom, M. (1983). "A Modification of the Newtonian Dynamics as a Possible Alternative to the Hidden Mass Hypothesis." *Astrophysical Journal*, 270, 365-370. ISBN: 9781018793733. DOI: 10.1086/161130
6. Clowe, D., et al. (2006). "A Direct Empirical Proof of the Existence of Dark Matter." *Astrophysical Journal Letters*, 648(2), L109-L113. DOI: 10.1086/508162
7. Everitt, C. W. F., et al. (2011). "Gravity Probe B: Final Results of a Space Experiment to Test General Relativity." *Physical Review Letters*, 106(22), 221101. ISBN: 9789996324147. DOI: 10.1103/physrevlett.106.221101
8. Verlinde, E. (2011). "On the Origin of Gravity and the Laws of Newton." *Journal of High Energy Physics*, 2011, 29. ISBN: 9789810212537
9. Podkletnov, E. (1997). "Weak Gravitational Shielding Properties of Composite Bulk YBa₂Cu₃O₇₋ₓ Superconductor Below 70 K Under E.M. Field." *arXiv: cond-mat/9701074*.
10. Agazie, G., et al. (NANOGrav Collaboration). (2023). "The NANOGrav 15 yr Data Set: Evidence for a Gravitational-Wave Background." *Astrophysical Journal Letters*, 951, L8.
