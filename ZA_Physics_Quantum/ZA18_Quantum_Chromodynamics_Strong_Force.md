# ZA18 — Quantum Chromodynamics: The Strong Nuclear Force
...
> **Cross-References:** [ZA07 — Standard Model](Q21_Standard_Model_Particle_Physics.md) · [ZA10 — QFT](Q26_Quantum_Field_Theory_Foundations.md) · [ZA11 — Nuclear Physics](Q27_Nuclear_Physics_Fission_Fusion.md) · [ZA16 — Plasma Physics](Q36_Plasma_Physics_Fourth_State_Matter.md) · [ZA14 — Antimatter](Q34_Antimatter_CP_Violation_Baryogenesis.md)
...
1. Gross, D. J. and Wilczek, F. "Ultraviolet Behavior of Non-Abelian Gauge Theories." *Physical Review Letters*, vol. 30, 1973, pp. 1343–1346.
2. Politzer, H. D. "Reliable Perturbative Results for Strong Interactions?" *Physical Review Letters*, vol. 30, 1973, pp. 1346–1349.
3. Gell-Mann, M. "A Schematic Model of Baryons and Mesons." *Physics Letters*, vol. 8, 1964, pp. 214–215.
4. Wilson, K. G. "Confinement of Quarks." *Physical Review D*, vol. 10, 1974, pp. 2445–2459.
5. Friedman, J. I. and Kendall, H. W. "Deep Inelastic Electron Scattering." *Annual Review of Nuclear Science*, vol. 22, 1972, pp. 203–254.
6. Aaij, R. et al. (LHCb Collaboration). "Observation of J/ψp Resonances Consistent with Pentaquark States." *Physical Review Letters*, vol. 115, 2015, 072001.
7. Adams, J. et al. (STAR Collaboration). "Experimental and Theoretical Challenges in the Search for the Quark-Gluon Plasma." *Nuclear Physics A*, vol. 757, 2005, pp. 102–183.
8. Bazavov, A. et al. "Equation of State in (2+1)-Flavor QCD." *Physical Review D*, vol. 90, 2014, 094503.
9. Bethke, S. "Experimental Tests of Asymptotic Freedom." *Progress in Particle and Nuclear Physics*, vol. 58, 2007, pp. 351–386.
10. Greensite, J. *An Introduction to the Confinement Problem.* 2nd ed., Springer, 2020.
...
|-------------|-----------|
| [ZA07 — Standard Model](Q21_Standard_Model_Particle_Physics.md) | QCD is the SU(3) gauge theory component of the Standard Model |
| [ZA10 — QFT](Q26_Quantum_Field_Theory_Foundations.md) | QCD is a quantum field theory — renormalization group, running coupling |
| [ZA11 — Nuclear Physics](Q27_Nuclear_Physics_Fission_Fusion.md) | The nuclear force between nucleons is a residual effect of QCD color force |
| [Q20 — Nucleosynthesis](../Q_Cosmology_Physics/Q20_Nucleosynthesis_Element_Formation.md) | QCD determines nuclear binding energies that drive stellar fusion |
| [ZA16 — Plasma Physics](Q36_Plasma_Physics_Fourth_State_Matter.md) | Quark-gluon plasma is the highest-temperature state of matter |
