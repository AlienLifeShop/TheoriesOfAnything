# ZA25 — Particle Accelerators and Colliders: Probing the Fundamental Structure of Matter
...
> **Cross-References:** [ZA07 — Standard Model](Q21_Standard_Model_Particle_Physics.md) · [ZA10 — Quantum Field Theory](Q26_Quantum_Field_Theory_Foundations.md) · [ZA19 — Electroweak Unification](Q39_Electroweak_Unification_Weak_Force.md) · [ZA18 — QCD](Q38_Quantum_Chromodynamics_Strong_Force.md) · [ZA20 — Grand Unified Theories](Q40_Grand_Unified_Theories.md)
...
|---|-------------|----------|--------|---------|
| 1 | Schematic cross-section of the CMS detector showing tracker, calorimeters, and muon system | — | — | — |

---

## BIBLIOGRAPHY

1. ATLAS Collaboration. "Observation of a New Particle in the Search for the Standard Model Higgs Boson with the ATLAS Detector at the LHC." *Physics Letters B*, vol. 716, 2012, pp. 1–29.
2. CMS Collaboration. "Observation of a New Boson at a Mass of 125 GeV with the CMS Experiment at the LHC." *Physics Letters B*, vol. 716, 2012, pp. 30–61.
3. Evans, L. and Bryant, P. "LHC Machine." *Journal of Instrumentation*, vol. 3, 2008, S08001.
4. Wilson, E. J. N. *An Introduction to Particle Accelerators.* Oxford University Press, 2001.
5. Wiedemann, H. *Particle Accelerator Physics.* 4th ed., Springer, 2015.
6. ATLAS Collaboration. "A Detailed Map of Higgs Boson Interactions by the ATLAS Experiment Ten Years After the Discovery." *Nature*, vol. 607, 2022, pp. 52–59.
7. FCC Collaboration. "FCC-hh: The Hadron Collider." *European Physical Journal Special Topics*, vol. 228, 2019, pp. 755–1107.
8. Delahaye, J.-P. et al. "Muon Colliders." arXiv:1901.06150 [physics.acc-ph], 2019.
9. Adli, E. et al. "Acceleration of Electrons in the Plasma Wakefield of a Proton Bunch." *Nature*, vol. 561, 2018, pp. 363–367.
10. Ellis, J. et al. "Review of Safety of LHC Collisions." *Journal of Physics G*, vol. 35, 2008, 115004.
...
|-------------|-----------|
| [ZA07 — Standard Model](Q21_Standard_Model_Particle_Physics.md) | Accelerators discovered all Standard Model particles; LHC completed the set with the Higgs |
| [ZA10 — Quantum Field Theory](Q26_Quantum_Field_Theory_Foundations.md) | QFT provides theoretical prediction framework tested by accelerator experiments |
| [ZA19 — Electroweak Unification](Q39_Electroweak_Unification_Weak_Force.md) | W and Z bosons discovered at SppS collider (CERN, 1983); Higgs mechanism confirmed at LHC |
| [ZA18 — QCD](Q38_Quantum_Chromodynamics_Strong_Force.md) | Deep inelastic scattering at SLAC discovered quarks; LHC jet physics tests QCD at highest energies |
| [ZA20 — Grand Unified Theories](Q40_Grand_Unified_Theories.md) | Future colliders aim to test GUT predictions (proton decay limits, coupling unification) |
