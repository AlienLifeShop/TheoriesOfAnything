# ZA19 — Electroweak Unification: The Weak Nuclear Force
...
> **Cross-References:** [ZA07 — Standard Model](Q21_Standard_Model_Particle_Physics.md) · [ZA18 — QCD](Q38_Quantum_Chromodynamics_Strong_Force.md) · [ZA10 — QFT](Q26_Quantum_Field_Theory_Foundations.md) · [ZA14 — Antimatter CP Violation](Q34_Antimatter_CP_Violation_Baryogenesis.md) · [ZA15 — Neutrinos](Q35_Neutrino_Physics_Oscillations.md)
...
- Cross-reference: [ZA14 — Antimatter](Q34_Antimatter_CP_Violation_Baryogenesis.md)
...
- Cross-reference: [ZA14 — CP Violation](Q34_Antimatter_CP_Violation_Baryogenesis.md)
...
- Cross-reference: [ZA20 — Grand Unified Theories](Q40_Grand_Unified_Theories.md)
...
1. Weinberg, S. "A Model of Leptons." *Physical Review Letters*, vol. 19, 1967, pp. 1264–1266.
2. Glashow, S. L. "Partial-Symmetries of Weak Interactions." *Nuclear Physics*, vol. 22, 1961, pp. 579–588.
3. Wu, C. S. et al. "Experimental Test of Parity Conservation in Beta Decay." *Physical Review*, vol. 105, 1957, pp. 1413–1415.
4. 't Hooft, G. "Renormalizable Lagrangians for Massive Yang-Mills Fields." *Nuclear Physics B*, vol. 35, 1971, pp. 167–188.
5. Arnison, G. et al. (UA1 Collaboration). "Experimental Observation of Isolated Large Transverse Energy Electrons with Associated Missing Energy at √s = 540 GeV." *Physics Letters B*, vol. 122, 1983, pp. 103–116.
6. Hasert, F. J. et al. (Gargamelle). "Observation of Neutrino-Like Interactions Without Muon or Electron in the Gargamelle Neutrino Experiment." *Physics Letters B*, vol. 46, 1973, pp. 138–140.
7. LEP Electroweak Working Group. "Precision Electroweak Measurements on the Z Resonance." *Physics Reports*, vol. 427, 2006, pp. 257–454.
8. Kobayashi, M. and Maskawa, T. "CP-Violation in the Renormalizable Theory of Weak Interaction." *Progress of Theoretical Physics*, vol. 49, 1973, pp. 652–657.
9. Aad, G. et al. (ATLAS Collaboration). "Observation of a New Particle in the Search for the Standard Model Higgs Boson with the ATLAS Detector at the LHC." *Physics Letters B*, vol. 716, 2012, pp. 1–29.
10. Langacker, P. *The Standard Model and Beyond.* 2nd ed., CRC Press, 2017.
...
|-------------|-----------|
| [ZA07 — Standard Model](Q21_Standard_Model_Particle_Physics.md) | Electroweak theory is the SU(2)×U(1) sector of the Standard Model |
| [ZA18 — QCD](Q38_Quantum_Chromodynamics_Strong_Force.md) | Strong and electroweak forces are the two pillars of particle physics |
| [ZA15 — Neutrinos](Q35_Neutrino_Physics_Oscillations.md) | Neutrinos interact only via the weak force — W and Z exchange |
| [ZA14 — CP Violation](Q34_Antimatter_CP_Violation_Baryogenesis.md) | CKM matrix CP violation operates through weak interactions |
| [ZA10 — QFT](Q26_Quantum_Field_Theory_Foundations.md) | Electroweak theory is a gauge QFT with spontaneous symmetry breaking |
