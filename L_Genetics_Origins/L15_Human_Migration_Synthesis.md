# L15 — Human Migration Synthesis — DNA, Language, and Culture
...
- **Ancient DNA methodology (Svante Pääbo).**
...
- **Bantu expansion genetic signature.**
...
- **Austronesian expansion traced by genetics.**
...
- **HUGO Pan-Asian SNP Consortium findings.**
...
- **Three-component European ancestry model.**
...
- **Peopling of the Americas via Beringia.**
...
- **Ancient DNA from Africa increasingly available.**
...
- **Coastal "beachcomber" migration route.**
...
- **Cavalli-Sforza's gene-language correlation.**
...
- **Multiple dispersal waves from Africa.**
...
- **Indo-European language spread via steppe.**
...
- **Denisovan admixture in Island Southeast Asia and Oceania.**
...
- **Neanderthal admixture gradient.**
...
- **Pre-Clovis Pacific coastal entry to the Americas.**
...
- **Language as a proxy for prehistoric population structure.**
...
- **Sahul as a single migration event.**
...
- **Trans-Pacific contact hypotheses.**
...
- **Hyper-diffusionism from a single advanced culture.**
...
- **Race-based migration hierarchies.**
...
- **Ancient global maritime civilization predating OOA.**
...
- **DNA as "memory" of ancestral experiences.**
...
1. Ramachandran, S. et al. (2005). "Support from the relationship of genetic and geographic distance in human populations for a serial founder effect originating in Africa." *PNAS*, 102(44), 15942–15947.
2. Li, J. Z. et al. (2008). "Worldwide human relationships inferred from genome-wide patterns of variation." *Science*, 319(5866), 1100–1104.
...
5. Haak, W. et al. (2015). "Massive migration from the steppe was a source for Indo-European languages in Europe." *Nature*, 522(7555), 207–211.
6. Narasimhan, V. M. et al. (2019). "The formation of human populations in South and Central Asia." *Science*, 365(6457), eaat7487.
7. Patin, E. et al. (2017). "Dispersals and genetic adaptation of Bantu-speaking populations in Africa and North America." *Science*, 356(6337), 543–546.
8. Lipson, M. et al. (2014). "Reconstructing Austronesian population history in Island Southeast Asia." *Nature Communications*, 5, 4689.
...
14. Anthony, D. W. (2007). *The Horse, the Wheel, and Language.* Princeton University Press.
