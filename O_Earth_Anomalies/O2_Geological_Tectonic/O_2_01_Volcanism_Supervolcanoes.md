...
## DOCUMENT NAVIGATION
- [§1 Volcanism Fundamentals](#1-volcanism-fundamentals)
- [§2 Supervolcanic Events and Civilization Impact](#2-supervolcanic-events-and-civilization-impact)
- [§3 Historical Eruptions That Changed History](#3-historical-eruptions-that-changed-history)
- [§4 Volcanism in Mythology and Religion](#4-volcanism-in-mythology-and-religion)
...
|-----|------|-------------|----------------------|
| **Siberian Traps** | ~252 Ma | ~7 million km² | **End-Permian** ("Great Dying") — 96% of marine species, 70% of land vertebrates (→ [R_1_03](../../R_Biology_Evolution/R1_Origin_Early_Life/R_1_03_Mass_Extinction_Events.md)) |
| **Central Atlantic Magmatic Province** | ~201 Ma | ~11 million km² | End-Triassic extinction |
| **Deccan Traps** | ~66 Ma | ~1.5 million km² | Contributed to K-Pg extinction (with Chicxulub impact) (→ [R_1_03](../../R_Biology_Evolution/R1_Origin_Early_Life/R_1_03_Mass_Extinction_Events.md)) |
...
- Proposed as inspiration for **Plato's Atlantis** — advanced island civilization destroyed by cataclysm (→ [E_1_01](../../E_Cataclysms_and_Chronology/E1_Impact_Space_Catastrophes/E_1_01_Younger_Dryas_Impact.md))
...
- Correlates with upheavals recorded in Chinese, Mesoamerican, and Scandinavian sources (→ [E_2_01](../../E_Cataclysms_and_Chronology/E2_Volcanic_Climate_Events/E_2_01_536_CE_Climate_Catastrophe.md))
...
| **Xiuhtecuhtli** | Aztec | Central Mexico | Fire god; New Fire Ceremony (→ [C_3_05](../../C_Global_Traditions/C3_Cosmology_Cycles_Ritual/C_3_05_Aztec_Cosmology_Five_Suns.md)) |
| **Ruaumoko** | Māori | New Zealand | Unborn god of earthquakes and volcanism |
| **Kagutsuchi** | Japanese | Japan | Fire deity whose birth killed mother Izanami (→ [A_4_04](../../A_Foundations/A4_Asian_Indigenous_Eastern/A_4_04_Kojiki.md)) |
...
- **Sodom and Gomorrah:** "Brimstone and fire from heaven" has been interpreted as volcanic or seismic activity near the Dead Sea rift (→ [A_2_01](../../A_Foundations/A2_Biblical_Gnostic_Western_Esoteric/A_2_01_Bible_Serpent_References.md))
...
- **Ragnarök (Norse):** The "Fimbulwinter" (three successive winters with no summer) followed by fire consuming the world may encode volcanic winter followed by eruption/lava flow (→ [A_4_02](../../A_Foundations/A4_Asian_Indigenous_Eastern/A_4_02_Norse_Eddas.md), E_4_05)
- **Mesoamerican Five Suns:** Repeated world-destructions by fire and wind parallel volcanic catastrophe cycles (→ [C_3_05](../../C_Global_Traditions/C3_Cosmology_Cycles_Ritual/C_3_05_Aztec_Cosmology_Five_Suns.md))
- **Aboriginal Australian stories:** Oral traditions in the Atherton Tablelands (Queensland) may preserve accurate descriptions of volcanic eruptions ~7,000 years ago, making them among the oldest geological oral histories (→ [C_4_05](../../C_Global_Traditions/C4_Regional_Mythology_Traditions/C_4_05_Australian_Aboriginal_Dreamtime.md))

### 4.3 Obsidian — Volcanic Glass as Currency and Tool

Volcanic products shaped prehistoric economy:
- **Obsidian:** Volcanic glass prized for razor-sharp edges; trade networks spanning hundreds of kilometers in Anatolia (Çatalhöyük → [D_1_01](../../D_Sites_and_Artifacts/D1_Iconic_Megasites/D_1_01_Gobekli_Tepe.md)), Mesoamerica (Olmec/Maya → [W_1_01](../../W_World_Civilizations/W1_Ancient_Near_East_Mediterranean/W_1_01_Olmec_Civilization_Serpent_Jaguar.md), C_1_07), and Oceania (Lapita → [W_4_02](../../W_World_Civilizations/W4_Americas_Pacific_Indigenous/W_4_02_Polynesian_Navigation_Rapa_Nui.md))
...
| Document | Connection |
|----------|-----------|
| → [E_2_01](../../E_Cataclysms_and_Chronology/E2_Volcanic_Climate_Events/E_2_01_536_CE_Climate_Catastrophe.md) | 536 CE dimming event; Late Antique Little Ice Age; volcanic climate forcing |
| → [E_1_01](../../E_Cataclysms_and_Chronology/E1_Impact_Space_Catastrophes/E_1_01_Younger_Dryas_Impact.md) | Atlantis hypothesis; Thera/Santorini as possible Atlantis source |
| → [E_4_06](../../E_Cataclysms_and_Chronology/E4_Dating_Chronological_Science/E_4_06_Kali_Yuga_World_Ages_Mathematics.md) | Cyclical destruction; yuga cycles and geological catastrophe periodicity |
| → [R_1_03](../../R_Biology_Evolution/R1_Origin_Early_Life/R_1_03_Mass_Extinction_Events.md) | Mass extinctions; flood basalt LIPs as primary extinction drivers |
| → [S_4_01](../../S_Future_Technology/S4_Space_Defense_Risk/S_4_01_Existential_Risk_Taxonomy.md) | Existential risk; supervolcanoes as civilization-ending threats |
| → [O_1_01](../O1_Geomagnetic_Atmospheric/O_1_01_Ley_Lines_Earth_Grid.md) | Earth anomalies; Yellowstone hotspot, caldera systems, geothermal features |
| → [D_1_01](../../D_Sites_and_Artifacts/D1_Iconic_Megasites/D_1_01_Gobekli_Tepe.md) | Göbekli Tepe; Younger Dryas climate context and volcanic theories |
| → [C_3_05](../../C_Global_Traditions/C3_Cosmology_Cycles_Ritual/C_3_05_Aztec_Cosmology_Five_Suns.md) | Aztec Five Suns; repeated world-destruction by fire parallels volcanic memory |
| → [C_4_02](../../C_Global_Traditions/C4_Regional_Mythology_Traditions/C_4_02_Pacific_Island_Traditions.md) | Pacific traditions; Ring of Fire volcanism, Polynesian volcanic island creation |
| → [L_1_01](../../L_Genetics_Origins/L1_Human_Evolution_Species/L_1_01_Ancient_DNA_Population_Genetics.md) | Genetic bottleneck; Toba hypothesis and human population genetics |
| → [M_4_03](../../M_Forbidden_Archaeology/M4_Lost_Civilizations_Claims/M_4_03_Archaeological_Dating_Disputes.md) | Archaeological dating; volcanic ash as chronological marker (tephrochronology) |
| → [J_2_01](../../J_Ancient_Technology/J2_Metallurgy_Materials_Craft/J_2_01_Ancient_Metallurgy.md) | Metallurgy; volcanic products (obsidian, pumice) as prehistoric technology |
...
2. **Rampino, Michael R., and Stephen Self.** "Volcanic Winter and Accelerated Glaciation Following the Toba Super-eruption." *Nature* 359 (1992): 50–52. — Foundational Toba volcanic winter hypothesis. DOI: 10.1038/359050a0.
...
4. **Petraglia, Michael, et al.** "Middle Paleolithic Assemblages from the Indian Subcontinent Before and After the Toba Super-eruption." *Science* 317 (2007): 114–116. — Evidence of human continuity through Toba. DOI: 10.1126/science.1141564.
...
9. **McCoy, Floyd W., and Grant Heiken.** "Tsunami Generated by the Late Bronze Age Eruption of Thera (Santorini), Greece." *Pure and Applied Geophysics* 157 (2000): 1227–1256. — Theran tsunami modeling.
10. **Sparks, R. Stephen J., et al.** *Super-Eruptions: Global Effects and Future Threats.* Geological Society of London, 2005. — Risk assessment of supervolcanic events.
11. **Friedrich, Walter L.** *Fire in the Sea: The Santorini Volcano.* Cambridge University Press, 2000. — Comprehensive Thera/Santorini volcanology.
12. **Self, Stephen.** "The Effects and Consequences of Very Large Explosive Volcanic Eruptions." *Philosophical Transactions of the Royal Society A* 364 (2006): 2073–2097. — Modeling VEI 7–8 impacts.
