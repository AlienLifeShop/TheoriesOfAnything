# B34 — Leviathan — Biblical Sea Monster and Chaos Serpent
...
**Leviathan** (Hebrew: לִוְיָתָן, *Livyātān*) is the great sea monster of the Hebrew Bible — a multi-headed, fire-breathing chaos serpent whom only YHWH can subdue. Appearing in **Job 41** (the longest single monster description in the Bible), **Psalm 74:13-14**, **Psalm 104:26**, **Isaiah 27:1**, and **2 Esdras 6:49-52**, Leviathan is the Hebrew cognate of the **Ugaritic Litan/Lōtān** — the seven-headed sea dragon defeated by Baal in the Baal Cycle (~1400–1200 BCE). Leviathan is thus part of the ancient Near Eastern **Chaoskampf** tradition (→ [A35](../A_Foundations/A35_Tiamat_Chaos_Dragon.md)) alongside Tiamat, Yamm, and Typhon. In the Hebrew Bible, Leviathan serves three theological functions: (1) a cosmogonic enemy subdued at creation, (2) a demonstration of YHWH's unrivaled power, and (3) an eschatological creature to be destroyed at the end of days. Related biblical terms include **Rahab** (רהב, a different sea monster), **Tannin** (תנין, "dragon/serpent"), and **Tehom** (תהום, "the deep," cognate with Tiamat).
...
| Feature | Text (selected verses, NRSV) |
|---------|------------------------------|
| **Uncatchable** | "Can you draw out Leviathan with a fishhook, or press down its tongue with a cord?" (41:1) |
| **Armored** | "Its back is made of shields in rows, shut up closely as with a seal" (41:15) |
| **Fire-breathing** | "Out of its mouth go flaming torches; sparks of fire leap out. Out of its nostrils comes smoke" (41:19-20) |
| **Invulnerable** | "The sword that reaches it does not avail, nor does the spear, the dart, or the javelin" (41:26) |
| **Terror** | "It makes the deep boil like a pot; it makes the sea like a pot of ointment" (41:31) |
| **Supremacy** | "On earth it has no equal, a creature without fear. It surveys everything that is lofty; it is king over all that are proud" (41:33-34) |
...
- This places Leviathan's final destruction in the **eschatological future** — applying the cosmogonic combat pattern to end-times prophecy
- **Tier 1** — Textual parallel with Ugaritic is one of the most secure in comparative Semitics
...
- Litan/Leviathan is a servant or ally of **Yamm** (Sea) — the chaotic sea-god whom Baal defeats to establish his kingship
- The **seven heads** of Litan are explicit in the Ugaritic text — paralleled in Psalm 74:14 ("you crushed the heads of Leviathan") and in Revelation 12:3 (the "great red dragon with seven heads")
- **Tier 1** — The Ugaritic texts are published and translated; the cognate is accepted by all Semitists

---

## §3 — RELATED BIBLICAL CHAOS CREATURES

| Creature | Hebrew | Key Passages | Description |
|----------|--------|-------------|-------------|
| **Leviathan** | לִוְיָתָן | Job 41, Ps 74:14, Isa 27:1 | Multi-headed sea serpent/dragon |
| **Rahab** | רַהַב | Job 26:12, Isa 51:9, Ps 89:10 | Sea monster — different from Leviathan; name means "proud/arrogant one" |
| **Tannin** | תַּנִּין | Isa 27:1, Isa 51:9, Ezek 29:3, 32:2 | "Dragon/serpent" — generic term; used for Pharaoh (Ezek 29:3) |
| **Tehom** | תְּהוֹם | Gen 1:2, Ps 104:6 | "The Deep" — depersonalized cognate of Tiamat |
| **Yamm** | יָם | Ps 74:13, Hab 3:8 | "Sea" — sometimes personified as a chaos entity |
| **Behemoth** | בְּהֵמוֹת | Job 40:15-24 | Land monster; paired with Leviathan as chaos creatures |

- **Behemoth and Leviathan** form a **complementary pair**: Behemoth rules the land, Leviathan rules the sea. This pairing appears in **2 Esdras 6:49-52** and later Jewish tradition (see §4)
- **Tier 1** — All terms are in the canonical text
...
- The **sukkah** (tabernacle) of the righteous will be made from Leviathan's skin
...
- The Christian tradition collapsed Leviathan into the Devil/Satan — the chaos monster is identified with the cosmic adversary
- **Tier 2** — Connection to Leviathan is standard in critical commentary
...
|----------|-------------|-----------|
| **Crocodile** | Traditional Christian commentators; some modern translations | Doesn't match: crocodiles have no multiple heads, don't breathe fire, and don't inhabit the open sea |
| **Whale** | Some popular interpretations | Doesn't match: no fire, no armor, no mythological combat role |
| **Purely mythological** | Modern critical scholars (Day, Wakeman) | Most likely — Leviathan is a mythological chaos creature, not a zoological description |
| **Dinosaur/extinct reptile** | Young Earth Creationists | **Tier 4** — No evidence; presupposes human-dinosaur coexistence |

- **Scholarly consensus:** Leviathan is a **mythological creature** — the Hebrew reflex of the ancient Near Eastern chaos-dragon tradition. Job 41's description uses poetic hyperbole (fire-breathing, invulnerability) that does not correspond to any known animal. The question "what real animal was Leviathan?" misunderstands the genre
- **Tier 1–2** — The mythological reading is standard in critical scholarship
...
- The political metaphor has outlived the theological one in modern secular discourse
- **Tier 1** — Hobbes's usage is well-documented
...
|---|-------------|----------|--------|---------|
| 1 | Leviathan — medieval manuscript illustration | B34_leviathan_medieval.jpg | Wikimedia Commons | Public Domain |
| 2 | Baal Cycle tablet (KTU 1.5 — Litan reference) | B34_baal_cycle_tablet.jpg | Wikimedia Commons | Public Domain |
| 3 | Gustave Doré — Destruction of Leviathan (1865) | B34_dore_leviathan.jpg | Wikimedia Commons | Public Domain |
| 4 | Hobbes Leviathan frontispiece (1651) | B34_hobbes_leviathan.jpg | Wikimedia Commons | Public Domain |
| 5 | Seven-headed serpent seal from Tell Asmar | B34_seven_headed_serpent.jpg | Wikimedia Commons | Public Domain |
...
*Research drawn from critical biblical commentaries (Anchor Bible, Word Biblical Commentary), published Ugaritic text editions, and peer-reviewed studies from Cambridge UP, Brill, and Eisenbrauns. All sources verifiable. Last Updated: Mar 4, 2026*
