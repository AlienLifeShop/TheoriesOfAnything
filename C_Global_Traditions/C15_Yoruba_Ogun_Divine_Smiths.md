...
- **The blacksmith in African societies:**
  ...
  - The forge as a WOMB — iron ore transformed into metal parallels conception and birth. Many African smelting furnaces are explicitly designed with female anatomical symbolism (Herbert 1993).
  - **Liminal status:** the blacksmith bridges the raw/cooked, nature/culture, dead/living divides. This is why they are both essential AND marginal — too powerful to be fully integrated.
...
- **Connection to acoustic technology (J04):** if rhythm-induced trance was part of ancient technology, the division between "spiritual" and "technical" practice is a modern imposition
...
|---|-------------|----------|--------|---------|
| 1 | Ogun shrine with iron implements | C15_ogun_shrine_001.jpg | Wikimedia Commons | CC BY-SA 4.0 |
| 2 | Hephaestus at the forge (red-figure vase) | C15_hephaestus_forge_002.jpg | Wikimedia Commons | Public Domain |
| 3 | Nok culture iron furnace remains | C15_nok_furnace_003.jpg | Wikimedia Commons | CC BY-SA 3.0 |
| 4 | Wayland the Smith panel (Franks Casket) | C15_wayland_smith_004.jpg | Wikimedia Commons | Public Domain |
...
|-------------|-----------|
| [J05 — Ancient Metallurgy](../J_Ancient_Technology/J05_Ancient_Metallurgy.md) | Haya steelmaking, Damascus steel — the TECHNOLOGIES divine smiths supposedly gave |
| [A04 — Book of Enoch](../A_Foundations/A04_Book_of_Enoch_and_Watchers.md) | Azazel's metalworking instruction as forbidden knowledge |
