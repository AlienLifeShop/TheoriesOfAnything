...
- **The king as intermediary:**
  - Responsible for maintaining cosmic order (Sumerian "me" — A06)
...
- **The uraeus (rearing cobra):**
  - The sacred serpent on the pharaoh's brow (B08 — Wadjet)
...
- **A remarkable pattern connects sacred kingship to serpent/dragon symbolism globally:**
  ...
  - **India:** Naga kings → many dynasties claim descent from serpent beings (C11)
  - **Mesoamerica:** Quetzalcoatl (feathered serpent) → model for legitimate rulership (C04)
  - **West Africa:** Danhomey kingdom named after the serpent Dan (C05)
...
|---|-------------|----------|--------|---------|
| 1 | Pharaoh with uraeus crown | C17_pharaoh_uraeus_001.jpg | Egyptian Museum Cairo | Fair Use |
| 2 | Chinese emperor dragon robe | C17_dragon_robe_002.jpg | National Palace Museum | Fair Use |
| 3 | European coronation scene | C17_coronation_003.jpg | Public Domain painting | Public Domain |
| 4 | Maya bloodletting ritual lintel | C17_maya_bloodletting_004.jpg | Lintel 24, Yaxchilán | Fair Use |
...
|-------------|-----------|
| [A01 — Sumerian Texts](../A_Foundations/A01_Sumerian_Texts_and_Tablets.md) | "Kingship descended from heaven" |
| [B06 — Dynastic Serpent Lineage](../B_Beings_and_Entities/B06_Dynastic_Serpent_Lineage.md) | Serpent symbolism in royal lines |
| [B07 — Ancient Rulers Lifespans](../B_Beings_and_Entities/B07_Ancient_Rulers_Lifespans.md) | Impossibly long pre-Flood king reigns |
| [B08 — Wadjet Cobra](../B_Beings_and_Entities/B08_Wadjet_Cobra_Goddess.md) | Royal uraeus serpent |
| [C12 — Chinese Dragon](../C_Global_Traditions/C12_Chinese_Dragon_Mythology_Ancient_Scriptures.md) | Dragon as imperial symbol |
| [N01 — Mystery Schools](../N_Secret_Societies/N01_Mystery_Schools.md) | Esoteric knowledge of rulers |
| [E09 — Rise and Fall](../E_Cataclysms_and_Chronology/E09_Rise_Fall_Civilizations.md) | Civilizational cycles and leadership |
