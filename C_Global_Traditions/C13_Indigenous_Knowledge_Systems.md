...
- **Songlines (Dreaming Tracks):** the land itself encodes knowledge. Correct songs must be sung at specific locations — they simultaneously:
  - Navigate (each verse describes a landmark)
  - Encode ecological knowledge (which species at each location, seasonal patterns)
  - Maintain law and kinship (who has custodial responsibility for each area)
  - Preserve history (events that occurred at each location over millennia)
- **Sea-level rise memories (Reid & Nunn 2015, *Australian Geographer*):**
  - 21 Aboriginal groups across Australia preserve oral traditions of once-exposed land now under the sea
  - These traditions are GEOGRAPHICALLY ACCURATE — they describe specific bays, headlands, and islands that were dry land during the last glacial period
  - The sea level rose to current levels ~7,000 years ago → these are ORAL TRADITIONS PRESERVED FOR 7,000+ YEARS with geographical accuracy
  - This is the longest known oral transmission of historically verifiable information
- **Fire-stick farming:**
  - Aboriginal peoples systematically burned the landscape to create "fire mosaics" — patches of different succession stages
  - This INCREASED biodiversity (diverse habitats in small areas), attracted game, prevented fuel accumulation, and maintained open woodland
...
- **Information sources used:**
  ...
  - Ocean swells: at least 8 different swell patterns recognized by feel (sitting cross-legged in the canoe, sensing swell direction through the hull)
  - Cloud patterns: clouds form differently over islands (pile up over land due to heating)
  - Bird behavior: migratory birds indicate nearby land; their altitude and direction encode distance
  - Water color and phosphorescence: changes near land
  - "Tē lapa" — underwater flashes of light said to pulse toward land (documented but not fully explained by Western science)
...
- **~25-50%** of modern pharmaceuticals derive from natural compounds first identified by Indigenous peoples:
  ...
  - **Curare:** arrow poison (Amazonian peoples) → tubocurarine → surgical muscle relaxant
  - **Pilocarpine:** from jaborandi plant (Guaraní peoples) → glaucoma treatment
  - **Rotenone:** fish poison (multiple traditions) → insecticide
  - **Kava:** Polynesian anxiolytic, now studied for anti-anxiety properties
  - **Ayahuasca:** 80+ Amazonian peoples combine exactly two plants — one contains DMT, the other contains MAO inhibitor that makes DMT orally active. The probability of discovering this combination by chance from 80,000+ Amazonian plant species is infinitesimal. The Indigenous explanation: "the plants told us."
- **Ethnobotanical knowledge loss:** ~1 Indigenous language dies every 2 weeks. Each language encodes unique ecological and pharmacological knowledge. This is an ongoing mass extinction of human knowledge.
...
- Western academia traditionally dismissed oral tradition as unreliable. This is now being corrected:
  ...
  - **Icelandic sagas:** oral traditions about Viking settlement of Greenland and Vinland (North America) were confirmed archaeologically at L'Anse aux Meadows
  - **San (Bushmen) rock art:** encodes knowledge of now-extinct species (e.g., Megalotragus, a giant hartebeest) — visual record spanning millennia
- **Mechanisms for reliability:**
  - Ritualized performance (songs, ceremonies) → reduces drift
  - Multiple custodians (distributed backup)
  - Social sanctions for alterations
...
- **Aboriginal Australian astronomy** is the world's oldest. Documented examples:
  ...
  - **Variable star observation:** Aboriginal Australians identified Betelgeuse as a variable star (changes brightness) — pulsation period incorporated into narratives. Western astronomy confirmed Betelgeuse's variability centuries later.
- **Dogon (Mali):** astronomer Marcel Griaule reported (1930s-50s) Dogon knowledge of Sirius B (a white dwarf companion invisible to the naked eye) including its 50-year orbital period. **Controversial:** Sagan and others argued contamination from earlier European contact. The debate remains unresolved.
- **Maya astronomy:** predicted Venus's synodic period to within 2 hours over 481 years (error: 0.08 day). Eclipse prediction cycles in the Dresden Codex match modern calculations.
...
- **Jeremy Narby, *The Cosmic Serpent* (1998):** proposed that shamans perceive DNA directly through altered states → the serpent symbolism across ayahuasca traditions represents the double helix
- **Status:** Narby's specific DNA claim is speculative and criticized. But the selectivity of the ayahuasca combination remains unexplained by random experimentation alone.
...
|---|-------------|----------|--------|---------|
| 1 | Aboriginal rock art star map | C13_aboriginal_star_map_001.jpg | Wikimedia Commons | CC BY-SA 4.0 |
| 2 | Hokule'a traditional sailing canoe | C13_hokuleʻa_002.jpg | Wikimedia Commons | CC BY 2.0 |
| 3 | Amazon terra preta soil comparison | C13_terra_preta_003.jpg | Wikimedia Commons | CC BY-SA 3.0 |
| 4 | Fire-stick farming mosaic pattern | C13_firestick_farming_004.jpg | CSIRO | CC BY 3.0 |
...
|-------------|-----------|
| [C05 — Credo Mutwa Africa](C05_Credo_Mutwa_African_Traditions.md) | African Indigenous knowledge as parallel system |
