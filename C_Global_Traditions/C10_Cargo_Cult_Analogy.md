# C10 — Cargo Cult Analogy for Ancient Contact
...
> **Cross-References:** A07, C04, C08, D01, H02

---

## Overview

Cargo cults are religious movements observed primarily in Melanesia during and after World War II, in which indigenous populations who witnessed advanced military technology created ritualistic imitations of what they had seen — building mock airstrips, wearing mock uniforms, and performing ceremonies to summon the return of the "cargo" (manufactured goods). These movements demonstrate a documented, repeatable process by which contact with a technologically superior civilization is mythologized within a single generation. This document examines cargo cults in detail, then explores their applicability as an analogy for ancient contact hypotheses — particularly regarding "knowledge-giver" traditions worldwide.
...
### Observable Mythologization Process
...
- Some scholars describe it as evolving from a cargo cult into a broader cultural identity movement
...
### Stage 2: Interpretation Through Existing Framework
...
### Stage 5: Codification and Transmission
...
### Parallel Table: Cargo Cult Features vs. Ancient "Knowledge-Giver" Traditions
...
### Graham Hancock's Use of the Analogy
...
### Peter Worsley — *The Trumpet Shall Sound* (1957) [SCHOLARLY]
...
### Lamont Lindstrom — *Cargo Cult: Strange Stories of Desire from Melanesia and Beyond* (1993) [SCHOLARLY]
...
### Kenelm Burridge — *Mambu: A Melanesian Millennium* (1960) [SCHOLARLY]
...
### The Critical Problem: The Missing Civilization
...
### The Independent Invention Argument
...
### The Condescension Problem [SCHOLARLY]
