...
- The temples at **Ġgantija** (Gozo, ~3600 BCE), **Ħagar Qim**, **Mnajdra**, and **Tarxien** (all Malta, ~3200–2500 BCE) feature distinctive **lobed/oval floor plans** that some scholars have interpreted as representing the body of a reclining goddess.
...
**The Claim:**
- Drawing on Gimbutas, some scholars and feminist theologians have proposed that human civilization passed through a **matriarchal golden age** — a lengthy pre-patriarchal period (Paleolithic through early Neolithic, ~40,000–3500 BCE) characterized by:
...
|-------------|-----------|
| [A01 — Sumerian Texts](../A_Foundations/A01_Sumerian_Texts_and_Tablets.md) | Ninhursag, Inanna, Ki — primary goddess sources in cuneiform |
| [A06 — Sumerian ME](../A_Foundations/A06_Sumerian_ME_Divine_Programs.md) | Inanna's theft of the ME as goddess asserting cosmic power |
| [A14 — Pyramid Texts](../A_Foundations/A14_Pyramid_Texts.md) | Earliest attestations of Isis, Nut, and Hathor |
| [B02 — Anunnaki](../B_Beings_and_Entities/B02_Anunnaki_Connection.md) | Ninhursag as Anunnaki mother goddess; creation of humanity |
| [B08 — Wadjet](../B_Beings_and_Entities/B08_Wadjet_Cobra_Goddess.md) | Serpent-goddess nexus in Egyptian tradition |
| [C01 — World Religions Serpent](../C_Global_Traditions/C01_World_Religions_Serpent_Connections.md) | Serpent-goddess associations across traditions (§2.3) |
| [C08 — Cross-Cultural Patterns](../C_Global_Traditions/C08_Cross_Cultural_Patterns.md) | Mother Goddess as one of the universal mythological patterns |
