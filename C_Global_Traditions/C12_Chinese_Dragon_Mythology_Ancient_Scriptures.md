...
- **Gold masks with "alien" features** — oversized eyes, prominent noses; some scholars connect to dragon/divine ancestry claims [Tier 2–3]
...
- **Connection to project thesis (C08):** The Chinese case is the STRONGEST example of INDEPENDENT serpent symbolism development — which paradoxically SUPPORTS the claim that serpent reverence is a human universal (C09, cognitive anthropology) while UNDERMINING the claim that it requires a single historical source
