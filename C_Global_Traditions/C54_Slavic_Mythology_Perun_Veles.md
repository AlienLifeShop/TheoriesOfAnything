# C54 — Slavic Mythology — Perun, Veles, and the World Tree
...
> **Cross-References:** [C39 — Storm God](C39_Storm_God_Pattern.md) · [F09 — Pre-IE](../F_Lost_Connections/F09_Pre_Indo_European_Substrate_Cultures.md) · [C36 — Axis Mundi](C36_Sacred_Trees_Axis_Mundi.md) · [A12 — Norse Eddas](../A_Foundations/A12_Norse_Eddas.md) · [C55 — Baltic Mythology](C55_Baltic_Mythology_Lithuanian_Latvian.md) · [C53 — Finnish/Kalevala](C53_Finnish_Kalevala_Finno_Ugric.md)
...
- Their opposition = the **PIE storm-god vs. serpent** pattern (→ [C39](C39_Storm_God_Pattern.md) §2.2):
...
- Comparative parallel: this is the **closest surviving reflex** of the PIE *\*Perkwunos vs. \*Welnos* opposition (→ [C39](C39_Storm_God_Pattern.md))
...
- Parallel to Greek Hephaestus, Vedic Tvaṣṭṛ, Georgian/Nart Tlepsh (→ [C52](C52_Georgian_Caucasian_Prometheus.md)) — the IE divine craftsman
...
- Connected by the **world tree** (oak) — Perun at the top, Veles at the roots (→ [C36](C36_Sacred_Trees_Axis_Mundi.md))
...
- Some scholars argue Baltic mythology preserves the system **more purely** due to Lithuania's late Christianization (1387) → [C55](C55_Baltic_Mythology_Lithuanian_Latvian.md)
...
1. Ivanov, V. V. & Toporov, V. N. (1974). *Исследования в области славянских древностей*. Nauka.
2. Rybakov, B. A. (1987). *Язычество древних славян*. Nauka.
...
5. Helmold of Bosau. *Chronica Slavorum* (1167). Trans. F. J. Tschan. Columbia University Press, 1935. DOI: 10.1524/9783050048314.138
6. Saxo Grammaticus. *Gesta Danorum* (c. 1200). Trans. P. Fisher. D. S. Brewer, 2015. DOI: 10.1093/oseo/instance.00254316
7. Łowmiański, H. (1979). *Religia Słowian i jej upadek*. PWN.
8. Mikhailov, N. (2017). "Slavic Mythology." In *Handbook of Religions in Ancient Europe*. Routledge.
9. Znayenko, M. T. (1980). *The Gods of the Ancient Slavs*. Slavica Publishers. DOI: 10.2307/2496872
10. Cross, S. H. & Sherbowitz-Wetzor, O. P., trans. (1953). *The Russian Primary Chronicle*. Medieval Academy of America. DOI: 10.2307/2848481
11. West, M. L. (2007). *Indo-European Poetry and Myth*. Oxford University Press. ISBN: 9780199558919
...
|-------------|-----------|
| [C39 — Storm God](C39_Storm_God_Pattern.md) | Perun as IE storm god — closest reflex of PIE *Perkwunos vs. *Welnos |
| [C36 — Axis Mundi](C36_Sacred_Trees_Axis_Mundi.md) | Slavic world tree (oak) — Perun at top, Veles at roots, three realms |
| [A12 — Norse Eddas](../A_Foundations/A12_Norse_Eddas.md) | Thor/Jörmungandr parallels; Yggdrasil/world tree; comparable IE cosmology |
| [C55 — Baltic Mythology](C55_Baltic_Mythology_Lithuanian_Latvian.md) | Proto-Balto-Slavic religious unity; Perun–Perkūnas, Veles–Velnias |
| [C53 — Finnish/Kalevala](C53_Finnish_Kalevala_Finno_Ugric.md) | Northern European contact zone — Finno-Slavic mythological interface |
| [C52 — Georgian/Caucasian](C52_Georgian_Caucasian_Prometheus.md) | Svarog as divine smith — Nart saga parallels |
| [F09 — Pre-IE](../F_Lost_Connections/F09_Pre_Indo_European_Substrate_Cultures.md) | Pre-IE substrate in Slavic religion (Mokosh? Rod?) |
| [C51 — Armenian](C51_Armenian_Mythology_Urartian.md) | IE comparative parallels — Vahagn/Perun thunder-god variants |
