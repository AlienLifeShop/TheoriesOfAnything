# C69 — Angkor Wat, Khmer Cosmology, and Hindu-Buddhist Temple Mountains
...
> **Cross-References:** C06, C11, D05, D22, C53, D06, J05, E09
...
### 1.2 Cosmological Framework [5/5 sources]
...
### 2.1 Architectural Data [5/5 sources]
...
### 2.2 The Churning of the Sea of Milk — Key Bas-Relief [5/5 sources]
...
### 2.3 Astronomical Alignments [4/5 sources]

| Alignment | Description |
|-----------|-------------|
| **Spring equinox** | Sun rises directly over the central tower when viewed from the western causeway (→ D06) |
...
| **Precession?** | Graham Hancock proposed Angkor temple layout mirrors Draco constellation at ~10,500 BCE; this is rejected by archaeologists but noted as an alternative claim (→ G03) |

---

## 3. ANGKOR THOM, BAYON

### 3.1 Jayavarman VII's Buddhist Revolution [5/5 sources]
...
### 3.2 Infrastructure Scale [4/5 sources]
...
### 4.1 Water Management System [5/5 sources]
...
### 4.2 Climate Vulnerability [4/5 sources]
...
- This finding supports the **climate-civilization nexus** observed in other collapse events (→ S10, E09)

---

## 5. DECLINE AND REDISCOVERY

### 5.1 LIDAR Revelations [5/5 sources]
...
### 5.2 Current Challenges [3/5 sources]
...
2. Coe, M. D. (2003). *Angkor and the Khmer Civilization*. Thames & Hudson.
3. Evans, D., et al. (2013). "Uncovering Archaeological Landscapes at Angkor Using Lidar." *PNAS*, 110(31).
4. Evans, D. (2016). "Airborne Laser Scanning as a Method for Exploring Long-Term Socio-Ecological Dynamics in Cambodia." *Journal of Archaeological Science*, 74.
5. Mannikka, E. (1996). *Angkor Wat: Time, Space, and Kingship*. University of Hawai'i Press.
6. Buckley, B. M., et al. (2010). "Climate as a Contributing Factor in the Demise of Angkor, Cambodia." *PNAS*, 107(15).
7. Fletcher, R. (2012). "Low-Density, Agrarian-Based Urbanism: Scale, Power, and Ecology." In *The Comparative Archaeology of Complex Societies*. Cambridge University Press.
8. Jacques, C., & Freeman, M. (1997). *Angkor: Cities and Temples*. River Books.
9. Sharrock, P. D. (2009). "Garuda, Vajrapani, and Religious Change in Jayavarman VII's Angkor." *Journal of Southeast Asian Studies*, 40(1).
10. Lustig, E. (2009). "Power and Pragmatism in the Political Economy of Angkor." PhD dissertation, University of Sydney.
11. Penny, D., et al. (2014). "The Demise of Angkor: Systemic Vulnerability of Urban Infrastructure to Climatic Variations." *Science Advances*, 2(10).
