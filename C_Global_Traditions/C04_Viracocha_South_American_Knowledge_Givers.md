...
- The "bearded white god" physical descriptions are contested — many scholars argue they are post-conquest embellishments
...
- See **A07** (Apkallu, Oannes, and the Seven Sages) for the full Mesopotamian side
...
|-------|-----------|------------|
| Apkallu, Oannes, Seven Sages | A07 | Functional parallel — knowledge-givers emerging from water |
| Sumerian texts and tablets | A01 | ME tablets as "civilization packages" — same teaching lists |
| Anunnaki and reptilian connection | B02 | Non-human teachers of civilization |
| Reptilian Beings Overview | B01 | Feathered Serpent = serpent + divinity; Quetzalcoatl literally IS a serpent being who teaches |
| Dynastic Serpent Lineage | B06 | Serpent-associated civilizing rulers |
| World Religions Serpent Connections | C01 | Pan-cultural serpent symbolism |
| Global flood stories | C02 | Viracocha and Bochica both connected to flood narratives |
| Flood-Serpent Connection | C08 | Flood-knowledge-giver overlap |
| Cross-cultural patterns | C10 | Pan-American knowledge-giver pattern |
| Sites and artifacts | D01 | Tiwanaku precision stonework; El Castillo; Inca engineering |
