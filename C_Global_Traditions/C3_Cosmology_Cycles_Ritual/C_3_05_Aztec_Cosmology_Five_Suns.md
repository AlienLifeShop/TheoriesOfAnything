...
> **Last Updated:** Jun 14, 2025 | **Source Count:** 10 | **Weighted Score:** 17 | **Source Confidence:** [2/5] | **Confidence:** High (historical/textual), Medium (pre-contact reconstruction)

---

## DOCUMENT NAVIGATION
- [§1 The Aztec World — Context](#1-the-aztec-world--context)
- [§2 The Five Suns — Cosmic Ages](#2-the-five-suns--cosmic-ages)
- [§3 The Current Sun — Nahui Ollin](#3-the-current-sun--nahui-ollin)
- [§4 The Structure of the Cosmos](#4-the-structure-of-the-cosmos)
- [§5 Time — The Interlocking Calendars](#5-time--the-interlocking-calendars)
- [§6 The Blood Debt — Human Sacrifice as Cosmic Maintenance](#6-the-blood-debt--human-sacrifice-as-cosmic-maintenance)
- [§7 Cataclysm Parallels](#7-cataclysm-parallels)
...
- Migrated from the legendary homeland of **Aztlan** (location debated; possibly northwest Mexico) beginning ~12th century CE
- Founded **Tenochtitlan** in ~1325 CE on an island in Lake Texcoco (modern Mexico City)
- Built the **Triple Alliance** (Tenochtitlan, Texcoco, Tlacopan) into the dominant empire of Mesoamerica by 1428 CE
- At their height (~1500 CE), governed 5–6 million people and controlled territory from the Pacific to the Gulf of Mexico
- Were conquered by Hernán Cortés and allied Indigenous forces in 1521 CE
...
- **1st Sun**: Tezcatlipoca becomes the sun; Quetzalcoatl knocks him from the sky with a stone club; Tezcatlipoca falls and, enraged, sends jaguars to destroy the world
- **2nd Sun**: Quetzalcoatl becomes the sun; Tezcatlipoca kicks him from the sky; Quetzalcoatl sends a great wind that destroys everything and transforms people into monkeys
- **3rd Sun**: Tlaloc governs; Quetzalcoatl sends a rain of fire
- **4th Sun**: Chalchiuhtlicue (water goddess) governs; destroyed by flood
- **5th Sun**: Created through collective divine sacrifice at **Teotihuacan** (see §3)
...
- Enki vs. Enlil (Sumerian — see [A_1_04](../../A_Foundations/A1_Mesopotamian_Near_Eastern/A_1_04_Enki_Enlil_and_Sumerian_Leaders.md))
- Prometheus vs. Zeus (Greek — see [C_2_07](../C2_Knowledge_Bringer_Serpent/C_2_07_Prometheus_Forbidden_Knowledge_Archetype.md))
- YHWH vs. the Serpent (Biblical — see [A_2_01](../../A_Foundations/A2_Biblical_Gnostic_Western_Esoteric/A_2_01_Bible_Serpent_References.md))
...
- **Center face**: Tonatiuh (the Fifth Sun) or possibly Tlaltecuhtli (earth lord), tongue extended as a sacrificial knife
- **Four surrounding squares**: The four previous Suns (4 Jaguar, 4 Wind, 4 Rain, 4 Water) with their destruction dates
- **Inner ring**: 20 day-signs of the tonalpohualli (260-day calendar)
- **Outer ring**: Turquoise/solar rays; two fire serpents (Xiuhcoatl) whose mouths meet at the base, from which emerge two deity faces
...
- The gods **died** to create the current world → humans owe a **blood debt**
- The Sun requires continuous **feeding** with blood (especially hearts) to keep moving → human sacrifice is cosmic maintenance, not cruelty
- The humble, willing sacrifice (Nanahuatzin) succeeds where proud hesitation (Tecuciztecatl) fails → **sacrifice must be willing**
- The current Sun is destined to end in **earthquakes** → there is no permanent safety
...
- Levels 1–2: Moon and stars
- Level 3: Sun's path
- Level 4: Venus (Tlahuizcalpantecuhtli)
- Levels 5–9: Various celestial phenomena (comets, night sky, storms, blue sky)
- Levels 10–12: Realm of the gods
- Level 13: **Omeyocan** — "Place of Duality," dwelling of **Ometeotl** (the dual god/goddess of all creation)
...
- The **Sumerian** seven gates of the underworld (see [C_3_04](C_3_04_Seven_Level_Cosmology_Seven_Gates.md))
- The **Egyptian** twelve hours of the Duat
- The **Tibetan** bardo passages
- The **Orphic** descent (see [C_1_04](../C1_Universal_Archetypes_Patterns/C_1_04_Orpheus_Descent_Underworld_Archetype.md))
...
- **Templo Mayor** dedication (1487 CE): Sources claim 4,000–84,000 victims over four days (the higher numbers are likely exaggerated; modern estimates suggest 4,000–20,000)
- Regular sacrifice throughout the 18 monthly festivals
- **Flower Wars** (xochiyaoyotl) — staged battles specifically to capture sacrificial victims
...
- Become companions of the Sun (warriors died in sacrifice accompanied the Sun for 4 years)
- Or travel to specific afterlife realms based on manner of death (drowned → Tlalocan, paradise of Tlaloc)
- Or be transformed — as in each previous Sun, destruction = transformation into new forms
...
|-------------------|-----------------|
| **4 Water** (flood) | Near-universal flood myths (see [C_3_01](C_3_01_Global_Flood_Stories.md)) |
...
The Fourth Sun's destruction by flood is most directly parallel to the global flood tradition documented in [C_3_01](C_3_01_Global_Flood_Stories.md) and [E_4_06](../../E_Cataclysms_and_Chronology/E1_Impact_Space_Catastrophes/E_1_01_Younger_Dryas_Impact.md). The overlap raises the question: do these traditions preserve memory of actual Younger Dryas or earlier catastrophic events, or do they reflect universal human anxieties about natural disaster?
...
- **Hindu Yugas**: Four cosmic ages, cyclically repeating — close parallel
- **Buddhist kalpas**: Vast time cycles of creation and destruction
- **Hopi worlds**: Four previous worlds, each destroyed; currently in the Fifth World (remarkably close to the Aztec Five Suns)
- **Norse Ragnarök**: Destruction followed by rebirth — cyclical within a single-cycle framework
...
- The Five Suns narrative as recorded may have been significantly shaped by **Tlacaelel** and the Aztec imperial project in the 15th century CE
- Colonial-era sources (post-1521) are filtered through Christian scribes who may have reshaped the narrative
- The "original" pre-Aztec version of the Five Suns may be irrecoverable

### 8.2 Against Cataclysm Memory

- The Five Suns may encode general anxieties about natural disaster (earthquakes, floods, hurricanes are common in Mesoamerica) rather than memories of specific events
- The parallels with other traditions may reflect shared cognitive patterns rather than shared history
- "Pattern matching" across cultures risks imposing connections not present in the source material

### 8.3 Against Sacrifice Interpretations

- Sacrifice may have served primarily **political** rather than cosmological purposes — ideological justification for imperial terror
- The blood-debt theology may be a post-hoc rationalization, not the original motivation
- Competing interpretations exist within Mesoamerican studies regarding scale and significance
...
|-------------|-----------|
| [C_2_11](../C2_Knowledge_Bringer_Serpent/C_2_11_Quetzalcoatl_Feathered_Serpent.md) | Quetzalcoatl — central deity of Five Suns narrative |
| [W_1_01](../../W_World_Civilizations/W1_Ancient_Near_East_Mediterranean/W_1_01_Olmec_Civilization_Serpent_Jaguar.md) | Olmec predecessors — origins of Mesoamerican cosmology |
| [A_4_03](../../A_Foundations/A4_Asian_Indigenous_Eastern/A_4_03_Popol_Vuh.md) | Popol Vuh — parallel creation cycle narrative |
| [C_3_01](C_3_01_Global_Flood_Stories.md) | Global flood — Fourth Sun parallel |
| [E_4_06](../../E_Cataclysms_and_Chronology/E1_Impact_Space_Catastrophes/E_1_01_Younger_Dryas_Impact.md) | Younger Dryas — possible historical basis |
| [C_3_04](C_3_04_Seven_Level_Cosmology_Seven_Gates.md) | Multi-level cosmology — thirteen heavens / nine underworlds |
| [C_1_05](../C1_Universal_Archetypes_Patterns/C_1_05_Dying_Rising_Deity_Pattern.md) | Dying-rising deity — divine self-sacrifice |
| [C_2_08](../C2_Knowledge_Bringer_Serpent/C_2_08_Venus_Morning_Star.md) | Venus — Tlahuizcalpantecuhtli connection |
| [C_3_03](C_3_03_Sacred_Kingship_Divine_Rulership.md) | Sacred kingship — Aztec ruler cosmology |
| [D_5_08](../../D_Sites_and_Artifacts/D5_Sacred_Geometry_Art_Symbolism/D_5_08_Archaeoastronomy_Synthesis.md) | Archaeoastronomy — calendar alignments |
...
1. Brundage, Burr Cartwright. *The Fifth Sun: Aztec Gods, Aztec World*. University of Texas Press, 1983. DOI: 10.7560/724273
2. Milbrath, Susan. "Planets in Aztec Culture." In: *Oxford Research Encyclopedia of Planetary Science*, 2019. DOI: 10.1093/acrefore/9780190647926.013.54
3. Klein, Cecelia F. "Post-Classic Mexican Death Imagery as Sign of Cyclic Completion." In: *Death and the Afterlife in Pre-Columbian America*, Dumbarton Oaks, 1975. DOI: 10.1017/s0003598x00100729
4. Carrasco, Davíd. "Aztec Temporal Universe." In: *The Oxford Handbook of the Aztecs*, Oxford University Press, 2016.
5. Sahagún, Bernardino de. *Florentine Codex: General History of the Things of New Spain*, trans. Arthur J.O. Anderson and Charles E. Dibble, University of Utah Press, 1950–1982. DOI: 10.1017/s0022216x00009949. ISBN: 9780874800081
6. Matos Moctezuma, Eduardo. *Life and Death in the Templo Mayor*. University Press of Colorado, 1995. DOI: 10.64628/aao.6axxw54pq
7. Taube, Karl. "The Breath of Life: The Symbolism of Wind in Mesoamerica and the American Southwest." In: *The Road to Aztlan*, Los Angeles County Museum of Art, 2001.
8. León-Portilla, Miguel. *Aztec Thought and Culture*. University of Oklahoma Press, 1963. ISBN: 9780806105697
9. Townsend, Richard F. *The Aztecs*. 3rd ed., Thames & Hudson, 2009.
10. Read, Kay Almere, and Jason J. González. *Handbook of Mesoamerican Mythology*. ABC-Clio, 2000.
