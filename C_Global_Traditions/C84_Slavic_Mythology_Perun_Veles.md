# C84 — Slavic Mythology — Perun, Veles, and the World Tree
...
### 1.2 Vladimir's Pantheon (980 CE) [5/5 sources]
...
### 1.3 Archaeological Evidence [4/5 sources]
...
### 2.1 Perun vs. Veles — The Core Myth [5/5 sources]
...
- Their opposition = the **PIE storm-god vs. serpent** pattern (→ C56 §2.2):
...
- Comparative parallel: this is the **closest surviving reflex** of the PIE *\*Perkwunos vs. \*Welnos* opposition (→ C56)

### 2.2 Mokosh — The Earth Mother [4/5 sources]
...
### 2.3 Svarog and the Smith-God Tradition [3/5 sources]
...
- Parallel to Greek Hephaestus, Vedic Tvaṣṭṛ, Georgian/Nart Tlepsh (→ C82) — the IE divine craftsman

### 2.4 Dvoeverie — Dual Faith After Christianization [4/5 sources]
...
### 3.1 Rod — The Universal Creator [2/5 sources]
...
### 3.2 The Three Realms — Prav, Yav, Nav [2/5 sources]
...
- Connected by the **world tree** (oak) — Perun at the top, Veles at the roots (→ C53)
...
### 3.3 Slavic-Baltic Religious Unity [3/5 sources]
...
- Some scholars argue Baltic mythology preserves the system **more purely** due to Lithuania's late Christianization (1387) → C85

---

## 4. DUBIOUS CLAIMS (Tier 4 — No Credible Source)

### 4.1 The Book of Veles (Велесова Книга) [5/5 sources]
...
### 4.2 Ancient Slavic Civilization Predating Sumer [0/5 sources]
...
3. Gimbutas, M. (1971). *The Slavs*. Thames and Hudson.
4. Gasparini, E. (1973). *Il Matriarcato Slavo*. Sansoni.
5. Helmold of Bosau. *Chronica Slavorum* (1167). Trans. F. J. Tschan. Columbia University Press, 1935.
6. Saxo Grammaticus. *Gesta Danorum* (c. 1200). Trans. P. Fisher. D. S. Brewer, 2015.
...
9. Znayenko, M. T. (1980). *The Gods of the Ancient Slavs*. Slavica Publishers.
10. Cross, S. H. & Sherbowitz-Wetzor, O. P., trans. (1953). *The Russian Primary Chronicle*. Medieval Academy of America.
11. West, M. L. (2007). *Indo-European Poetry and Myth*. Oxford University Press.
12. Puhvel, J. (1987). *Comparative Mythology*. Johns Hopkins University Press.
