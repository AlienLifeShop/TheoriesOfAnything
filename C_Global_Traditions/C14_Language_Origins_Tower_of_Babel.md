...
- **500,000+ BP:** some researchers argue Homo erectus had proto-language (Bickerton 1990). Controlled fire use, Acheulean handaxes, and apparent long-distance travel suggest SOME communication sophistication
...
- **Connection to P01 — Hard Problem:** if consciousness is partly linguistically constructed, the emergence of new linguistic forms could alter consciousness itself
...
|---|-------------|----------|--------|---------|
| 1 | World language families map | C14_language_families_map_001.png | Wikimedia Commons | CC BY-SA 4.0 |
| 2 | Broca's and Wernicke's areas | C14_brain_language_areas_002.png | Wikimedia Commons | CC BY-SA 3.0 |
| 3 | Tower of Babel (Bruegel painting) | C14_tower_babel_003.jpg | Wikimedia Commons | PD |
| 4 | Language endangerment map | C14_language_endangerment_004.png | UNESCO | Fair Use |
...
|-------------|-----------|
| [R02 — Human Brain Evolution](../R_Biology_Evolution/R02_Human_Brain_Evolution.md) | Brain evolution → language capacity emergence |
| [C08 — Cross-Cultural Patterns](C08_Cross_Cultural_Patterns.md) | Linguistic universals as structural cross-cultural patterns |
| [A01 — Sumerian Texts](../A_Foundations/A01_Sumerian_Texts_and_Tablets.md) | Sumerian as language isolate; earliest written records |
| [L01 — Human Genetic Anomalies](../L_Genetics_Origins/L01_Ancient_DNA_Population_Genetics.md) | FOXP2, Chromosome 2 — genetic basis of language |
| [H01 — Suppression](../H_Suppression_and_Thesis/H01_Suppression_of_Ancient_Knowledge.md) | Language death = knowledge suppression |
| [C13 — Indigenous Knowledge](C13_Indigenous_Knowledge_Systems.md) | Language encodes unique ecological knowledge |
| [P01 — Hard Problem of Consciousness](../P_Philosophy_Meaning/P01_Hard_Problem_of_Consciousness.md) | Language and consciousness co-evolution |
