...
- **Stealing fire:** Extinguishes all fires, then tricks his ancestress Mahuika into giving up the fire hidden in her fingernails and toenails (see also C18, §1.5).
...
- Cargo cult dynamics (see C10) show how real technological contact generates mythological frameworks strikingly similar to trickster narratives — the "stranger" who arrives and transforms everything
...
|-------------|-----------|
| [A06 — Sumerian ME](../A_Foundations/A06_Sumerian_ME_Divine_Programs.md) | Enki's drunken transfer of the ME as trickster act; knowledge escapes through loss of control |
| [A09 — Enki & Enlil](../A_Foundations/A09_Enki_Enlil_and_Sumerian_Leaders.md) | Enki as the pro-humanity trickster vs. Enlil as authoritarian lawgiver |
| [A12 — Norse Eddas](../A_Foundations/A12_Norse_Eddas.md) | Loki's role across the Poetic and Prose Eddas; trickster as cosmic catalyst |
| [C03 — Flood Serpent](../C_Global_Traditions/C03_Flood_Serpent_Connection.md) | Enki's trickster circumvention of the flood decree; the trickster preserves humanity |
| [C08 — Cross-Cultural Patterns](../C_Global_Traditions/C08_Cross_Cultural_Patterns.md) | The trickster as one of the most widespread cross-cultural mythological patterns |
| [C10 — Cargo Cult](../C_Global_Traditions/C10_Cargo_Cult_Analogy.md) | How technological contact generates trickster-like mythological frameworks |
...
- **Distinction from C18:** This document treats the trickster as a **broad archetype** encompassing but not limited to the fire-theft/forbidden-knowledge pattern. C18 focuses specifically on the Promethean pattern of knowledge transfer, punishment, and cost. The overlap is significant but the framing differs: C18 asks "why does the knowledge-giver appear everywhere?"; C22 asks "why does the **boundary-crosser** appear everywhere?"
