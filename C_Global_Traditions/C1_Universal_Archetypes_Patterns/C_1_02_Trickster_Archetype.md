...
> **Cross-References:** [A_1_02 — Sumerian ME](../../A_Foundations/A1_Mesopotamian_Near_Eastern/A_1_02_Sumerian_ME_Divine_Programs.md) · [A_4_02 — Norse Eddas](../../A_Foundations/A4_Asian_Indigenous_Eastern/A_4_02_Norse_Eddas.md) · [C_2_02 — Flood Serpent](../C2_Knowledge_Bringer_Serpent/C_2_02_Flood_Serpent_Connection.md) · [C_5_02 — Cargo Cult](../C5_Regional_Analytical_Traditions/C_5_02_Cargo_Cult_Analogy.md) · [C_4_03 — Yoruba](../C4_Regional_Mythology_Traditions/C_4_03_Yoruba_Ogun_Divine_Smiths.md) · [C_2_07 — Prometheus](../C2_Knowledge_Bringer_Serpent/C_2_07_Prometheus_Forbidden_Knowledge_Archetype.md) · [H_4_02 — Two Factions](../../H_Suppression_and_Thesis/H4_Modern_Corporate_Suppression/H_4_02_Two_Factions_Dynamic.md) · [S_1_01 — AGI](../../S_Future_Technology/S1_AI_Computing_Digital/S_1_01_AGI_Existential_Risk.md)
...
See [C_2_07 — Prometheus / Forbidden Knowledge Archetype](../C2_Knowledge_Bringer_Serpent/C_2_07_Prometheus_Forbidden_Knowledge_Archetype.md) for full treatment.
...
|-------------|-----------|
| [A_1_02 — Sumerian ME](../../A_Foundations/A1_Mesopotamian_Near_Eastern/A_1_02_Sumerian_ME_Divine_Programs.md) | Enki's drunken transfer of the ME as trickster act; knowledge escapes through loss of control |
| [A_1_04 — Enki & Enlil](../../A_Foundations/A1_Mesopotamian_Near_Eastern/A_1_04_Enki_Enlil_and_Sumerian_Leaders.md) | Enki as the pro-humanity trickster vs. Enlil as authoritarian lawgiver |
| [A_4_02 — Norse Eddas](../../A_Foundations/A4_Asian_Indigenous_Eastern/A_4_02_Norse_Eddas.md) | Loki's role across the Poetic and Prose Eddas; trickster as cosmic catalyst |
| [C_2_02 — Flood Serpent](../C2_Knowledge_Bringer_Serpent/C_2_02_Flood_Serpent_Connection.md) | Enki's trickster circumvention of the flood decree; the trickster preserves humanity |
| [C_1_01 — Cross-Cultural Patterns](C_1_01_Cross_Cultural_Patterns.md) | The trickster as one of the most widespread cross-cultural mythological patterns |
| [C_5_02 — Cargo Cult](../C5_Regional_Analytical_Traditions/C_5_02_Cargo_Cult_Analogy.md) | How technological contact generates trickster-like mythological frameworks |
| [C_4_03 — Yoruba/Ogun](../C4_Regional_Mythology_Traditions/C_4_03_Yoruba_Ogun_Divine_Smiths.md) | Eshu/Legba as trickster in the Yoruba orisha system; Ogun as complementary culture hero |
| [C_2_07 — Prometheus](../C2_Knowledge_Bringer_Serpent/C_2_07_Prometheus_Forbidden_Knowledge_Archetype.md) | Prometheus as fire-theft trickster; overlap between trickster and forbidden knowledge archetypes |
| [H_4_02 — Two Factions](../../H_Suppression_and_Thesis/H4_Modern_Corporate_Suppression/H_4_02_Two_Factions_Dynamic.md) | The trickster as necessary third element in the two-factions dynamic |
| [Y_4_03 — Shamanic Practices](../../Y_Altered_States/Y4_Sleep_Trance_Perception/Y_4_03_Shamanic_Practices_Altered_States.md) | Trickster figures encountered in shamanic journeying; sacred clowns as ritual specialists |
| [S_1_01 — AGI](../../S_Future_Technology/S1_AI_Computing_Digital/S_1_01_AGI_Existential_Risk.md) | AI as modern trickster — boundary-crossing entity with amoral relationship to truth |
...
2. **African trickster traditions beyond Anansi and Eshu:** At least a dozen distinct trickster traditions exist across the continent (Hare in East Africa, Tortoise in Igbo traditions, Jackal in Southern Africa, Mantis among the San). A dedicated survey would reveal whether African tricksters share the structural features identified by Radin and Hyde or form a distinct category.

3. **Gender and the trickster:** Female tricksters are rare in the literature but not absent (Baubo in Greek tradition, Uzume in Japanese myth, Sheela-na-gig in Celtic tradition). Are female tricksters suppressed by patriarchal editorial processes, genuinely rarer, or simply classified differently?

4. **Quantitative phylogenetic analysis:** Apply Yuri Berezkin's and Julien d'Huy's phylogenetic methods to trickster motifs specifically (not just fire-theft) to estimate the antiquity and migration pathways of the archetype.

### Medium Priority

5. **South Asian trickster traditions:** Krishna as butter-thief and child-prankster; the *vidushaka* tradition; Ganesh as obstacle-creator-and-remover. Indian mythology may contain a trickster strand that has been under-analyzed because Hindu scholarship focuses on devotional rather than structuralist readings.

6. **The modern trickster in popular culture:** Bugs Bunny, the Joker, Deadpool, Bartimaeus, Jack Sparrow, Loki (MCU). Analysis of how the archetype persists in mass entertainment and whether it still serves its original social functions.

7. **Neuroscience of trickster response:** Do trickster stories activate specific neural pathways (e.g., humor circuits, mentalizing networks, cheater-detection modules) that differ from responses to non-trickster narratives? Could provide empirical support for or against the cognitive science hypothesis (§2.3).

### Low Priority

8. **Trickster in philosophical traditions:** Socrates as *eiron* (the ironic questioner); Diogenes the Cynic as philosophical trickster; Zhuangzi's use of paradox and absurdity. The trickster as epistemological principle — the idea that truth can only be reached by indirection.

9. **Connection to entropy and thermodynamics:** The trickster as mythological encoding of the second law — the principle that order inherently generates disorder, that systems cannot maintain themselves without the injection of random variation. Highly speculative but formally interesting.
