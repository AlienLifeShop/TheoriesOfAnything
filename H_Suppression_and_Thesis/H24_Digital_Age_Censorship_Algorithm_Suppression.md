# H24 — Digital Age Censorship and Algorithm Suppression
...
> **Cross-References:** [H04 — Propaganda & Information Control](H04_Propaganda_Information_Control.md) · [S22 — Internet & Digital Civilization](../S_Future_Technology/S22_Internet_Digital_Civilization.md) · [ZC04 — Propaganda & Persuasion](../ZC_Social_Science/ZC04_Propaganda_Persuasion_Information_Warfare.md) · [H15 — Scientific Censorship](H15_Scientific_Censorship_Paradigm_Defense.md) · [H23 — History Rewriting](H23_History_Rewriting_Textbook_Controversies.md)
...
> **Last Updated:** Mar 7, 2026 | **Source Count:** 22 | **Weighted Score:** 32 | **Source Confidence:** [4/5] | **Confidence:** High for documented systems; Medium for contested effects
...
- **Key mechanisms of algorithmic information control:**
  1. **Search ranking:** Google processes ~8.5 billion searches per day — the ranking algorithm determines what information is effectively accessible (studies show ~75% of users never scroll past the first page of results)
...
1. King, Gary, Jennifer Pan, and Margaret E. Roberts. "How the Chinese Government Fabricates Social Media Posts for Strategic Distraction, Not Engaged Argument." *American Political Science Review* 111.3 (2017): 484–501
2. Roberts, Margaret E. *Censored: Distraction and Diversion Inside China's Great Firewall* (Princeton UP, 2018)
...
4. Pariser, Eli. *The Filter Bubble: How the New Personalized Web Is Changing What We Read and How We Think* (Penguin, 2011)
5. Gillespie, Tarleton. *Custodians of the Internet: Platforms, Content Moderation, and the Hidden Decisions That Shape Social Media* (Yale UP, 2018)
...
|-------|----------|-------------|
| Propaganda & information control | [H04](H04_Propaganda_Information_Control.md) | Historical context for digital-age information control |
| Internet & digital civilization | [S22](../S_Future_Technology/S22_Internet_Digital_Civilization.md) | Technological infrastructure underlying censorship mechanisms |
| Propaganda psychology | [ZC04](../ZC_Social_Science/ZC04_Propaganda_Persuasion_Information_Warfare.md) | Psychological mechanisms exploited by algorithmic systems |
| Scientific censorship | [H15](H15_Scientific_Censorship_Paradigm_Defense.md) | Parallels between institutional and digital suppression |
| History rewriting | [H23](H23_History_Rewriting_Textbook_Controversies.md) | Digital dimensions of narrative control |
| Psychedelic research suppression | [H25](H25_Psychedelic_Research_Suppression.md) | Content moderation of drug information as suppression |

---

*Document H24 — Theories of Anything Project*
