# H08 — Academic Gatekeeping, Paradigm Resistance, and the Sociology of Knowledge
...
- **Paradigm**: Not just a theory but a **worldview** — shared assumptions, methods, values, exemplary solutions
- **Incommensurability**: Competing paradigms cannot be fully translated into each other's terms; proponents "see the world differently"
- **Planck's Principle**: "Science advances one funeral at a time" — paradigm shifts often require the old generation to retire/die
- **Semmelweis Reflex**: The tendency to reject new evidence that contradicts established norms
...
- **Government agencies** (NSF, NIH, ERC) fund proposals evaluated by peer panels — same paradigm-bias risk
- **"Fundable" science** tends to be incremental, low-risk, within established paradigms
- **High-risk/high-reward** programs exist (NSF EAGER, DARPA, ERC grants) but represent <5% of funding
- **Industry funding** creates different biases (profit motive; pharmaceutical companies fund favorable trials)
- **Matthew Effect** (Merton, 1968): established scientists receive disproportionate credit and funding; newcomers struggle
