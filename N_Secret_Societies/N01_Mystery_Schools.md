...
- **Dead Sea Scrolls connection (Tier 1–2):**
  ...
  - **Disagreement:** Some scholars (Golb, Hirschfeld) argue Qumran was not Essene — possibly a fortress, villa, or pottery workshop. The identification remains majority opinion but NOT universal.
- **Serpent/Knowledge-keeper connections:**
  - Essene emphasis on angelic hierarchies and hidden knowledge parallels Book of Enoch (A04) — Enoch scrolls are heavily represented at Qumran
...
- **Serpent/Dragon connections (Tier 2):**
  ...
  - The caduceus-like imagery of entwined serpents parallels Hermetic tradition (A08)
- **Parallel to Mystery Schools:**
...
- **Cross-References:** C01 (Celtic serpent traditions), N01 (Mystery Schools parallels), A08 (Hermetic tradition)
...
|---|------------|---------|----------|------|
| 1 | Mithras tauroctony relief (Louvre) | Public Domain | T1_N01_mystery_001_mithras_tauroctony_louvre.jpg | 1 |
| 2 | Eleusis Telesterion reconstruction | CC-BY-SA | T2_N01_mystery_002_eleusis_telesterion_reconstruction.png | 2 |
| 3 | Orphic gold tablet (Petelia) | Public Domain | T1_N01_mystery_003_orphic_gold_tablet_petelia.jpg | 1 |
...
- [ ] Archaeological analysis of Mithraea for acoustic properties (connection to J04)
