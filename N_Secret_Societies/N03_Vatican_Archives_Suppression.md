...
- **Pineal gland symbolism:**
  ...
  - **Pine cone symbolism IS ancient and widespread:**
    - Mesopotamia: Apkallu (A07) carry pine cone-shaped objects in reliefs (function debated — blessing? purification?)
...
|---|------------|---------|----------|------|
| 1 | Vatican Apostolic Archive interior corridor | CC-BY-SA | T2_N03_vatican_001_apostolic_archive_interior.jpg | 2 |
| 2 | Athanasius Festal Letter 39 (earliest canon list) | Public Domain | T1_N03_vatican_002_athanasius_festal_letter.jpg | 1 |
| 3 | Nag Hammadi Codex II (contains Gospel of Thomas) | Public Domain | T1_N03_vatican_003_nag_hammadi_codex_ii.jpg | 1 |
...
|------------|------------|
| [A03 — Nag Hammadi](../A_Foundations/A03_Nag_Hammadi_Gnostic_Texts.md) | The excluded texts from canon formation are the SAME texts in the Nag Hammadi library — the archive is the Church's rejection made physical |
| [A07 — Apkallu](../A_Foundations/A07_Apkallu_Oannes_Seven_Sages.md) | Apkallu carry pine cone-shaped objects in reliefs — parallels Vatican Pine Cone Court symbolism |
