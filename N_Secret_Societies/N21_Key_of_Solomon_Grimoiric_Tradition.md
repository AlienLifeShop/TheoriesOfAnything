# N21 — Key of Solomon — Grimoiric Tradition and Solomonic Magic
...
## DOCUMENT NAVIGATION
- [§1 Solomon as Magician — Development of the Legend](#1-solomon-as-magician)
- [§2 The Greater Key of Solomon (Clavicula Salomonis)](#2-the-greater-key-of-solomon)
- [§3 The Lesser Key of Solomon (Lemegeton)](#3-the-lesser-key-of-solomon)
- [§4 Testament of Solomon — The Earliest Text](#4-testament-of-solomon)
- [§5 Solomon in Islamic Tradition — Jinn and the Seal](#5-solomon-in-islamic-tradition)
- [§6 Transmission History and Manuscript Tradition](#6-transmission-history)
...
The **Key of Solomon** (*Clavicula Salomonis*) is the most influential grimoire in the Western magical tradition — a collection of ritual instructions, invocations, sigils, and pentacles attributed to King Solomon but composed primarily in the **14th–17th centuries CE**. The tradition rests on a biblical foundation: 1 Kings 4:29-34 credits Solomon with wisdom over all creation, and later Jewish, Christian, and Islamic traditions expanded this into mastery over demons, spirits, and hidden knowledge. The earliest Solomonic magical text is the **Testament of Solomon** (~1st–5th century CE), a Greek-language narrative in which Solomon binds demons to build the Temple using a divine ring. The **Greater Key** (earliest MSS: 14th–15th c.) focuses on angelic invocation and ritual preparation; the **Lemegeton** or **Lesser Key** (compiled ~17th c.) catalogs 72 named demons with their ranks, seals, and powers. These texts drew on Jewish Kabbalistic angel magic, Greco-Egyptian magical papyri, Arabic *da'wa* (invocational magic), and Christian liturgical forms. They profoundly influenced Renaissance occultism (Agrippa, Dee), modern ceremonial magic (Golden Dawn, Crowley), and continue to shape Western esoteric practice today.
...
- **1 Kings 6-7:** Solomon builds the Temple — the architectural centerpiece of Israelite religion
...
- The **ring of Solomon** (*khātam Sulaymān*) bearing the divine Name, which gives power over demons and djinn, becomes the central motif
- **Tier 2** — Rabbinic sources are historical documents; the claims are theological/literary
...
- **S. L. MacGregor Mathers** published the standard English translation in 1889, working from seven British Library manuscripts (Lansdowne MS 1203, Add. MS 10862, Sloane MS 1307, Sloane MS 3091, Harleian MS 3981, King's MS 288, Sloane MS 3847)
...
|------|-------|-------------|
| **Book I** | Conjurations and invocations | Summoning of spirits; oaths by divine names; hours and days of operation |
| **Book II** | Ritual preparation | Pentacles (protective/empowering symbols); ritual implements (athame, wand, robes); purification baths; fasting; prayers |

**Key elements:**
- **44 pentacles** organized by the seven classical planets (Saturn, Jupiter, Mars, Sun, Venus, Mercury, Moon) — each with Hebrew names of God, angelic names, and Psalm verses inscribed in geometric patterns
- **Planetary timing:** Operations must be performed during the correct planetary hour and day — a system drawn from Hellenistic astrology
...
- **Arabic magical texts:** The *Picatrix* (*Ghāyat al-Ḥakīm*, ~10th–11th c.), Arabic *Shams al-Ma'ārif* (13th c.), and similar texts share techniques with the Key — suggesting Arabic intermediary transmission
- **Christian liturgy:** Many of the prayers, psalms, and purification rituals directly parallel Christian liturgical forms
- **Tier 2** — Source analysis is scholarly reconstruction, well-supported but debated in details
...
| Book | Title | Contents |
|------|-------|----------|
| **1** | **Ars Goetia** | Catalog of 72 demons, each with name, rank, seal, appearance, and powers. The most famous section |
| **2** | **Ars Theurgia-Goetia** | Spirits of the compass directions; 31 aerial spirits and their servants |
| **3** | **Ars Paulina** | Angels of the hours of the day and the zodiacal signs; attributed (falsely) to Paul the Apostle |
...
- **Examples:**
  - **Paimon** (#9): "A great King... he appears with a crown, riding a dromedary... teaches all arts, sciences, and secret things; reveals hidden treasure"
  - **Astaroth** (#29): "A mighty Duke... appears as a foul angel riding an infernal beast" — name derived from Canaanite goddess **Astarte/Ishtar** (→ demonization of pagan deities)
  - **Asmodeus** (#32): "A great King... from the Talmudic Ashmedai"
- **The demonization pattern:** Many Goetic demon names derive from pre-existing pagan deities (Astarte → Astaroth, Baal → Bael, etc.) or from Jewish/Christian demonological tradition (Asmodeus ← Ashmedai, Belial ← Beliyya'al)
- **Tier 2** — The manuscript contents are verifiable; the demonization pattern is well-established scholarship
...
- **36 decans** — each decan (10° of the zodiac) is associated with a demon and a bodily affliction — combining demonology with Hellenistic astrology
- The Testament demonstrates that **Solomonic magical literature existed before Christianity became the dominant religion** — it cannot be dismissed as purely medieval invention
- **Tier 2** — Content is documented; the question is how much pre-Christian material it preserves
...
- **Quran 21:82, 38:36-38:** Solomon is given power over wind and *shayāṭīn* (satanic jinn) whom he employs for construction and diving
...
- The Six-pointed star (hexagram) and five-pointed star (pentagram) both appear as "Seal of Solomon" in different traditions — the hexagram predominated in Jewish contexts, the pentagram in Islamic and Western magical contexts
- **Tier 2** — Islamic magical texts are documented; the Solomonic attribution is conventional
...
|--------|------------|-----------|
| ~10th c. BCE | Biblical Solomon — wisdom traditions | 1 Kings, Proverbs (attributed) |
| ~1st c. BCE–5th c. CE | Hellenistic expansion — Solomon as magician/exorcist | Wisdom of Solomon, Josephus, Testament of Solomon |
| ~3rd–7th c. CE | Jewish mystical elaboration | Hekhalot texts, Sefer ha-Razim |
| ~7th–12th c. CE | Islamic integration — jinn mastery | Quran, hadith, Arabic grimoires |
| ~12th–14th c. CE | Latin/Italian grimoire compilation | Earliest Key of Solomon MSS; Liber Iuratus Honorii (Sworn Book of Honorius) |
| ~15th–16th c. CE | Renaissance occultism | Agrippa, *De Occulta Philosophia* (1533); John Dee's Enochian system |
| ~17th c. CE | Lemegeton compilation | Ars Goetia catalog of 72; printed editions begin circulating |
...
- Bodleian Library (Oxford) holds additional copies
- **No two manuscripts are identical** — scribes modified, added, and rearranged material freely. This is a *living tradition*, not a fixed canon
- **Tier 1** — The manuscripts physically exist and can be consulted
...
- Planetary magic (seven classical planets) is Hellenistic, not ancient Israelite
...
- The grimoiric system influenced literature (Marlowe's *Doctor Faustus*, Goethe's *Faust*, Lovecraft's *Necronomicon* concept) and continues in modern media (anime, video games, TV — *Supernatural*, *Ars Goetia* in *Persona*/*SMT*)
- **Tier 3** — Jungian interpretation is speculative; cultural influence is Tier 1
...
|---|-------------|----------|--------|---------|
| 1 | Pentacle of Solomon from Mathers' edition | N21_solomon_pentacle.jpg | Public Domain (1889 edition) | Public Domain |
| 2 | Ars Goetia demon seal examples (Paimon, Astaroth) | N21_goetia_seals.jpg | Public Domain (17th c. MSS) | Public Domain |
| 3 | Seal of Solomon hexagram/pentagram variants | N21_seal_of_solomon.jpg | Wikimedia Commons | CC BY-SA 3.0 |
| 4 | Testament of Solomon manuscript page | N21_testament_manuscript.jpg | Wikimedia Commons | Public Domain |
| 5 | Magic circle from Key of Solomon MS | N21_magic_circle.jpg | British Library MS Sloane 3091 | Public Domain |

*Search terms: "Key of Solomon pentacle Mathers," "Ars Goetia demon seals manuscript," "Seal of Solomon hexagram pentagram," "Testament of Solomon Greek manuscript," "Key of Solomon magic circle British Library Sloane"*
...
|-------------|-----------|
| [A02 — Bible Serpent References](../A_Foundations/A02_Bible_Serpent_References.md) | Biblical Solomon as foundation of the tradition |
...
*Research drawn from primary manuscripts (British Library Sloane collection, Mathers edition), biblical and Quranic primary texts, and academic monographs from Cambridge UP, Oxford UP, and Brill. All sources verifiable. Last Updated: Mar 4, 2026*
