...
Money is the most pervasive technology in human civilization — more people interact with monetary systems daily than with any other human invention. Yet the history of money reveals something counterintuitive: DEBT came before coins. David Graeber's landmark *Debt: The First 5000 Years* (2011) demonstrated that the "barter → coins → credit" narrative taught in economics textbooks is historically backwards. In reality, complex credit systems existed in Sumerian temples by 3500 BCE — debts denominated in barley and silver shekels were recorded on clay tablets (A01) thousands of years before the first coins appeared in Lydia (~600 BCE). The control of money creation has been inseparable from the control of civilizations: Sumerian temple economies, Roman debasement, Medieval Templar banking (N04), Renaissance Medici power, and the establishment of central banks (Bank of England 1694, Federal Reserve 1913) all represent the same fundamental pattern — whoever controls the monetary system controls political power. Today, most money is created not by governments but by private commercial banks through lending (McLeay et al. 2014, Bank of England) — a fact that surprises even most economics students. The architecture of modern finance, from fractional reserve banking to derivatives markets ($632 trillion notional value as of 2022), represents perhaps the most complex and least understood power structure on Earth, connecting directly to questions of who rules, how knowledge is controlled (H01), and why civilizational cycles repeat (E09).
...
- **Knights Templar (1119-1312):** created the first international banking system
  ...
  - Their enormous financial power likely contributed to their suppression by Philip IV of France (who owed them immense debts) in 1307 (see N04)
...
|---|-------------|----------|--------|---------|
| 1 | Sumerian clay tablet with debt record | N05_sumerian_debt_tablet_001.jpg | British Museum | CC BY-NC-SA |
| 2 | Lydian electrum stater coin | N05_lydian_coin_002.jpg | Classical Numismatic Group | CC BY-SA |
| 3 | Federal Reserve building | N05_federal_reserve_003.jpg | Wikimedia Commons | Public Domain |
| 4 | Global wealth inequality pyramid | N05_wealth_pyramid_004.jpg | Credit Suisse adapted | Fair Use |
...
|-------------|-----------|
| [A01 — Sumerian Texts](../A_Foundations/A01_Sumerian_Texts_and_Tablets.md) | Earliest debt records on clay tablets |
| [N04 — Knights Templar](../N_Secret_Societies/N04_Knights_Templar.md) | First international banking system |
| [H01 — Suppression](../H_Suppression_and_Thesis/H01_Suppression_of_Ancient_Knowledge.md) | Financial knowledge suppression |
| [E09 — Rise and Fall](../E_Cataclysms_and_Chronology/E09_Rise_Fall_Civilizations.md) | Economic cycles and collapse |
| [N01 — Mystery Schools](../N_Secret_Societies/N01_Mystery_Schools.md) | Secret knowledge and power structures |
