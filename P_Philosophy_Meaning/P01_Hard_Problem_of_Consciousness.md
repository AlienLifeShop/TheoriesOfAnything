...
|---|-------------|----------|--------|---------|
| 1 | David Chalmers portrait / lecture | P01_chalmers_hard_problem_001.jpg | Wikimedia Commons | CC BY 2.0 |
| 2 | Neural correlates of consciousness diagram | P01_neural_correlates_diagram_001.png | Wikimedia Commons | CC BY-SA 4.0 |
| 3 | Microtubule structure (Orch OR) | P01_microtubule_structure_001.png | Wikimedia Commons | CC BY-SA 3.0 |
| 4 | Global workspace theory diagram | P01_global_workspace_diagram_001.png | Wikimedia Commons | CC BY-SA 4.0 |
| 5 | Integrated Information Theory (Φ) | P01_iit_phi_diagram_001.png | Wikimedia Commons | CC BY-SA 4.0 |
| 6 | Brain under anesthesia (fMRI) | P01_anesthesia_fmri_001.jpg | Academic / Alkire 2008 | Fair Use |
| 7 | Split-brain experiment diagram | P01_split_brain_experiment_001.png | Wikimedia Commons | CC BY-SA 4.0 |
| 8 | Ancient consciousness symbols collage | P01_ancient_consciousness_symbols_001.png | Wikimedia Commons | Public Domain |
