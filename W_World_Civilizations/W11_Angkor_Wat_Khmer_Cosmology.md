# W11 — Angkor Wat, Khmer Cosmology, and Hindu-Buddhist Temple Mountains
...
> **Cross-References:** C06, C11, D05, D22, C36, D06, J05, E09
...
## DOCUMENT NAVIGATION
- [§1 The Khmer Empire — Rise and Cosmological Foundation](#1-the-khmer-empire)
- [§2 Angkor Wat — Architecture and Symbolism](#2-angkor-wat)
- [§3 Angkor Thom, Bayon, and Buddhist Transformation](#3-angkor-thom-bayon)
- [§4 The Hydraulic City — Water Engineering](#4-the-hydraulic-city)
- [§5 Decline, Rediscovery, and LIDAR Revelations](#5-decline-and-rediscovery)
...
- **Location:** East wing of southern gallery; 49 m long
- **Narrative:** Devas (gods) and asuras (demons) use the serpent Vasuki as a rope wrapped around Mount Mandara, pulling alternately to churn the cosmic ocean
- **Products of the Churning:** Amrita (elixir of immortality), Lakshmi (goddess of fortune), the apsaras, various treasures, and halahala (poison, consumed by Shiva)
- **Political meaning:** The king (Suryavarman II, depicted as Vishnu) oversees the cosmic process — the state IS the churning, maintaining order between opposing forces
- **Astronomical interpretation:** Some scholars (e.g., Eleanor Mannikka) argue the bas-relief encodes **astronomical measurements**: the number of devas and asuras corresponds to solar/lunar cycles

### 2.3 Astronomical Alignments

| Alignment | Description |
|-----------|-------------|
| **Spring equinox** | Sun rises directly over the central tower when viewed from the western causeway (→ [D06](../D_Sites_and_Artifacts/D06_Serpent_Mound_Effigy_Mounds.md)) |
...
| **Precession?** | Graham Hancock proposed Angkor temple layout mirrors Draco constellation at ~10,500 BCE; this is rejected by archaeologists but noted as an alternative claim (→ [G03](../G_Modern_Frameworks/G03_Mycelium_Network.md)) |
...
- **Jayavarman VII** (r. ~1181-1218 CE): Perhaps the greatest Khmer king; converted the empire from Hinduism to **Mahayana Buddhism**; built more structures than all previous kings combined
- **Angkor Thom** (9 km² walled city, 3 km per side): New capital built around the **Bayon** temple
- **Bayon:** ~216 serene stone faces (often identified with Avalokiteshvara, the bodhisattva of compassion — or Jayavarman VII himself, or both) gazing in all directions
- **Ta Prohm:** University/monastery complex; deliberately left partially unrestored with trees growing through it; inscription records 12,640 functionaries, 79,365 support staff
- **Preah Khan:** Temple-monastery-university complex dedicated to Jayavarman VII's father; 515 deities in the central sanctuary
...
- **LIDAR and dendrochronology** studies reveal that Greater Angkor's water system was designed for **normal monsoon variability**
- 14th-15th century climate records show alternating **severe droughts** and **extreme flooding** — outside the system's design parameters
- Buckley et al. (2010): Tree-ring data from Vietnamese cypress trees show anomalous climate during Angkor's decline period
- The hydraulic system's centralized nature meant that **failure cascaded** — unlike dispersed agricultural systems
- This finding supports the **climate-civilization nexus** observed in other collapse events (→ [S10](../S_Future_Technology/S10_Climate_Change_Civilization_Deep_Time.md), E09)
...
- **2012-2015:** Damian Evans and team used airborne LIDAR to penetrate jungle canopy
- Revealed **Greater Angkor** as a **1,000+ km² urban landscape** — the largest pre-industrial city complex ever documented
- Discovered previously unknown temple complexes, road networks, spiral-shaped mounds, neighborhoods, and industrial areas
- Mahendraparvata (Phnom Kulen) revealed as an early urban grid with sophisticated water management
- Confirmed that Angkor was not an isolated monument but a **continuous urban landscape** serving ~750,000-1,000,000 people

### 5.2 Current Challenges

- **Tourism pressure:** ~2.6 million visitors/year (pre-COVID); structural stress; ground subsidence from groundwater extraction
- **Restoration:** International collaboration (APSARA Authority, UNESCO, teams from Japan, France, India, Germany, etc.)
- **Living landscape:** Local communities continue to live within and around Angkor; Buddhist monasteries active at many temples
- **Looting:** Ongoing problem; many statues removed and sold on black market; war damage from Khmer Rouge period
...
| [C36 — Axis Mundi](../C_Global_Traditions/C36_Sacred_Trees_Axis_Mundi.md) | Mount Meru / temple-mountain as axis mundi |
...
- **Skeptical position:** Mainstream scholars have raised substantive objections to several claims associated with Angkor Wat, Khmer Cosmology, and Hindu-Buddhist Temple Mountains. Critics argue that alternative explanations rooted in established scientific, historical, or psychological frameworks can account for the available evidence without invoking extraordinary mechanisms.
- **Methodological concerns:** The evidence base for some claims related to Angkor Wat, Khmer Cosmology, and Hindu-Buddhist Temple Mountains relies on interpretive arguments, circumstantial data, or sources that have not undergone rigorous peer review. Scientific methodology demands reproducible evidence and controlled analysis.
- Critics have noted that extraordinary claims require extraordinary evidence, and the current evidentiary basis remains insufficient by conventional academic standards.

### Alternative Explanations & Disputed Evidence

- **Alternative explanations:** Conventional frameworks offer well-documented explanations for many phenomena associated with Angkor Wat, Khmer Cosmology, and Hindu-Buddhist Temple Mountains. Critics argue these conventional explanations should be exhausted before more speculative interpretations are pursued.
...
2. Coe, M. D. (2003). *Angkor and the Khmer Civilization*. Thames & Hudson. ISBN: 9780500052105
3. Evans, D., et al. (2013). "Uncovering Archaeological Landscapes at Angkor Using Lidar." *PNAS*, 110(31).
4. Evans, D. (2016). "Airborne Laser Scanning as a Method for Exploring Long-Term Socio-Ecological Dynamics in Cambodia." *Journal of Archaeological Science*, 74. DOI: 10.1016/j.jas.2016.05.009
5. Mannikka, E. (1996). *Angkor Wat: Time, Space, and Kingship*. University of Hawai'i Press. DOI: 10.2307/2761011
6. Buckley, B. M., et al. (2010). "Climate as a Contributing Factor in the Demise of Angkor, Cambodia." *PNAS*, 107(15).
7. Fletcher, R. (2012). "Low-Density, Agrarian-Based Urbanism: Scale, Power, and Ecology." In *The Comparative Archaeology of Complex Societies*. Cambridge University Press. DOI: 10.1017/cbo9781139022712.013
8. Jacques, C., & Freeman, M. (1997). *Angkor: Cities and Temples*. River Books.
9. Sharrock, P. D. (2009). "Garuda, Vajrapani, and Religious Change in Jayavarman VII's Angkor." *Journal of Southeast Asian Studies*, 40(1). DOI: 10.1017/s0022463409000083
10. Lustig, E. (2009). "Power and Pragmatism in the Political Economy of Angkor." PhD dissertation, University of Sydney.
11. Penny, D., et al. (2014). "The Demise of Angkor: Systemic Vulnerability of Urban Infrastructure to Climatic Variations." *Science Advances*, 2(10). DOI: 10.1126/sciadv.aau4029. ISBN: 9780521561785
