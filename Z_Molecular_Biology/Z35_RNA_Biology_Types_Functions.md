# Z35 — RNA Biology: Types and Functions
...
> **Cross-References:** Z14 — Epigenetics Inheritance · [Z28 — Viral Integration ERVs](L51_Viral_Integration_Endogenous_Retroviruses.md) · [Z26 — Chromosome Evolution](L49_Chromosome_Evolution_Karyotype.md) · S08 — CRISPR Gene Editing · Q12 — RNA World Hypothesis
...
- **Major functional lncRNAs:**
  - ***XIST*** (X-inactive specific transcript): ~17 kb lncRNA transcribed from the X-inactivation center → coats the X chromosome in cis → recruits Polycomb repressive complex (PRC2) and other silencing factors → compacts chromatin → transcriptional silencing of ~85% of X-linked genes (Z26); the paradigmatic lncRNA
  ...
  - ***TERC*** (telomerase RNA component): The RNA template within telomerase — essential for telomere maintenance (Z27)
...
- **Function:** Silence transposable elements (LINE-1, ERVs; Z28) in the germline — protecting genome integrity during gametogenesis; the "ping-pong" amplification cycle in *Drosophila* creates a feed-forward loop of TE-silencing piRNAs; piRNA pathway dysfunction → transposon derepression → male infertility in mice
...
- **Ribosome as ribozyme:** The peptidyl transferase center is composed entirely of rRNA → protein synthesis is fundamentally an RNA-catalyzed reaction → strong support for the RNA world hypothesis (Q12)
...
3. Cech, T. R. & Steitz, J. A. (2014). "The Noncoding RNA Revolution — Trashing Old Rules to Forge New Ones." *Cell*, 157(1), 77–94.
4. Karikó, K. et al. (2005). "Suppression of RNA Recognition by Toll-like Receptors: The Impact of Nucleoside Modification and the Evolutionary Origin of RNA." *Immunity*, 23(2), 165–175.
5. Rinn, J. L. & Chang, H. Y. (2012). "Genome Regulation by Long Noncoding RNAs." *Annual Review of Biochemistry*, 81, 145–166.
6. Ozata, D. M. et al. (2019). "PIWI-Interacting RNAs: Small RNAs with Big Functions." *Nature Reviews Genetics*, 20(2), 89–108.
7. Ban, N. et al. (2000). "The Complete Atomic Structure of the Large Ribosomal Subunit at 2.4 Å Resolution." *Science*, 289(5481), 905–920.
8. Kristensen, L. S. et al. (2019). "The Biogenesis, Biology and Characterization of Circular RNAs." *Nature Reviews Genetics*, 20(11), 675–691.
9. Adams, D. et al. (2018). "Patisiran, an RNAi Therapeutic, for Hereditary Transthyretin Amyloidosis." *New England Journal of Medicine*, 379(1), 11–21.
...
- **Z14 — Epigenetics Inheritance:** RNA-mediated epigenetic regulation (lncRNAs, piRNAs)
- **[Z28 — Viral Integration ERVs](L51_Viral_Integration_Endogenous_Retroviruses.md):** piRNA silencing of endogenous retroviruses
- **[Z26 — Chromosome Evolution](L49_Chromosome_Evolution_Karyotype.md):** XIST lncRNA in X-inactivation
- **S08 — CRISPR Gene Editing:** CRISPR guide RNA (crRNA/tracrRNA) as functional RNA
- **Q12 — RNA World Hypothesis:** Catalytic RNA supporting prebiotic RNA world
