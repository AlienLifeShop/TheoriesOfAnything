# Z29 — Forensic Genetics and DNA Identification
...
- Predicting physical appearance from DNA using pigmentation SNPs (L23): IrisPlex (6 SNPs → eye color), HIrisPlex (22 SNPs → eye + hair color), HIrisPlex-S (41 SNPs → eye + hair + skin color); additional traits under development: facial morphology (SNPs in *PAX3*, *TP63*, *EDAR*), male pattern baldness, freckling
...
2. Butler, J. M. (2015). *Forensic DNA Typing: Biology, Technology, and Genetics of STR Markers*. 3rd ed. Academic Press.
3. Hares, D. R. (2015). "Selection and Implementation of Expanded CODIS Core Loci in the United States." *Forensic Science International: Genetics*, 17, 33–34.
4. Greytak, E. M. et al. (2019). "Genetic Genealogy for Cold Case and Active Investigations." *Forensic Science International*, 299, 103–113.
5. Walsh, S. et al. (2011). "IrisPlex: A Sensitive DNA Tool for Accurate Prediction of Blue and Brown Eye Colour." *Forensic Science International: Genetics*, 5(3), 170–180.
6. Budowle, B. & van Daal, A. (2008). "Forensically Relevant SNP Classes." *BioTechniques*, 44(5), 603–608.
7. PCAST (2016). *Report to the President: Forensic Science in Criminal Courts*. President's Council of Advisors on Science and Technology.
8. Bright, J.-A. et al. (2016). "Developmental Validation of STRmix™." *Forensic Science International: Genetics*, 23, 226–239.
9. Kayser, M. (2015). "Forensic DNA Phenotyping: Predicting Human Appearance from Crime Scene Material for Investigative Purposes." *Forensic Science International: Genetics*, 18, 33–48.
10. Gill, P. et al. (2012). "DNA Commission of the International Society of Forensic Genetics: Recommendations on the Interpretation of Mixtures." *Forensic Science International: Genetics*, 6(6), 684–688.

---

## CROSS-REFERENCE INDEX

- **[L23 — Genetics Skin Hair Eye Color](../L_Genetics_Origins/L23_Genetics_Skin_Hair_Eye_Color.md):** Pigmentation SNPs for forensic DNA phenotyping
- **Z08 — Human Migration Genetics:** Ancestry-informative markers in forensic context
- **Z05 — Ancient DNA:** Shared DNA extraction/amplification techniques for degraded samples
- **[L16 — Population Genetics](../L_Genetics_Origins/L16_Population_Genetics_Hardy_Weinberg.md):** Allele frequency databases for statistical calculations
- **[L25 — Paleogenomics Methods](../L_Genetics_Origins/L25_Paleogenomics_Methods_Ancient_DNA.md):** Technical overlap with ancient DNA recovery methods
