# Z41 — Genome Architecture and 3D Organization
...
> **Cross-References:** Z14 — Epigenetics Inheritance · [Z26 — Chromosome Evolution](L49_Chromosome_Evolution_Karyotype.md) · [Z35 — RNA Biology](L60_RNA_Biology_Types_Functions.md) · [Z28 — Viral Integration ERVs](L51_Viral_Integration_Endogenous_Retroviruses.md) · R09 — Cell Biology
...
- **Debate:** Whether lamina tethering is a cause or consequence of gene silencing; some studies show that artificial tethering of genes to the lamina can silence them, but not consistently.
...
1. Lieberman-Aiden, Erez, et al. "Comprehensive Mapping of Long-Range Interactions Reveals Folding Principles of the Human Genome." *Science* 326 (2009): 289–293.
2. Dixon, Jesse R., et al. "Topological Domains in Mammalian Genomes Identified by Analysis of Chromatin Interactions." *Nature* 485 (2012): 376–380.
3. Rao, Suhas S. P., et al. "A 3D Map of the Human Genome at Kilobase Resolution Reveals Principles of Chromatin Looping." *Cell* 159 (2014): 1665–1680.
4. Fudenberg, Geoffrey, et al. "Formation of Chromosomal Domains by Loop Extrusion." *Cell Reports* 15 (2016): 2038–2049.
5. Cremer, Thomas, and Christoph Cremer. "Chromosome Territories, Nuclear Architecture and Gene Regulation in Mammalian Cells." *Nature Reviews Genetics* 2 (2001): 292–301.
...
- **Z14 — Epigenetics Inheritance:** Histone marks, chromatin states, epigenetic regulation
- **[Z26 — Chromosome Evolution](L49_Chromosome_Evolution_Karyotype.md):** Chromosome structure and evolution
- **[Z35 — RNA Biology](L60_RNA_Biology_Types_Functions.md):** lncRNA scaffolding (XIST, NEAT1)
- **[Z28 — Viral Integration ERVs](L51_Viral_Integration_Endogenous_Retroviruses.md):** SINE enrichment at TAD boundaries
- **R09 — Cell Biology:** Nuclear structure, cell division
