# Z17 — Transposons and Mobile Genetic Elements
...
> **Cross-References:** L01 — DNA Discovery · [Z13 — Gene Expression Regulation](L28_Gene_Expression_Regulation.md) · [Z11 — Human Genome Project](L26_Human_Genome_Project_Legacy.md) · R01 — Darwin Evolution · [Z16 — Genetic Recombination](L34_Genetic_Recombination_Crossing_Over.md)
...
| # | Description | Source |
|---|-------------|--------|
| 1 | TE classification diagram (Class I and II) | Standard molecular biology texts |
| 2 | L1 retrotransposition cycle (TPRT mechanism) | Kazazian (2004) adapted |
| 3 | Human genome TE composition pie chart | Lander et al. (2001) |
| 4 | Maize kernel variegation (Ac/Ds) | McClintock (1950) adapted |
...
3. Kazazian, H. H. et al. (1988). "Haemophilia A Resulting from De Novo Insertion of L1 Sequences Represents a Novel Mechanism for Mutation in Man." *Nature*, 332, 164–166.
4. Agrawal, A., Eastman, Q. M., & Schatz, D. G. (1998). "Transposition Mediated by RAG1 and RAG2 and Its Implications for the Evolution of the Immune System." *Nature*, 394, 744–751.
5. Mi, S. et al. (2000). "Syncytin Is a Captive Retroviral Envelope Protein Involved in Human Placental Morphogenesis." *Nature*, 403, 785–789.
6. Bourque, G. et al. (2018). "Ten Things You Should Know About Transposable Elements." *Genome Biology*, 19, 199.
7. Hancks, D. C., & Kazazian, H. H. (2016). "Roles for Retrotransposon Insertions in Human Disease." *Mobile DNA*, 7, 9.
8. Chuong, E. B., Elde, N. C., & Feschotte, C. (2017). "Regulatory Activities of Transposable Elements: From Conflicts to Benefits." *Nature Reviews Genetics*, 18, 71–86.
9. Koonin, E. V., & Makarova, K. S. (2013). "CRISPR-Cas: Evolution of an RNA-Based Adaptive Immunity System in Prokaryotes." *RNA Biology*, 10(5), 679–686.
10. Muotri, A. R. et al. (2005). "Somatic Mosaicism in Neuronal Precursor Cells Mediated by L1 Retrotransposition." *Nature*, 435, 903–910.

---

## CROSS-REFERENCE INDEX

- **L01 — DNA Discovery:** DNA as substrate for transposon movement
- **[Z13 — Gene Expression Regulation](L28_Gene_Expression_Regulation.md):** TE-derived regulatory elements
- **[Z11 — Human Genome Project](L26_Human_Genome_Project_Legacy.md):** Revealed TEs as ~45% of human genome
- **R01 — Darwin Evolution:** TEs as agents of genome evolution
- **[Z16 — Genetic Recombination](L34_Genetic_Recombination_Crossing_Over.md):** NAHR between TE copies causing rearrangements
- **[L18 — Mendel Inheritance](../L_Genetics_Origins/L18_Mendel_Inheritance_Rediscovery.md):** Ac/Ds transposons in Mendel's organism (maize)
