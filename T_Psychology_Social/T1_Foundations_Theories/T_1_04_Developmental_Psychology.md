...
> **Cross-References:** [T_1_02](T_1_02_Evolutionary_Psychology_Adapted_Mind.md) · [ZC_1_03](../T2_Clinical_Health/T_2_02_Neurodiversity.md) · [K_2_01](../../K_Consciousness/K2_Neuroscience_Brain/K_2_01_Split_Brain_Divided_Consciousness.md) · [T_2_02](../T2_Clinical_Health/T_2_02_Neurodiversity.md) · [R_2_09](../../R_Biology_Evolution/R2_Human_Primate_Evolution/R_2_09_Self_Domestication.md)
...
### 1.1 Piaget's Cognitive Stage Theory (1936–1970)
...
### 1.2 Attachment Theory (Bowlby, 1958, 1969)
...
### 1.3 Ainsworth's Strange Situation (1970)
...
### 1.4 Erikson's Psychosocial Stages (1950)
...
### 1.5 Adverse Childhood Experiences (Felitti et al., 1998)
...
### 2.1 Kohlberg's Moral Development (1958, 1981)
...
### 2.2 Critical and Sensitive Periods
...
### 2.4 Neuroplasticity Across the Lifespan
...
### 2.5 Internal Working Models and Intergenerational Transmission
...
### 3.1 Epigenetic Intergenerational Trauma
...
### 3.2 Attachment Causation vs. Correlation
...
### 3.3 Fourth Trimester Hypothesis
...
### 4.2 "Refrigerator Mother" Hypothesis
...
- **Screen time and neurodevelopment:** How does early childhood exposure to screens, tablets, and digital media affect cognitive development, attention regulation, language acquisition, and social-emotional development? Longitudinal data with adequate controls for confounding variables (socioeconomic status, parenting quality) remain scarce despite intense public concern.

- **Global developmental diversity:** Piaget's, Erikson's, and Kohlberg's models were developed from Western samples. How do developmental trajectories differ in subsistence-farming communities, pastoralist societies, and non-literate cultures? Rogoff (2003) provides a framework, but systematic cross-cultural developmental data remain limited for most populations.

- **Epigenetic mechanisms of intergenerational trauma:** Can animal models of epigenetic inheritance (Dias & Ressler, 2014) be validated in human populations with adequate controls for shared environment and cultural transmission? Distinguishing biological from behavioral transmission pathways is a critical frontier.

- **Post-formal development validation:** Do post-formal cognitive stages (Commons, Kegan, Cook-Greuter) represent genuine developmental advances or culturally valued perspectives mistaken for universal development? Large-sample, cross-cultural validation using standardized instruments is needed.

- **ACE interactions and resilience:** The ACE model demonstrates dose-response effects, but what protects some high-ACE individuals from adverse outcomes? Resilience research (Masten, 2014) identifies protective factors (secure attachment, supportive adult relationship, community resources) but specific mechanisms of resilience remain incompletely understood.

- **Attachment beyond infancy:** How do attachment patterns evolve, stabilize, or change across the lifespan? The transition from childhood attachment to adult romantic attachment (Hazan & Shaver, 1987) is well-documented, but developmental mechanisms driving attachment continuity and change remain debated.
...
- **Longitudinal vs. cross-sectional designs:** Longitudinal studies (e.g., Minnesota Longitudinal Study) provide developmental trajectory data but suffer from attrition, cohort effects, and enormous resource requirements. Cross-sectional comparisons are more efficient but conflate age with cohort.

- **Observer bias in attachment coding:** Strange Situation classifications and AAI coding require trained raters whose reliability must be established and maintained. Inter-rater agreement is generally high but not perfect, and coder drift over time can affect consistency.

- **Ethical constraints with children:** Experimental manipulation of developmental variables (deprivation, stress, attachment disruption) is ethically prohibited in human research. Developmental psychology relies extensively on natural experiments, quasi-experimental designs, observational studies, and animal models.

- **Retrospective vs. prospective data:** Studies of childhood adversity often rely on adult retrospective reports, which are subject to recall bias, current-mood effects, and narrative reconstruction. Prospective studies beginning in childhood are methodologically superior but rare due to cost and duration.

- **Cultural validity of assessment instruments:** Piaget's tasks, Ainsworth's Strange Situation, and Kohlberg's moral dilemmas were developed in Western cultural contexts. Their validity across cultures requires demonstration rather than assumption—a challenge (cf. ZC_1_03) that developmental psychology has only partially addressed.

---

## KEY TERMS GLOSSARY

- **Object permanence:** The understanding that objects continue to exist when they are no longer visible—a milestone of Piaget's sensorimotor stage typically achieved around 8-12 months.

- **Zone of proximal development (ZPD):** Vygotsky's concept describing the gap between what a child can accomplish independently and what they can achieve with guidance from a more skilled partner.

- **Secure base:** Bowlby and Ainsworth's term for the attachment figure's role as a reliable starting point from which the child explores the environment and to which they return when distressed.

- **Internal working model:** Bowlby's concept of cognitive-affective templates shaped by early attachment experiences that structure expectations about relationships throughout life.

- **Scaffolding:** The adaptive support provided by a more knowledgeable partner that enables a child to perform tasks within their ZPD, gradually withdrawn as competence develops.

- **ACEs (Adverse Childhood Experiences):** Standardized categories of childhood adversity—abuse, neglect, and household dysfunction—whose cumulative count predicts adult health and psychological outcomes in a graded dose-response relationship.

- **Sensitive period:** A developmental window during which the organism is maximally responsive to specific environmental inputs; experience outside this window produces diminished or absent effects.

- **Disorganized attachment:** A pattern characterized by contradictory, confused attachment behavior in infants, associated with frightening or dissociative caregiver behavior and elevated risk for later psychopathology.
...
1. Ainsworth, M.D.S., et al. (1978). *Patterns of Attachment*. Hillsdale: Erlbaum.
2. Bowlby, J. (1969). *Attachment and Loss: Vol. 1*. New York: Basic Books. DOI: 10.1093/sw/26.4.355
3. Commons, M.L., & Richards, F.A. (2003). "Four Postformal Stages." In *Handbook of Adult Development*. New York: Springer. DOI: 10.1007/978-1-4615-0617-1_11
4. Cook-Greuter, S.R. (2000). "Mature Ego Development." *JAD*, 7(4), 227-240. DOI: 10.1023/a:1009511411421
5. Dias, B.G., & Ressler, K.J. (2014). "Parental Olfactory Experience Influences Behavior in Subsequent Generations." *Nature Neuroscience*, 17(1), 89-96. DOI: 10.1038/nn.3594.
6. Erikson, E.H. (1950). *Childhood and Society*. New York: W.W. Norton.
7. Felitti, V.J., et al. (1998). "Childhood Abuse and Household Dysfunction." *AJPM*, 14(4), 245-258.
8. Gilligan, C. (1982). *In a Different Voice*. Cambridge: Harvard University Press. DOI: 10.1017/s0360966900023859
9. Hubel, D.H., & Wiesel, T.N. (1963). "Receptive Fields in Striate Cortex of Young Kittens." *JNP*, 26(6), 994-1002.
10. Johnson, J.S., & Newport, E.L. (1989). "Critical Period Effects in Second Language Learning." *Cognitive Psychology*, 21(1), 60-99.
11. Kegan, R. (1994). *In Over Our Heads*. Cambridge: Harvard University Press. ISBN: 9780674257894
12. Kohlberg, L. (1981). *Essays on Moral Development: Vol. 1*. San Francisco: Harper & Row.
13. Lenneberg, E.H. (1967). *Biological Foundations of Language*. New York: Wiley.
14. Lourenço, O., & Machado, A. (1996). "In Defense of Piaget's Theory." *Psychological Review*, 103(1), 143-164.
15. Maguire, E.A., et al. (2000). "Navigation-Related Structural Change in Hippocampi." *PNAS*, 97(8), 4398-4403.
16. Main, M., & Solomon, J. (1986). "Insecure-Disorganized/Disoriented Attachment Pattern." In *Affective Development in Infancy*. Norwood: Ablex. ISBN: 9780893913458
17. Piaget, J. (1952). *The Origins of Intelligence in Children*. New York: IUP.
18. Rogoff, B. (2003). *The Cultural Nature of Human Development*. Oxford: Oxford University Press. ISBN: 9781280472688
19. Sroufe, L.A., et al. (2005). *The Development of the Person*. New York: Guilford.
20. Vaillant, G.E. (2012). *Triumphs of Experience*. Cambridge: Belknap.
21. van IJzendoorn, M.H. (1995). "Adult Attachment Representations." *Psychological Bulletin*, 117(3), 387-403.
22. van IJzendoorn, M.H., & Kroonenberg, P.M. (1988). "Cross-Cultural Patterns of Attachment." *Child Development*, 59(1), 147-156.
23. Yehuda, R., et al. (2016). "Holocaust Exposure Induced Intergenerational Effects." *Biological Psychiatry*, 80(5), 372-380.
...
|----------|-------|--------------|
| [T_1_02](T_1_02_Evolutionary_Psychology_Adapted_Mind.md) | Evolutionary Psychology | Attachment as evolved behavioral system; EEA as developmental context |
| [ZC_1_03](../T2_Clinical_Health/T_2_02_Neurodiversity.md) | Cross-Cultural Psychology | Cultural variation in developmental trajectories and child-rearing norms |
| [K_2_01](../../K_Consciousness/K2_Neuroscience_Brain/K_2_01_Split_Brain_Divided_Consciousness.md) | Split-Brain Research | Hemispheric specialization as neurodevelopmental process |
| [T_2_02](../T2_Clinical_Health/T_2_02_Neurodiversity.md) | Neurodiversity | Developmental variation as diversity rather than deficit |
| [R_2_09](../../R_Biology_Evolution/R2_Human_Primate_Evolution/R_2_09_Self_Domestication.md) | Self-Domestication | Extended juvenile period as feature of human self-domestication |
