...
> **Cross-References:** [R_1_01](../../R_Biology_Evolution/R1_Origin_Early_Life/R_1_01_Abiogenesis_Origin_of_Life.md) · [R_3_04](../../R_Biology_Evolution/R3_Mechanisms_Genetics/R_3_04_Sexual_Selection.md) · [R_3_06](../../R_Biology_Evolution/R3_Mechanisms_Genetics/R_3_06_Altruism_Cooperation.md) · [G_4_07](../../G_Modern_Frameworks/G4_Interdisciplinary_Meta_Methods/G_4_07_Memetics_Cultural_Evolution.md) · [L_2_01](../../L_Genetics_Origins/L2_Population_Regional_Genetics/L_2_01_Domestication_Genetics.md)
...
- **Mismatch quantification:** While the mismatch hypothesis is conceptually powerful, empirical research has yet to develop reliable metrics for quantifying the degree of mismatch between ancestral and modern environments for specific psychological mechanisms. Which mismatches cause the most harm, and how can they be prioritized for intervention?

- **Cultural evolution integration:** Gene-culture coevolution models (Boyd & Richerson, 2005) remain insufficiently integrated with mainstream EP. How do culturally transmitted norms, technologies, and institutions modify selection pressures on psychological mechanisms within historical timescales?

- **Female-centered EP:** Early EP disproportionately focused on male mating strategies. Recent work addresses female intrasexual competition, mate choice complexity, and maternal investment strategies, but significant gaps remain in understanding evolved female psychology on its own terms rather than as complement to male strategies.

- **Non-WEIRD replication:** Cross-cultural testing of EP predictions in small-scale societies, pastoralist communities, and non-Western urban populations remains sparse. Do proposed universal mechanisms genuinely transcend cultural context, or do some reflect WEIRD-specific environmental inputs?

- **Developmental plasticity:** How do sensitive periods in development (cf. T_1_04) calibrate evolved psychological mechanisms to local environmental conditions? The interaction between species-typical architecture and developmental experience represents a frontier for EP theory.

- **Ancestral environment reconstruction:** Our knowledge of EEA conditions is limited and heterogeneous. How confident can we be about the selection pressures that shaped specific psychological adaptations when the ancestral environment varied across geography, climate, and social organization?
...
- **Reverse engineering approach:** EP reasons backward from observed behavior to hypothesized adaptive functions. While powerful, this method risks generating unfalsifiable "just-so stories" unless studies include competing predictions and pre-registered designs.

- **Cross-cultural surveys:** Large-scale cross-cultural studies (Buss, 1989; Buss et al., 2020) provide evidence for universal preferences, but survey methodology introduces response biases, translation artifacts, and demand characteristics across culturally diverse samples.

- **Experimental economics and game theory:** Tasks like the Wason selection task, ultimatum game, and dictator game operationalize theoretical predictions about social exchange modules, but the artificial context may not capture the complexity of real-world social decision-making.

- **Twin and adoption studies:** Behavioral genetics provides heritability estimates for psychological traits (Bouchard & McGue, 2003), but heritability reflects population-level variance partitioning, not individual-level genetic causation.

- **Phylogenetic comparison:** Comparing human psychology with that of great apes and other primates provides evidence about shared ancestral mechanisms, but homology must be carefully distinguished from analogy, and primate behavior itself is culturally variable.

---

## KEY TERMS GLOSSARY

- **Environment of Evolutionary Adaptedness (EEA):** The ancestral conditions under which human psychological mechanisms were shaped by natural selection, typically referring to Pleistocene-era conditions.

- **Mismatch hypothesis:** The proposal that many modern psychological problems arise from discrepancies between evolved adaptations designed for ancestral environments and the demands of contemporary life.

- **Modularity:** The theory that the mind consists of functionally specialized processing systems (modules), each evolved to solve specific adaptive problems rather than operating as a general-purpose computer.

- **Inclusive fitness:** An organism's total genetic contribution to future generations, including effects on relatives' reproduction weighted by degree of genetic relatedness (Hamilton, 1964).

- **Parental investment:** Any expenditure of resources by a parent that increases offspring survival at the cost of the parent's ability to invest in other offspring (Trivers, 1972).

- **Spandrel:** A biological feature that arose as a byproduct of selection for some other trait rather than through direct adaptive selection (Gould & Lewontin, 1979).

- **Prepared learning:** The evolved predisposition to learn certain associations more readily than others (e.g., fear of snakes vs. fear of flowers).

- **Reciprocal altruism:** Cooperative behavior between non-relatives in which the cost of helping is repaid by future reciprocated help (Trivers, 1971).
...
1. Atran, S. (2002). *In Gods We Trust*. Oxford: Oxford University Press. ISBN: 9780385021746. DOI: 10.1086/420914
2. Axelrod, R. (1984). *The Evolution of Cooperation*. New York: Basic Books. ISBN: 9780465021222
3. Bouchard, T.J., & McGue, M. (2003). "Genetic and Environmental Influences on Human Psychological Differences." *Journal of Neurobiology*, 54(1), 4-45. DOI: 10.1002/neu.10160
...
6. Burnstein, E., Crandall, C., & Kitayama, S. (1994). "Neo-Darwinian Decision Rules for Altruism." *JPSP*, 67(5), 773-789. DOI: 10.1037//0022-3514.67.5.773
7. Buss, D.M. (1989). "Sex Differences in Human Mate Preferences." *BBS*, 12(1), 1-49. DOI: 10.1007/978-3-319-16999-6_88-1
8. Buss, D.M., et al. (1992). "Sex Differences in Jealousy." *Psychological Science*, 3(4), 251-255. DOI: 10.1111/j.1467-9280.1992.tb00038.x.
9. Buss, D.M., et al. (2020). "Human Mate Preferences in 45 Countries." *EHB*, 41(6), 446-458.
10. Cosmides, L. (1989). "The Logic of Social Exchange." *Cognition*, 31, 187-276.
11. Daly, M., & Wilson, M. (1988). *Homicide*. New York: Aldine de Gruyter.
12. Darwin, C. (1871). *The Descent of Man*. London: John Murray.
13. DeSteno, D., & Salovey, P. (1996). "Evolutionary Origins of Sex Differences in Jealousy?" *Psychological Science*, 7(6), 367-372.
14. Gluckman, P., & Hanson, M. (2006). *Mismatch*. Oxford: Oxford University Press.
15. Gould, S.J., & Lewontin, R.C. (1979). "The Spandrels of San Marco." *Proceedings of the Royal Society B*, 205(1161), 581-598.
16. Hamilton, W.D. (1964). "The Genetical Evolution of Social Behaviour." *JTB*, 7(1), 1-52.
17. Öhman, A., & Mineka, S. (2001). "Fears, Phobias, and Preparedness." *Psychological Review*, 108(3), 483-522.
18. Sperber, D., & Girotto, V. (2002). "Use or Misuse of the Selection Task?" *Cognition*, 85, 277-290. ISBN: 0176440658
19. Tooby, J., & Cosmides, L. (1992). "Psychological Foundations of Culture." In *The Adapted Mind*. Oxford: Oxford University Press.
20. Trivers, R.L. (1971). "The Evolution of Reciprocal Altruism." *QRB*, 46(1), 35-57.
21. Trivers, R.L. (1972). "Parental Investment and Sexual Selection." In *Sexual Selection and the Descent of Man*. Chicago: Aldine. ISBN: 9781351491112
...
|----------|-------|--------------|
| [R_1_01](../../R_Biology_Evolution/R1_Origin_Early_Life/R_1_01_Abiogenesis_Origin_of_Life.md) | Darwin & Evolution | Foundational theory underpinning all evolutionary psychology |
| [R_3_04](../../R_Biology_Evolution/R3_Mechanisms_Genetics/R_3_04_Sexual_Selection.md) | Sexual Selection | Mate choice and intrasexual competition as primary EP domain |
| [R_3_06](../../R_Biology_Evolution/R3_Mechanisms_Genetics/R_3_06_Altruism_Cooperation.md) | Altruism & Cooperation | Kin selection and reciprocal altruism as evolved strategies |
| [G_4_07](../../G_Modern_Frameworks/G4_Interdisciplinary_Meta_Methods/G_4_07_Memetics_Cultural_Evolution.md) | Memetics | Cultural evolution as complement to genetic evolution |
| [L_2_01](../../L_Genetics_Origins/L2_Population_Regional_Genetics/L_2_01_Domestication_Genetics.md) | Domestication | Self-domestication hypothesis parallels mismatch framework |
