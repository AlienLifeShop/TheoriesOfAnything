# S16 — Interstellar Communication — SETI, Breakthrough Listen, and the Search for Intelligence
...
- **Practical significance:** Largely symbolic — M13 will have moved from the targeted position by the time the signal arrives in ~25,000 years. The message was designed by Frank Drake with contributions from Carl Sagan.
...
The Fermi Paradox — Enrico Fermi's 1950 question "Where is everybody?" — remains the central unsolved problem in SETI. Proposed resolutions include: (→ [Q04](../Q_Cosmology_Physics/Q04_Fermi_Paradox_Drake_Equation.md))
