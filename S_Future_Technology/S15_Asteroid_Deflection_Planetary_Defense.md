# S15 — Asteroid Deflection and Planetary Defense
...
- **Dating:** Precisely dated to 66.043 ± 0.011 Ma using 40Ar/39Ar geochronology of impact tektites (Renne et al., *Science*, 2013). (→ [E20](../E_Cataclysms_and_Chronology/E20_Chicxulub_Impact_KPg_Boundary.md))
...
- **Counterfactual:** Had the airburst occurred over a populated urban area, casualties would have numbered in the hundreds of thousands. The event occurred in a sparsely populated region with only 2-3 known human casualties. (→ [E24](../E_Cataclysms_and_Chronology/E24_Tunguska_Event_Modern_Impact.md))
...
- **Dual-use concern:** The same nuclear devices useful for asteroid deflection are powerful weapons — creating treaty and proliferation tensions with the Outer Space Treaty (1967), which prohibits nuclear weapons in space. (→ [S13](../S_Future_Technology/S13_Nuclear_War_Civilizational_Risk.md))
...
|-------------|-----------|
| [E20 — Chicxulub Impact](../E_Cataclysms_and_Chronology/E20_Chicxulub_Impact_KPg_Boundary.md) | Detailed analysis of the K-Pg mass extinction asteroid impact |
| [E24 — Tunguska Event](../E_Cataclysms_and_Chronology/E24_Tunguska_Event_Modern_Impact.md) | 1908 airburst as modern case study of undetected near-Earth object |
| [E12 — Cyclical Destruction](../E_Cataclysms_and_Chronology/E12_Cyclical_Destruction_Renewal.md) | Ancient traditions of celestial fire and cyclical catastrophe |
| [E01 — Younger Dryas Impact](../E_Cataclysms_and_Chronology/E01_Younger_Dryas_Impact.md) | Controversial cometary impact hypothesis at 12,800 BP |
