# S25 — Food Security, Agricultural Technology, and the Future of Feeding Humanity
...
- **Connection to S18:** Synthetic biology platforms (BioBricks, CRISPR, metabolic engineering) underpin the scientific infrastructure for next-generation food ingredient production (→ [S18](S18_Synthetic_Biology.md)).
