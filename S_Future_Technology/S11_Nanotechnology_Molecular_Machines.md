# S11 — Nanotechnology, Molecular Machines, and Material Frontiers
...
- Smaller dots → blue/UV emission; larger dots → red emission
- Applications: QLED displays, medical imaging, solar cells, single-photon sources for quantum computing
- **2023 Nobel Prize in Chemistry** awarded for quantum dot discovery and synthesis

### 2.3 Metamaterials

Engineered nanostructured materials with properties not found in nature:
- **Negative refractive index** → potential "invisibility cloaking"
- **Acoustic metamaterials** → sound cloaking, seismic protection
- **Mechanical metamaterials** → auxetic materials (expand when stretched); ultra-lightweight + ultra-strong lattices
- **Photonic crystals** → control of light propagation at specific wavelengths
...
- **Jean-Pierre Sauvage** — created mechanically interlocked molecules (catenanes, rotaxanes) that can move relative to each other
- **Sir J. Fraser Stoddart** — designed molecular shuttles, elevators, and muscles from rotaxane/catenane architectures
- **Bernard L. Feringa** — built the first **unidirectional molecular motor** (1999); molecular "car" that moves across surfaces
...
- **DNA origami** (Rothemund, 2006) — long DNA scaffold folded by ~200 short "staple" strands into arbitrary 2D/3D shapes
- DNA-based **nanorobots** — drug delivery vehicles that open in response to specific molecular signals (Ido Bachelet, 2012)
- **DNA computers** — logic gates, walkers, and computational structures made from DNA
