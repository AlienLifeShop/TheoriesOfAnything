# S10 — Climate Change, Civilization, and Deep-Time Context
...
## DOCUMENT NAVIGATION
- [§1 Deep-Time Climate Context](#1-deep-time-climate-context)
- [§2 Historical Climate and Civilization](#2-historical-climate-and-civilization)
- [§3 The Current Crisis — Data and Projections](#3-the-current-crisis)
- [§4 Tipping Points and Cascading Failure](#4-tipping-points)
- [§5 Responses — Mitigation, Adaptation, Geoengineering](#5-responses)
...
- **Cold/drought periods** correlate with **civilizational contraction** (Bronze Age Collapse, 536 CE, Little Ice Age)
- BUT: **rapid warming** (PETM, current) drives **disruption** different from gradual warmth
- The **speed** of change matters more than the absolute temperature
- Complex civilizations are **more vulnerable** to climate disruption than simpler ones (interdependency → cascading failure)
...
- Permafrost thaw → methane/CO₂ release → more warming → more thaw
- Amazon dieback → reduced rainfall → more dieback + fire → carbon release
- Lenton et al. (2019): "We argue the intervention time left is **shorter than** the time it will take to act"
