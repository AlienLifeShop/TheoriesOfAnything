# ZB30 — Biological Scaling and Allometry
...
> **Cross-References:** R18 — Body Plans · [ZB30 — Biological Scaling](R68_Biological_Scaling_Allometry.md) · R10 — Convergent Evolution · ZA17 — Scale Invariance · V05 — Fractals
...
3. Brown, J. H., et al. (2004). "Toward a metabolic theory of ecology." *Ecology*, 85(7), 1771–1789.
4. Huxley, J. S. (1932). *Problems of Relative Growth*. London: Methuen.
5. Dodds, P. S., Rothman, D. H., & Weitz, J. S. (2001). "Re-examination of the '3/4-law' of metabolism." *Journal of Theoretical Biology*, 209(1), 9–27.
...
- **R18 — Body Plans:** Morphological diversity constrained by scaling relationships
- **R10 — Convergent Evolution:** Convergent scaling patterns across independent lineages
- **ZA17 — Scale Invariance:** Power-law scaling across physical and biological systems
- **V05 — Fractals:** Fractal geometry underlying vascular network models
- **[ZB31 — Death Biology](R69_Death_Biology_Programmed_Cell_Death.md):** Lifespan scaling with body size
- **R18 — Body Plans:** Physical constraints shaping animal design
