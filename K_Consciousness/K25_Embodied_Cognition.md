...
> **Cross-References:** [K22 — Predictive Processing](K22_Predictive_Processing_Consciousness.md) · [K15 — Phantom Limb](K15_Phantom_Limb_Body_Schema.md) · [K04 — Free Energy Principle](K04_Free_Energy_Principle.md) · [K24 — Hard Problem](K24_Hard_Problem_Consciousness.md) · [Y06 — Meditation Neuroplasticity](K08_Meditation_Neuroplasticity.md)
...
1. Varela, F. J., Thompson, E., and Rosch, E. *The Embodied Mind: Cognitive Science and Human Experience*. MIT Press, 1991.
2. Clark, A. and Chalmers, D. J. "The Extended Mind." *Analysis*, vol. 58, 1998, pp. 7–19.
3. Lakoff, G. and Johnson, M. *Philosophy in the Flesh: The Embodied Mind and Its Challenge to Western Thought*. Basic Books, 1999.
4. O'Regan, J. K. and Noë, A. "A Sensorimotor Account of Vision and Visual Consciousness." *Behavioral and Brain Sciences*, vol. 24, 2001, pp. 939–973.
5. Gibson, J. J. *The Ecological Approach to Visual Perception*. Houghton Mifflin, 1979.
6. Hauk, O., Johnsrude, I., and Pulvermüller, F. "Somatotopic Representation of Action Words in Human Motor and Premotor Cortex." *Neuron*, vol. 41, 2004, pp. 301–307.
7. Thompson, E. *Mind in Life: Biology, Phenomenology, and the Sciences of Mind*. Harvard University Press, 2007.
8. Noë, A. *Action in Perception*. MIT Press, 2004.
9. Glenberg, A. M. and Kaschak, M. P. "Grounding Language in Action." *Psychonomic Bulletin & Review*, vol. 9, 2002, pp. 558–565.
10. Clark, A. *Supersizing the Mind: Embodiment, Action, and Cognitive Extension*. Oxford University Press, 2008.
...
|-------------|-----------|
| [K22 — Predictive Processing](K22_Predictive_Processing_Consciousness.md) | Active inference integrates prediction with embodied action; perception as prediction is compatible with enactivism |
| [K15 — Phantom Limb](K15_Phantom_Limb_Body_Schema.md) | Phantom limbs demonstrate the body schema's role in perception and how body representation shapes conscious experience |
| [K04 — Free Energy Principle](K04_Free_Energy_Principle.md) | Free energy minimization occurs through action (changing the world) and perception (changing the model) — inherently embodied |
| [K24 — Hard Problem](K24_Hard_Problem_Consciousness.md) | Enactivism offers an alternative perspective on the hard problem: consciousness as a process of brain-body-environment interaction |
| [Y06 — Meditation Neuroplasticity](K08_Meditation_Neuroplasticity.md) | Contemplative practices involve embodied attention training with measurable neuroplastic changes |
