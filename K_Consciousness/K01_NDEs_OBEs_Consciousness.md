...
Modern consciousness research — NDEs in cardiac arrest patients, children's past-life memories, and DMT-induced entity encounters — produces data that intersects remarkably with ancient descriptions of death journeys, ascent narratives, and non-human entities. The AWARE study (largest prospective NDE study) confirmed consciousness during clinical death in some patients. DMT entity encounters show >50% reporting entity contact, with 35% describing insectoid/reptilian beings — matching traditions cataloged in B01. Ancient parallels (Plato's Er, Egyptian Amduat, Tibetan Bardo, Enoch's ascent) describe functionally identical journey structures.
...
- **Results:**
  - 39% of survivors reported awareness during clinical death (cardiac arrest)
  - 9% had experiences consistent with traditional NDE features
  - ONE patient had verified visual perception: accurately described events in the room while clinically dead (flat EEG, no heartbeat) for 3+ minutes
  - Hidden targets placed on shelves (to test OBE veridical perception) were NOT seen — but placement protocol had limitations
...
- **Methodology:** Children (average age 2–5) make specific, verifiable claims about a previous life, then investigation attempts to identify the person they describe
- **Landmark cases:**
  - **James Leininger:** Age 2, described being a WW2 fighter pilot shot down over Iwo Jima. Named aircraft carrier (Natoma Bay), squadron (VC-81), and friend (Jack Larsen); ALL verified. Described details before exposure to WW2 material.
  - **Ryan Hammons:** Age 4, described Hollywood life; identified obscure extra in Marty Martyn's life; 55 verifiable statements, 92% accuracy
...
- **Davis et al. (2020):** Largest survey of DMT entity encounters:
  - >50% of participants reported encounters with seemingly autonomous entities
  - 35% described entities as **insectoid or reptilian** in appearance
  - Entities frequently perceived as: intelligent, benevolent, communicative
  - 75%+ rated experience as "more real than everyday reality"
  - Many reported ontological shock — lasting change in worldview
- **Strassman (clinical):** IV DMT administration in controlled hospital setting; entity contact reported consistently
- **Assessment:** The EXPERIENCES are Tier 1 (documented in controlled studies). The ONTOLOGY of the entities (real beings vs. brain-generated) is Tier 3.
...
- NDE features appear consistently across cultures, religions, and ages:
  - Leaving the body / floating above
  - Tunnel or passage through darkness
  - Encounter with light / luminous being
  - Life review (panoramic, non-judgmental)
  - Boundary or point of no return
  - Return to body (often reluctant)
- NDEs in BLIND individuals (including congenitally blind) include detailed visual perception
- Children's NDEs show same pattern with LESS cultural contamination
- **Ancient parallels:**
  - **Plato, Republic X** — Myth of Er: soldier dies, travels through afterlife, returns with knowledge
  - **Egyptian Amduat** — 12-hour journey through underworld; weighing of heart
  - **Tibetan Bardo Thodol** — Detailed passage through between-life states
...
- **Results:**
  - 62 patients (18%) reported some recollection during cardiac arrest
  - 41 patients (12%) reported a core NDE experience
  - NDE depth ranged from simple awareness to full deep experience (tunnel, light, life review, deceased relatives, return decision)
  - NDEs were NOT correlated with: duration of cardiac arrest, medications administered, psychological factors, or religious belief
  - NDEs WERE correlated with: age <60 (younger patients had more NDEs), having had prior NDEs, and survival beyond 30 days
  - Follow-up at 2 and 8 years: NDE patients showed lasting transformative effects — decreased fear of death, increased empathy, increased spiritual interest
- **Significance:** This was the FIRST large-scale prospective study published in a top-tier medical journal, predating AWARE (2014) by 13 years. It demonstrated that NDEs occur during a period when the brain should be incapable of generating coherent conscious experience (flat EEG, no cerebral blood flow).
...
- **Four components (4 questions each):**
  1. **Cognitive:** Time distortion, thought acceleration, life review, sudden understanding
  2. **Affective:** Peace, joy, cosmic unity, encounter with light
  3. **Paranormal:** Vivid sensory experiences, extrasensory perception, precognitive visions, out-of-body experience
  4. **Transcendental:** Encounter with otherworldly realm, mystical beings, deceased spirits, border/point of no return
- **Scoring:** Each item scored 0–2; total range 0–32; threshold score of ≥7 classifies as NDE
- **Reliability:** Test-retest reliability over 20-year interval: r = 0.92 (exceptionally stable)
...
- Activity concentrated in temporoparietal junction (associated with OBE)
...
- 35% insectoid/reptilian entity descriptions in DMT encounters map to:
  ...
  - C05 (Credo Mutwa): Chitauri described in Zulu tradition
  - C11 (Nagas): Indian serpent beings with humanoid characteristics
  - C06 (SE Asian Naga): Serpent entities in Southeast Asian traditions
...
- If consciousness survives death (NDE data suggests possibility):
  ...
  - "Gods" communicating with humans (A-series documents) could involve discarnate consciousness
  - Hermetic principle "Mind is all" (A08) would be literal, not metaphorical
- **Status:** Philosophically profound but currently unfalsifiable at the individual level
...
|---|------------|---------|----------|------|
| 1 | Bosch, *Ascent of the Blessed* — NDE tunnel parallel | Public Domain | T1_K01_consciousness_001_bosch_ascent_blessed.jpg | 1 |
| 2 | Egyptian Amduat — underworld journey | Public Domain | T1_K01_consciousness_002_amduat_underworld_journey.jpg | 1 |
| 3 | Brain scan during NDE research | Fair Use | T1_K01_consciousness_003_brain_scan_nde_research.jpg | 1 |
| 4 | Ayahuasca ceremony (contains DMT-analog) | CC-BY-SA | T2_K01_consciousness_004_ayahuasca_ceremony.jpg | 2 |
| 5 | Out-of-body experience | Public Domain / CC | T1_K01_out_of_body_experience.jpg | 1 |
...
- [ ] Cross-cultural NDE: systematic survey of non-Western and indigenous traditions
- [ ] Controlled DMT entity encounter studies with pre-registered hypotheses about entity types
- [ ] Veridical OBE: replication of verified visual perception during cardiac arrest
...
3. Davis, Alan K. et al. "Survey of Entity Encounter Experiences Occasioned by Inhaled N,N-DMT." *J Psychopharmacology* 34(9), 2020.
4. Greyson, Bruce. *After*. St. Martin's, 2021.
5. Borjigin, Jimo et al. "Surge of Neurophysiological Coherence and Connectivity in the Dying Brain." *PNAS* 120(10), 2023.
6. Strassman, Rick. *DMT: The Spirit Molecule*. Park Street Press, 2001.
7. van Lommel, Pim et al. "Near-Death Experience in Survivors of Cardiac Arrest." *The Lancet* 358(9298), 2001.
8. Greyson, Bruce. "The Near-Death Experience Scale." *J Nervous and Mental Disease* 171(6), 1983.
