...
### 1.1 Scientific Verification of Lucid Dreaming [5/5 sources]
...
### 1.2 Two-Way Communication with Dreamers (Konkoly et al. 2021) [4/5 sources]
...
### 1.3 The Neuroscience of Lucid Dreaming [4/5 sources]
...
- **Voss et al. (2014, *Nature Neuroscience*):** applied 40 Hz transcranial alternating current stimulation (tACS) to frontal cortex of sleeping subjects → INDUCED lucid dreaming in ~77% of stimulations. This is the first demonstration that lucid dreaming can be triggered by external brain stimulation.
- **Baird et al. (2019, *Neuroscience of Consciousness*):** lucid dreaming ability correlates with larger prefrontal cortex volume and higher trait metacognition — the same qualities enhanced by meditation (see K08)

---

## 2. CREDIBLE CLAIMS (Tier 2 — Supported but Discussed)

### 2.1 Induction Techniques [3/5 sources]
...
### 2.2 Ancient and Traditional Dream Practices [3/5 sources]
...
### 2.3 Potential Applications [3/5 sources]
- **Therapeutic:**
...
### 3.1 Shared Dreaming [2/5 sources]
...
### 3.2 Dream Consciousness as Model for Death/Afterlife States [2/5 sources]
...
- See [P07 — Death & Afterlife](../P_Philosophy_Meaning/P07_Death_Afterlife_Across_Cultures.md)

---

## 4. DUBIOUS CLAIMS (Tier 4 — Unsupported)

### 4.1 "Lucid Dreaming Gives Access to Parallel Realities" [2/5 sources]
...
|---|-------------|----------|--------|---------|
| 1 | Eye-signal polysomnogram trace | K09_eye_signal_001.jpg | Adapted from LaBerge 1981 | Fair Use |
| 2 | Lucid vs non-lucid brain EEG comparison | K09_lucid_eeg_002.jpg | Adapted from Voss et al. 2009 | Fair Use |
| 3 | Two-way communication protocol diagram | K09_konkoly_protocol_003.jpg | Adapted from Konkoly et al. 2021 | Fair Use |
| 4 | Tibetan dream yoga thangka | K09_dream_yoga_004.jpg | Wikimedia Commons | Public Domain |

---

## BIBLIOGRAPHY

1. LaBerge, Stephen. "Lucid dreaming as a learnable skill." *Perceptual and Motor Skills* 51 (1980): 1039–1042.
2. Konkoly, K.R. et al. "Real-time dialogue between experimenters and dreamers during REM sleep." *Current Biology* 31 (2021): 1417–1427.
3. Voss, U. et al. "Lucid dreaming: a state of consciousness with features of both waking and non-lucid dreaming." *Sleep* 32 (2009): 1191–1200.
4. Voss, U. et al. "Induction of self awareness in dreams through frontal low current stimulation of gamma activity." *Nature Neuroscience* 17 (2014): 810–812.
5. Aspy, D.J. et al. "Reality testing and the mnemonic induction of lucid dreams." *Dreaming* 27 (2017): 206–231.
...
8. Norbu, Namkhai. *Dream Yoga and the Practice of Natural Light*. Snow Lion, 1992.
...
| [C13 — Indigenous Knowledge](../C_Global_Traditions/C13_Indigenous_Knowledge_Systems.md) | Aboriginal Dreamtime traditions |
