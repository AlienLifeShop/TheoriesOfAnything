# Q28 — Vacuum Energy and the Cosmological Constant Problem
...
> **Cross-References:** [Q07 — Dark Matter Dark Energy](Q07_Dark_Matter_Dark_Energy.md) · [ZA03 — Zero-Point Energy](Q11_Zero_Point_Energy.md) · [ZA10 — Quantum Field Theory](Q26_Quantum_Field_Theory_Foundations.md) · [Q13 — Cosmic Inflation](Q13_Cosmic_Inflation_First_Second.md) · [Q11 — Fate of Universe](Q11_Fate_of_Universe.md)
...
4. Martin, J. (2012). "Everything you always wanted to know about the cosmological constant problem (but were afraid to ask)." *Comptes Rendus Physique*, 13(6-7), 566–665.
...
7. Weinberg, S. (1987). "Anthropic bound on the cosmological constant." *Physical Review Letters*, 59(22), 2607–2610.
8. Carroll, S. M. (2001). "The cosmological constant." *Living Reviews in Relativity*, 4(1), 1.
9. Lamoreaux, S. K. (1997). "Demonstration of the Casimir force in the 0.6 to 6 μm range." *Physical Review Letters*, 78(1), 5–8.
10. DESI Collaboration (2024). "DESI 2024 VI: Cosmological constraints from baryon acoustic oscillations." *arXiv:2404.03002*.

---

## CROSS-REFERENCE INDEX

- **[Q07 — Dark Matter Dark Energy](Q07_Dark_Matter_Dark_Energy.md):** Dark energy as observed manifestation of vacuum energy / cosmological constant
- **[ZA03 — Zero-Point Energy](Q11_Zero_Point_Energy.md):** Vacuum zero-point energy as physical origin of Λ problem
- **[ZA10 — Quantum Field Theory](Q26_Quantum_Field_Theory_Foundations.md):** QFT vacuum state contains infinite zero-point energy requiring regularization
- **[Q13 — Cosmic Inflation](Q13_Cosmic_Inflation_First_Second.md):** Inflation driven by vacuum-like energy of inflaton field
- **[Q11 — Fate of Universe](Q11_Fate_of_Universe.md):** Positive Λ drives eternal exponential expansion (de Sitter future)
- **[Q05 — Multiverse](Q05_Multiverse_Theories.md):** String landscape + eternal inflation invoked as anthropic explanation of Λ
