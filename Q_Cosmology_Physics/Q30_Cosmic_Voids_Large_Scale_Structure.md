# Q30 — Cosmic Voids and Large-Scale Structure
...
> **Cross-References:** [Q10 — Observable Universe Cosmic Web](Q10_Observable_Universe_Cosmic_Web.md) · [Q07 — Dark Matter Dark Energy](Q07_Dark_Matter_Dark_Energy.md) · [Q18 — Galaxy Formation](Q18_Galaxy_Formation_Structure.md) · [Q13 — Cosmic Inflation](Q13_Cosmic_Inflation_First_Second.md) · [Q28 — Vacuum Energy](Q28_Vacuum_Energy_Cosmological_Constant.md)
...
1. de Lapparent, V., Geller, M. J., & Huchra, J. P. (1986). "A slice of the universe." *The Astrophysical Journal*, 302, L1–L5.
2. Sheth, R. K., & van de Weygaert, R. (2004). "A hierarchy of voids: much ado about nothing." *Monthly Notices of the Royal Astronomical Society*, 350(2), 517–538.
3. Hamaus, N., Sutter, P. M., & Wandelt, B. D. (2014). "Universal density profile for cosmic voids." *Physical Review Letters*, 112(25), 251302.
4. Szapudi, I., et al. (2015). "Detection of a supervoid aligned with the cold spot of the cosmic microwave background." *Monthly Notices of the Royal Astronomical Society*, 450(1), 288–294.
5. Sutter, P. M., et al. (2012). "A public void catalog from the SDSS DR7 galaxy redshift surveys." *The Astrophysical Journal*, 761(2), 187.
6. Kirshner, R. P., Oemler Jr., A., Schechter, P. L., & Shectman, S. A. (1981). "A million cubic megaparsec void in Boötes." *The Astrophysical Journal*, 248, Z33–Z35.
7. Springel, V., et al. (2005). "Simulations of the formation, evolution and clustering of galaxies and quasars." *Nature*, 435, 629–636.
8. Lavaux, G., & Wandelt, B. D. (2012). "Precision cosmography with stacked voids." *The Astrophysical Journal*, 754(2), 109.
9. Pisani, A., et al. (2019). "Counting voids to probe dark energy." *Bulletin of the American Astronomical Society*, 51(3), 40.
10. Tully, R. B., Courtois, H., Hoffman, Y., & Pomarède, D. (2014). "The Laniakea supercluster of galaxies." *Nature*, 513, 71–73.

---

## CROSS-REFERENCE INDEX

- **[Q10 — Observable Universe Cosmic Web](Q10_Observable_Universe_Cosmic_Web.md):** Voids as fundamental building blocks of the cosmic web
- **[Q07 — Dark Matter Dark Energy](Q07_Dark_Matter_Dark_Energy.md):** Void statistics constrain dark energy equation of state
- **[Q18 — Galaxy Formation](Q18_Galaxy_Formation_Structure.md):** Void galaxies evolve differently from cluster galaxies
- **[Q13 — Cosmic Inflation](Q13_Cosmic_Inflation_First_Second.md):** Voids grow from primordial underdensities seeded during inflation
- **[Q09 — CMB Anomalies](Q09_CMB_Anomalies.md):** Cold Spot anomaly potentially linked to foreground supervoid
- **[Q28 — Vacuum Energy](Q28_Vacuum_Energy_Cosmological_Constant.md):** Void expansion sensitive to dark energy driving accelerated expansion
