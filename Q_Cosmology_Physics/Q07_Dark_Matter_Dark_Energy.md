...
|---|-------------|----------|--------|---------|
| 1 | Galaxy rotation curve showing dark matter need | Q07_galaxy_rotation_curve_001.png | Wikimedia Commons | CC BY-SA 4.0 |
| 2 | Bullet Cluster gravitational lensing map | Q07_bullet_cluster_002.jpg | NASA/CXC | PD (NASA) |
| 3 | CMB power spectrum Planck 2018 | Q07_cmb_power_spectrum_003.png | ESA/Planck | CC BY-SA 3.0 IGO |
| 4 | Cosmic composition pie chart (5/27/68%) | Q07_cosmic_composition_004.png | Wikimedia Commons | CC BY-SA 4.0 |
| 5 | Type Ia supernovae Hubble diagram | Q07_supernova_hubble_diagram_005.png | Wikimedia Commons | CC BY-SA 4.0 |
| 6 | Dark matter candidate mass range | Q07_dm_candidate_masses_006.png | Wikimedia Commons | CC BY-SA 4.0 |
| 7 | Cosmic web simulation (IllustrisTNG) | Q07_cosmic_web_simulation_007.jpg | IllustrisTNG / CC BY 4.0 | CC BY 4.0 |
...
|-------------|-----------|
| [Q02 — Big Bang](Q02_Big_Bang_Alternative_Cosmologies.md) | Dark energy discovery changed our understanding of cosmic fate |
| [Q01 — Anthropic Principle](Q01_Anthropic_Principle_Fine_Tuning.md) | Weinberg's anthropic prediction of cosmological constant value |
| [Q05 — Multiverse](Q05_Multiverse_Theories.md) | Multiverse is leading explanation for cosmological constant fine-tuning |
| [Q06 — Holographic Principle](Q06_Holographic_Principle.md) | Verlinde's emergent gravity derives from holographic principle |
| [D05 — Megalithic](../D_Sites_and_Artifacts/D05_Megalithic_Impossible_Engineering.md) | Speculative theories about anti-gravity sometimes invoke dark energy (unfounded) |
| [G01 — Quantum Mechanics](../G_Modern_Frameworks/G01_Quantum_Mechanics_Ancient_Knowledge.md) | Vacuum energy and quantum fluctuations underlie dark energy problem |
