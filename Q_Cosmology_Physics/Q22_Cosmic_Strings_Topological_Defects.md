# Q22 — Cosmic Strings and Topological Defects
...
> **Cross-References:** [ZA20 — Grand Unified Theories](Q40_Grand_Unified_Theories.md) · [Q13 — Cosmic Inflation](Q13_Cosmic_Inflation_First_Second.md) · [ZA02 — String Theory](Q09_String_Theory_Extra_Dimensions.md) · [Q09 — CMB Anomalies](Q09_CMB_Anomalies.md) · [Q18 — Galaxy Formation](Q18_Galaxy_Formation_Structure.md)
...
- **Kibble mechanism (1976):** During a cosmological phase transition, different regions of space "choose" different vacuum states — defects form at boundaries
- **Laboratory analogue:** Confirmed in liquid crystals, superfluid helium (Zurek), and superconductors — defect density follows Kibble-Zurek scaling
...
- **Nambu-Goto approximation:** Idealized infinitely thin relativistic strings — adequate for cosmological modeling
...
- **NANOGrav (2023):** Reported a common-spectrum signal in pulsar timing arrays consistent with a stochastic gravitational wave background — cosmic strings are among the possible sources (alongside supermassive black hole binaries)
...
- **String theory prediction:** Fundamental strings (F-strings) and D-branes wrapped around compact dimensions (D-strings) can be stretched to cosmic scales during brane inflation
...
1. Kibble, T. W. B. "Topology of Cosmic Domains and Strings." *Journal of Physics A*, vol. 9, 1976, pp. 1387–1398.
2. Vilenkin, A. and Shellard, E. P. S. *Cosmic Strings and Other Topological Defects.* Cambridge University Press, 2000.
3. Hindmarsh, M. and Kibble, T. W. B. "Cosmic Strings." *Reports on Progress in Physics*, vol. 58, 1995, pp. 477–562.
4. Ade, P. A. R. et al. (Planck Collaboration). "Planck 2013 Results. XXV. Searches for Cosmic Strings and Other Topological Defects." *Astronomy & Astrophysics*, vol. 571, 2014, A25.
5. Agazie, G. et al. (NANOGrav Collaboration). "The NANOGrav 15 yr Data Set: Evidence for a Gravitational-Wave Background." *The Astrophysical Journal Letters*, vol. 951, 2023, L8.
6. Copeland, E. J., Myers, R. C., and Polchinski, J. "Cosmic F- and D-Strings." *Journal of High Energy Physics*, vol. 2004, no. 06, 2004, 013.
7. Auclair, P. et al. "Probing the Gravitational Wave Background from Cosmic Strings with LISA." *Journal of Cosmology and Astroparticle Physics*, vol. 2020, no. 04, 2020, 034.
8. Zurek, W. H. "Cosmological Experiments in Superfluid Helium?" *Nature*, vol. 317, 1985, pp. 505–508.
9. Blanco-Pillado, J. J. et al. "New Limits on Cosmic Strings from Gravitational Wave Observation." *Physics Letters B*, vol. 778, 2018, pp. 392–396.
10. Ringeval, C. et al. "Cosmological Evolution of Cosmic String Loops." *Journal of Cosmology and Astroparticle Physics*, vol. 2007, no. 02, 2007, 023.
...
|-------------|-----------|
| [ZA20 — Grand Unified Theories](Q40_Grand_Unified_Theories.md) | GUT phase transitions can produce cosmic strings and monopoles |
| [Q13 — Cosmic Inflation](Q13_Cosmic_Inflation_First_Second.md) | Strings can form at the end of inflation; inflation solves monopole problem |
| [ZA02 — String Theory](Q09_String_Theory_Extra_Dimensions.md) | Cosmic superstrings from string theory could be stretched to cosmic size |
| [Q09 — CMB Anomalies](Q09_CMB_Anomalies.md) | Cosmic strings would imprint characteristic patterns in the CMB |
| [Q18 — Galaxy Formation](Q18_Galaxy_Formation_Structure.md) | Strings were once proposed as seeds for galaxy formation |
