# Q34 — Cosmic Nucleosynthesis and Primordial Helium Abundance
...
> **Cross-References:** [Q20 — Nucleosynthesis Element Formation](Q20_Nucleosynthesis_Element_Formation.md) · [ZA15 — Neutrino Physics](Q35_Neutrino_Physics_Oscillations.md) · [Q02 — Big Bang](Q02_Big_Bang_Alternative_Cosmologies.md) · [Q32 — Stellar Populations](Q32_Stellar_Populations_Metallicity.md) · [Q13 — Cosmic Inflation](Q13_Cosmic_Inflation_First_Second.md)
...
1. Fields, B. D. (2011). "The primordial lithium problem." *Annual Review of Nuclear and Particle Science*, 61, 47–68.
2. Cooke, R. J., Pettini, M., & Steidel, C. C. (2018). "One percent determination of the primordial deuterium abundance." *The Astrophysical Journal*, 855(2), 102.
3. Pitrou, C., Coc, A., Uzan, J.-P., & Vangioni, E. (2018). "Precision Big Bang nucleosynthesis with improved helium-4 predictions." *Physics Reports*, 754, 1–66.
4. Wagoner, R. V., Fowler, W. A., & Hoyle, F. (1967). "On the synthesis of elements at very high temperatures." *The Astrophysical Journal*, 148, 3–49.
5. Aver, E., Olive, K. A., & Skillman, E. D. (2015). "The effects of He I λ10830 on helium abundance determinations." *Journal of Cosmology and Astroparticle Physics*, 2015(07), 011.
6. Spite, F., & Spite, M. (1982). "Abundance of lithium in unevolved halo stars and old disk stars: Interpretation and consequences." *Astronomy and Astrophysics*, 115, 357–366.
7. Coc, A., & Vangioni, E. (2017). "Primordial nucleosynthesis." *International Journal of Modern Physics E*, 26(08), 1741002.
8. Mossa, V., et al. (2020). "The baryon density of the universe from an improved rate of deuterium burning." *Nature*, 587, 210–213.
9. Planck Collaboration (2020). "Planck 2018 results. VI. Cosmological parameters." *Astronomy & Astrophysics*, 641, A6.
10. Alpher, R. A., Bethe, H., & Gamow, G. (1948). "The origin of chemical elements." *Physical Review*, 73(7), 803–804.

---

## CROSS-REFERENCE INDEX

- **[Q20 — Nucleosynthesis](Q20_Nucleosynthesis_Element_Formation.md):** BBN produces the lightest elements; stellar nucleosynthesis produces heavier ones
- **[ZA15 — Neutrino Physics](Q35_Neutrino_Physics_Oscillations.md):** Neutrino freeze-out and $N_{eff}$ directly constrained by BBN abundances
- **[Q02 — Big Bang](Q02_Big_Bang_Alternative_Cosmologies.md):** BBN is one of three pillars of Big Bang cosmology (with CMB and expansion)
- **[Q32 — Stellar Populations](Q32_Stellar_Populations_Metallicity.md):** Spite plateau in metal-poor halo stars preserves primordial Li (with depletion)
- **[ZA14 — Antimatter CP Violation](Q34_Antimatter_CP_Violation_Baryogenesis.md):** Baryon asymmetry $\eta \sim 10^{-9}$ set before BBN by baryogenesis
- **[Q13 — Cosmic Inflation](Q13_Cosmic_Inflation_First_Second.md):** Inflation sets the homogeneity that makes uniform BBN possible
