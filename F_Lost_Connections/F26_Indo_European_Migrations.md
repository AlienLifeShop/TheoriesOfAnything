# F26 — Indo-European Migrations: Yamnaya, Corded Ware, and the Steppe Hypothesis

> **Source Count:** 17 | **Weighted Score:** 44 | **Source Confidence:** [5/5] | **Last Updated:** March 8, 2026
...
> **Cross-References:** [F09 — Pre-Indo-European Substrates](F09_Pre_Indo_European_Substrates.md) · [L29](../L_Genetics_Origins/L29.md) · [A20](../A_Foundations/A20.md) · [C54](../C_Global_Traditions/C54.md) · [C55](../C_Global_Traditions/C55.md)
...
- **Counter-Argument:** Some scholars (e.g., Littauer and Crouwel) initially questioned whether Sintashta vehicles were true chariots or heavy carts; subsequent finds confirmed lightweight spoked-wheel construction.
...
- Genetic studies show Corded Ware populations derived ~75% ancestry from Yamnaya, representing a massive demographic shift — not just cultural diffusion.
...
| # | Description | Filename | Source | License |---|-------------|----------|--------|---------| 1 | Map of Yamnaya expansion routes into Europe and Asia | yamnaya_expansion_map.png | Anthony 2007 / adapted | Fair Use | 2 | Corded Ware pottery and battle axe examples | corded_ware_artifacts.png | National Museum of Denmark | CC BY-SA 4.0 | 3 | Sintashta chariot burial reconstruction | sintashta_chariot.png | Koryakova & Epimakhov 2007 | Fair Use | 4 | Ancient DNA admixture diagram showing Yamnaya component | yamnaya_admixture_chart.png | Haak et al. 2015 | Fair Use |
...
2. Anthony, David W. *The Horse, the Wheel, and Language: How Bronze-Age Riders from the Eurasian Steppes Shaped the Modern World*. Princeton University Press, 2007.
3. Benveniste, Émile. *Indo-European Language and Society*. University of Miami Press, 1973.
4. Evershed, R.P. et al. "Dairying, diseases and the evolution of lactase persistence in Europe." *Nature* 608, 336–340 (2022).
...
6. Koryakova, L. and Epimakhov, A. *The Urals and Western Siberia in the Bronze and Iron Ages*. Cambridge University Press, 2007.
7. Kristiansen, K. et al. "Re-theorising mobility and the formation of culture and language among the Corded Ware Culture in Europe." *Antiquity* 91(356), 334–347 (2017).
8. Mathieson, I. et al. "Genome-wide patterns of selection in 230 ancient Eurasians." *Nature* 528, 499–503 (2015).
9. Narasimhan, V.M. et al. "The formation of human populations in South and Central Asia." *Science* 365, eaat7487 (2019).
10. Olalde, I. et al. "The Beaker phenomenon and the genomic transformation of northwest Europe." *Nature* 555, 190–196 (2018).
11. Possehl, Gregory L. *The Indus Civilization: A Contemporary Perspective*. AltaMira Press, 2002.
12. Poznik, G.D. et al. "Punctuated bursts in human male demography inferred from 1,244 worldwide Y-chromosome sequences." *Nature Genetics* 48, 593–599 (2016).
13. Rascovan, N. et al. "Emergence and Spread of Basal Lineages of Yersinia pestis during the Neolithic Decline." *Cell* 176(1–2), 295–305 (2019).
14. Renfrew, Colin. *Archaeology and Language: The Puzzle of Indo-European Origins*. Jonathan Cape, 1987.
15. Underhill, P.A. et al. "The phylogenetic and geographic structure of Y-chromosome haplogroup R1a." *European Journal of Human Genetics* 23, 124–131 (2015).
16. Wang, C.-C. et al. "Ancient human genome-wide data from a 3000-year interval in the Caucasus corresponds with eco-geographic regions." *Nature Communications* 10, 590 (2019).
17. Zhang, F. et al. "The genomic origins of the Bronze Age Tarim Basin mummies." *Nature* 599, 256–261 (2021).

---

## CROSS-REFERENCE INDEX

| Related Doc | Connection |-------------|-----------| F09 — Pre-Indo-European Substrates | Substrate languages displaced by IE migrations | F27 — Horse and Wheel Domestication | Key technologies enabling steppe mobility | F03 — Bronze Age Trade Networks | Trade routes connecting steppe to Mediterranean | L29 — Ancient DNA and Population Genetics | Genomic methods confirming migration models | C54 — Vedic Traditions | Indo-Aryan branch of IE migrations into South Asia | C55 — Iranian Traditions | Indo-Iranian branch divergence and Avestan parallels | A20 — Hittite and Anatolian Texts | Earliest attested IE language (Anatolian branch) |
