...
- **Göbekli Tepe** (D01) contains non-local obsidian — its builders participated in these networks
...
- **Cross-References:** A01 (Sumerian cuneiform context), E01 (cataclysm parallels)
...
- **Cross-References:** C06 (SE Asian connections), F02 (trans-oceanic contact), A01 (Sumerian texts referencing Meluhha)

---

*F03 — Claude-only source — February 9, 2026*
