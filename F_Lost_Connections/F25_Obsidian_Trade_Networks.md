# F25 — Obsidian Trade Networks: Archaeological Tracers of Ancient Exchange
...
> **Cross-References:** [F03](F03_Bronze_Age_Trade_Networks.md) · [D01](../D_Sites_and_Artifacts/D01_Gobekli_Tepe.md) · D26 · J22 · [F23](F23_Austronesian_Expansion.md) · [F24](F24_Roman_Indian_Ocean_Trade.md) · [E05](../E_Cataclysms_and_Chronology/E05_Radiocarbon_Calibration.md)
...
- **Counter-argument:** Some scholars argue that sea levels were lower and island distances shorter during the late Pleistocene, reducing the required maritime capability. However, even at maximum sea-level lowstand, Melos was never connected to the Greek mainland — some open-water crossing was always required.
...
|---|-------------|----------|--------|---------|
| 1 | Raw obsidian nodule showing conchoidal fracture and glass texture | F25_obsidian_nodule_raw.jpg | Wikimedia Commons | CC BY-SA 4.0 |
| 2 | Obsidian prismatic blade core (Mesoamerican) | F25_obsidian_prismatic_core.jpg | National Museum of Anthropology, Mexico | Fair Use — Academic |
| 3 | Map of Near Eastern obsidian sources and distribution | F25_near_east_obsidian_map.png | Adapted from Renfrew et al. (1966) | Fair Use — Academic |
| 4 | Polished obsidian mirror from Çatalhöyük | F25_catalhoyuk_obsidian_mirror.jpg | Ankara Museum of Anatolian Civilizations | Fair Use — Academic |
| 5 | Portable XRF analysis of obsidian artifact in the field | F25_portable_xrf_obsidian.jpg | UC Berkeley archaeological field photo | Fair Use — Academic |
| 6 | Obsidian fall-off curve diagram (Renfrew model) | F25_obsidian_falloff_curve.png | Adapted from Renfrew (1975) | Fair Use — Academic |
| 7 | Teotihuacán obsidian workshop excavation | F25_teotihuacan_obsidian_workshop.jpg | INAH Mexico | Fair Use — Academic |
| 8 | Green Pachuca obsidian blade (distinctive color) | F25_pachuca_green_obsidian_blade.jpg | Wikimedia Commons | CC BY-SA 3.0 |
| 9 | XRF spectrum comparison — two obsidian sources | F25_xrf_spectrum_comparison.png | IAOS database | Fair Use — Academic |
| 10 | John Dee's Aztec obsidian mirror (British Museum) | F25_dee_obsidian_mirror_british_museum.jpg | British Museum | CC BY-NC-SA 4.0 |

---

## BIBLIOGRAPHY

1. Renfrew, C., Dixon, J. E. & Cann, J. R. (1966). "Obsidian and early cultural contact in the Near East." *Proceedings of the Prehistoric Society*, 32, 30–72. DOI: 10.1017/S0079497X0001433X
2. Renfrew, C. (1975). "Trade as action at a distance: questions of integration and communication." In Sabloff, J. A. & Lamberg-Karlovsky, C. C. (eds.), *Ancient Civilization and Trade*. University of New Mexico Press, 3–59.
3. Carter, T. et al. (2011). "Tepe Telegrams: Göbekli Tepe obsidian." In Schmidt, K. (ed.), *Göbekli Tepe: Preliminary Report*. Deutsches Archäologisches Institut.
4. Cauvin, M.-C. et al. (1998). "L'obsidienne au Proche et Moyen Orient: du volcan à l'outil." *BAR International Series*, 738. Archaeopress.
5. Glascock, M. D. (2002). "Obsidian provenance research in the Americas." *Accounts of Chemical Research*, 35(8), 611–617. DOI: 10.1021/ar010041f
6. Shackley, M. S. (2005). *Obsidian: Geology and Archaeology in the North American Southwest*. University of Arizona Press.
7. Torrence, R. (1986). *Production and Exchange of Stone Tools: Prehistoric Obsidian in the Aegean*. Cambridge University Press.
8. Hirth, K. G. (ed.) (2003). *Mesoamerican Lithic Technology: Experimentation and Interpretation*. University of Utah Press.
9. Tykot, R. H. (1996). "Obsidian procurement and distribution in the central and western Mediterranean." *Journal of Mediterranean Archaeology*, 9(1), 39–82.
10. Perlès, C. (2001). *The Early Neolithic in Greece: The First Farming Communities in Europe*. Cambridge University Press.
11. Cann, J. R. & Renfrew, C. (1964). "The characterization of obsidian and its application to the Mediterranean region." *Proceedings of the Prehistoric Society*, 30, 111–133.
12. Frahm, E. (2012). "Non-destructive sourcing of Bronze Age Near Eastern obsidian artefacts: redeveloping and reassessing electron microprobe analysis for obsidian provenance research." *Archaeometry*, 54(4), 623–642. DOI: 10.1111/j.1475-4754.2011.00647.x
13. Milić, M. (2014). "PXRF characterisation of obsidian from central Anatolia, the Aegean and central Europe." *Journal of Archaeological Science*, 41, 285–296. DOI: 10.1016/j.jas.2013.08.002
14. Clark, J. E. (1987). "Politics, prismatic blades, and Mesoamerican civilization." In Johnson, J. K. & Morrow, C. A. (eds.), *The Organization of Core Technology*. Westview Press, 259–284.
15. Kuzmin, Y. V. (2006). "Recent studies of obsidian exchange networks in prehistoric Northeast Asia." *Bulletin of the Indo-Pacific Prehistory Association*, 26, 61–69.
16. Ikeya, N. (2015). "Maritime transport of obsidian in Japan during the Upper Paleolithic." In Kaifu, Y. et al. (eds.), *Emergence and Diversity of Modern Human Behavior in Paleolithic Asia*. Texas A&M Press, 145–160.
17. Binder, D. et al. (2011). "First evidence of Cappadocian obsidian in the Aegean: a Mesolithic find from Franchthi Cave." *Journal of Greek Archaeology*, 1, 1–14.
18. Braswell, G. E. (ed.) (2003). *The Maya and Teotihuacan: Reinterpreting Early Classic Interaction*. University of Texas Press.
19. Frahm, E. & Feinberg, J. M. (2013). "Environment and collapse: Eastern Anatolian obsidians at Urkesh (Tell Mozan, Syria) and the third-millennium Mesopotamian urban crisis." *Journal of Archaeological Science*, 40(4), 1866–1878. DOI: 10.1016/j.jas.2012.11.017
...
|---|---|---|
| Göbekli Tepe | [D01](../D_Sites_and_Artifacts/D01_Gobekli_Tepe.md) | Obsidian sourcing reveals builder supply networks |
| Çatalhöyük | D26 | Major obsidian processing center — mirrors, blades, workshops |
| Bronze Age trade | [F03](F03_Bronze_Age_Trade_Networks.md) | Obsidian networks preceded and paralleled metal trade routes |
| Lithic technology | J22 | Knapping techniques, prismatic blade production |
| Austronesian expansion | [F23](F23_Austronesian_Expansion.md) | Lapita obsidian trade as expansion tracer |
| Roman trade | [F24](F24_Roman_Indian_Ocean_Trade.md) | Comparison of material provenance analysis methods |
| Radiocarbon dating | [E05](../E_Cataclysms_and_Chronology/E05_Radiocarbon_Calibration.md) | Obsidian hydration dating as complementary chronological tool |
| Sacred geometry | [D10](../D_Sites_and_Artifacts/D10_Sacred_Geometry.md) | Obsidian mirrors and symbolic/reflective properties |
| Mesoamerican traditions | C19 | Tezcatlipoca obsidian mirror deity |
| First Americans | F14 | Obsidian Cliff (Yellowstone) in North American trade |
