# X10 — Personalized and Genomic Medicine
...
> **Cross-References:** [Z39 — Pharmacogenomics](../Z_Molecular_Biology/Z39_Pharmacogenomics_Personalized_Med.md) · [Z45 — Future Genomics](../Z_Molecular_Biology/Z45_Future_Genomics_Personalized.md) · [S01 — Future Technology Overview](../S_Future_Technology/S01_Future_Technology_Overview.md)
...
**Personalized medicine** (also called precision medicine) represents the shift from one-size-fits-all treatment to therapies tailored to an individual's genetic profile, biomarkers, and molecular disease characteristics. This transformation is most advanced in **oncology**, where tumor molecular profiling, targeted therapies (imatinib for BCR-ABL+ CML, trastuzumab for HER2+ breast cancer), and immunotherapies (checkpoint inhibitors, CAR-T cell therapy) have dramatically improved outcomes for specific cancer subtypes. **Pharmacogenomics** — using genetic variants to predict drug response — is now clinically implemented for ~200+ drug-gene pairs (CPIC guidelines), guiding dosing of warfarin, clopidogrel, codeine, and many psychotropic medications. This document focuses on the **clinical frontier and future trajectory** of personalized medicine, complementing the molecular foundations in Z39 and the long-range vision in Z45.
...
1. Collins, F. S. and H. Varmus. "A New Initiative on Precision Medicine." *New England Journal of Medicine*, vol. 372, 2015, pp. 793–795.
2. Druker, B. J. et al. "Five-Year Follow-Up of Patients Receiving Imatinib for Chronic Myeloid Leukemia." *New England Journal of Medicine*, vol. 355, 2006, pp. 2408–2417.
3. Relling, M. V. and W. E. Evans. "Pharmacogenomics in the Clinic." *Nature*, vol. 526, 2015, pp. 343–350.
4. June, C. H. et al. "CAR T Cell Immunotherapy for Human Cancer." *Science*, vol. 359, 2018, pp. 1361–1365.
5. Frangoul, H. et al. "CRISPR-Cas9 Gene Editing for Sickle Cell Disease and β-Thalassemia." *New England Journal of Medicine*, vol. 384, 2021, pp. 252–260.
...
|-------------|-----------|
| [Z39 — Pharmacogenomics](../Z_Molecular_Biology/Z39_Pharmacogenomics_Personalized_Med.md) | Molecular foundations of pharmacogenomics |
| [Z45 — Future Genomics](../Z_Molecular_Biology/Z45_Future_Genomics_Personalized.md) | Long-range genomic medicine vision |
| [X02 — Ayurveda](X02_Ayurveda_Indian_Medicine.md) | Dosha typing as historical precursor to personalized medicine |
| [S01 — Future Technology](../S_Future_Technology/S01_Future_Technology_Overview.md) | AI and biotechnology convergence |
| [X11 — Medical Ethics](X11_Medical_Ethics_Tuskegee_Helsinki.md) | Ethics of genetic privacy, equity, and germline editing |
| [L01 — Genetics Origins](../L_Genetics_Origins/L01_Genetics_Origins_Overview.md) | Genetic foundations underlying personalized medicine |
