# V33 — Mathematical Optimization: Linear Programming, Convex Methods, and Gradient Descent
...
> **Cross-References:** [V23 — Linear Algebra](V23_Linear_Algebra_Matrices_Transformations.md) · [ZD09 — Computational Complexity](V37_Computational_Complexity_P_NP.md) · [V24 — Differential Equations](V24_Differential_Equations_Modeling_Change.md) · [ZD06 — Game Theory](../ZD_Information_Computation/ZD06_Game_Theory_Strategy.md) · S01 — AI Overview
...
5. Robbins, H. and Monro, S. "A Stochastic Approximation Method." *Annals of Mathematical Statistics*, vol. 22, 1951, pp. 400–407.
...
9. Belkin, M. et al. "Reconciling Modern Machine-Learning Practice and the Classical Bias-Variance Trade-Off." *Proceedings of the National Academy of Sciences*, vol. 116, 2019, pp. 15849–15854.
...
|-------------|-----------|
| [V23 — Linear Algebra](V23_Linear_Algebra_Matrices_Transformations.md) | LP and QP formulated in matrix-vector notation; eigenvalue problems central to SDP |
| [ZD09 — Computational Complexity](V37_Computational_Complexity_P_NP.md) | LP is in P; integer programming is NP-hard; approximation algorithms bridge theory and practice |
| [ZD06 — Game Theory](../ZD_Information_Computation/ZD06_Game_Theory_Strategy.md) | LP duality connected to minimax theorem; Nash equilibria found via complementarity programming |
| S01 — AI Overview | SGD and Adam are the computational engines of modern neural network training |
| [V24 — Differential Equations](V24_Differential_Equations_Modeling_Change.md) | Optimal control theory (Pontryagin's maximum principle) links differential equations with optimization |
