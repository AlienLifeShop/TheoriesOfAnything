# V54 — Origami Mathematics and Paper Folding
...
> **Cross-References:** [V10 — Geometry](V10_Geometry_Euclid_NonEuclidean.md) · [V48 — Ancient Greek Mathematics](V48_Ancient_Greek_Mathematics.md) · [V08 — History of Algebra](V08_History_of_Algebra.md) · S05 — Advanced Manufacturing · [V20 — Mathematical Proof](V20_Mathematical_Proof.md)
...
1. Demaine, E. D., & O'Rourke, J. (2007). *Geometric Folding Algorithms: Linkages, Origami, Polyhedra*. Cambridge University Press.
2. Lang, R. J. (2003). *Origami Design Secrets: Mathematical Methods for an Ancient Art*. A K Peters.
...
6. Huzita, H. (1992). "Understanding Geometry through Origami Axioms." In *Proceedings of the 1st International Conference on Origami in Science, Mathematics, and Education* (pp. 215–222).
7. Tachi, T. (2009). "Origamizing Polyhedral Surfaces." *IEEE Transactions on Visualization and Computer Graphics*, 16(2), 298–311.
...
9. Miura, K. (1985). "Method of Packaging and Deployment of Large Membranes in Space." *Proceedings of the 31st Congress of the International Astronautical Federation*, IAF-80-A31.
...
- **[V10 — Geometry](V10_Geometry_Euclid_NonEuclidean.md):** Geometric constructions — origami extends Euclidean constructibility
- **[V48 — Ancient Greek Mathematics](V48_Ancient_Greek_Mathematics.md):** Three classical problems solved by origami but not compass/straightedge
- **[V08 — History of Algebra](V08_History_of_Algebra.md):** Cubic equations — algebraic power of origami folds
- **[ZD09 — Computational Complexity](V37_Computational_Complexity_P_NP.md):** NP-completeness of flat foldability
- **[V43 — Galois Theory](V43_Galois_Theory_Field_Extensions.md):** Algebraic characterization of constructible numbers
- **[V25 — Topology](V25_Topology_Shape_Continuity_Invariants.md):** Topological aspects of folding and cut problems
