# V30 — Category Theory: The Mathematics of Mathematical Structure
...
> **Cross-References:** [V29 — Set Theory](V29_Set_Theory_Foundations_Infinity.md) · [V25 — Topology](V25_Topology_Shape_Continuity_Invariants.md) · [V23 — Linear Algebra](V23_Linear_Algebra_Matrices_Transformations.md) · [V22 — Number Theory](V22_Number_Theory_Primes_Patterns.md) · [ZA06 — Quantum Entanglement](../ZA_Physics_Quantum/ZA06_Quantum_Entanglement_Nonlocality.md)
...
2. Eilenberg, S. and Mac Lane, S. "General Theory of Natural Equivalences." *Transactions of the American Mathematical Society*, vol. 58, 1945, pp. 231–294.
3. Awodey, S. *Category Theory.* 2nd ed., Oxford University Press, 2010.
4. Riehl, E. *Category Theory in Context.* Dover, 2016.
5. Grothendieck, A. and Dieudonné, J. "Éléments de géométrie algébrique." *Publications Mathématiques de l'IHÉS*, various volumes, 1960–1967.
6. Lurie, J. *Higher Topos Theory.* Annals of Mathematics Studies, Princeton University Press, 2009.
7. Moggi, E. "Notions of Computation and Monads." *Information and Computation*, vol. 93, 1991, pp. 55–92.
...
|-------------|-----------|
| [V29 — Set Theory](V29_Set_Theory_Foundations_Infinity.md) | Category theory as alternative foundation to ZFC set theory |
| [V25 — Topology](V25_Topology_Shape_Continuity_Invariants.md) | Algebraic topology expressed naturally in categorical language — functors from topology to algebra |
| [V23 — Linear Algebra](V23_Linear_Algebra_Matrices_Transformations.md) | Vect is a key example category; linear maps are morphisms |
| [V22 — Number Theory](V22_Number_Theory_Primes_Patterns.md) | Langlands program uses categorical framework — Galois representations as functors |
| [ZA06 — Quantum Entanglement](../ZA_Physics_Quantum/ZA06_Quantum_Entanglement_Nonlocality.md) | Categorical quantum mechanics (Abramsky-Coecke) uses monoidal categories |
