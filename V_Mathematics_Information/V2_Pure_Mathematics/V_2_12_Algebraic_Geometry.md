...
> **Cross-References:** [V_2_02 — Topology](../../V_Mathematics_Information/V2_Pure_Mathematics/V_2_02_Topology_Knot_Theory.md) · [V_2_09 — Number Theory](V_2_09_Number_Theory_Primes_Patterns.md) · [V_2_11 — Abstract Algebra](V_2_11_Abstract_Algebra_Groups_Rings_Fields.md) · [V_2_10 — Category Theory](V_2_10_Category_Theory_Mathematical_Structure.md) · [ZA_2_04 — Loop Quantum Gravity](../../ZA_Physics_Quantum/ZA2_Gravity_Spacetime_Cosmology/ZA_2_04_Loop_Quantum_Gravity.md)
...
1. Hartshorne, R. *Algebraic Geometry*. Springer, 1977. ISBN: 9780534931933
2. Grothendieck, A. and Dieudonné, J. *Éléments de Géométrie Algébrique (EGA)*. Publications Mathématiques de l'IHÉS, 1960–1967. DOI: 10.1007/bf02684778
3. Deligne, P. "La Conjecture de Weil: I." *Publications Mathématiques de l'IHÉS*, vol. 43, 1974, pp. 273–307. DOI: 10.1007/bf02684373.
4. Wiles, A. "Modular Elliptic Curves and Fermat's Last Theorem." *Annals of Mathematics*, vol. 141, 1995, pp. 443–551. DOI: 10.2307/2118559.
5. Mori, S. "Flip Theorem and the Existence of Minimal Models for 3-Folds." *Journal of the American Mathematical Society*, vol. 1, 1988, pp. 117–253. DOI: 10.2307/1990969
6. Candelas, P. et al. "A Pair of Calabi-Yau Manifolds as an Exactly Soluble Superconformal Theory." *Nuclear Physics B*, vol. 359, 1991, pp. 21–74. DOI: 10.1016/0550-3213(91)90292-6.
...
|-------------|-----------|
| [V_2_02 — Topology](../../V_Mathematics_Information/V2_Pure_Mathematics/V_2_02_Topology_Knot_Theory.md) | Algebraic geometry uses topological invariants (genus, cohomology, fundamental group) to classify varieties |
| [V_2_09 — Number Theory](V_2_09_Number_Theory_Primes_Patterns.md) | Arithmetic algebraic geometry connects varieties over number fields to prime distribution and Diophantine equations |
| [V_2_11 — Abstract Algebra](V_2_11_Abstract_Algebra_Groups_Rings_Fields.md) | Varieties are defined over fields; schemes are built from commutative rings; Galois theory connects to algebraic geometry |
| [V_2_10 — Category Theory](V_2_10_Category_Theory_Mathematical_Structure.md) | Grothendieck's revolution used category theory (sheaves, functors, derived categories) as the foundational language |
| [ZA_2_04 — Loop Quantum Gravity](../../ZA_Physics_Quantum/ZA2_Gravity_Spacetime_Cosmology/ZA_2_04_Loop_Quantum_Gravity.md) | Calabi-Yau compactification in string theory provides the physical motivation for much algebraic geometry research |
