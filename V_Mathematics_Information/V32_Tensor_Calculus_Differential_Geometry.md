# V32 — Tensor Calculus and Differential Geometry: The Mathematics of Curved Spaces
...
> **Cross-References:** [V25 — Topology](V25_Topology_Shape_Continuity_Invariants.md) · [V23 — Linear Algebra](V23_Linear_Algebra_Matrices_Transformations.md) · [ZA08 — General Relativity](../ZA_Physics_Quantum/ZA08_General_Special_Relativity.md) · ZA03 — String Theory · [V24 — Differential Equations](V24_Differential_Equations_Modeling_Change.md)
...
1. Riemann, B. "Über die Hypothesen, welche der Geometrie zu Grunde liegen." *Abhandlungen der Königlichen Gesellschaft der Wissenschaften zu Göttingen*, vol. 13, 1868 (lecture delivered 1854).
2. Einstein, A. "Die Feldgleichungen der Gravitation." *Sitzungsberichte der Preussischen Akademie der Wissenschaften zu Berlin*, 1915, pp. 844–847.
3. Carroll, S. M. *Spacetime and Geometry: An Introduction to General Relativity.* Cambridge University Press, 2019.
...
9. Schutz, B. F. *Geometrical Methods of Mathematical Physics.* Cambridge University Press, 1980.
...
|-------------|-----------|
| [ZA08 — General Relativity](../ZA_Physics_Quantum/ZA08_General_Special_Relativity.md) | Einstein's GR is written entirely in the language of tensor calculus and Riemannian geometry |
| [V25 — Topology](V25_Topology_Shape_Continuity_Invariants.md) | Manifolds are topological spaces with smooth structure; differential topology studies smooth invariants |
| [V23 — Linear Algebra](V23_Linear_Algebra_Matrices_Transformations.md) | Tensors generalize vectors and matrices; tangent spaces are vector spaces |
| ZA03 — String Theory | Calabi-Yau manifolds and higher-dimensional Riemannian geometry central to string compactification |
| [V24 — Differential Equations](V24_Differential_Equations_Modeling_Change.md) | Ricci flow, geodesic equation, and Einstein's equations are PDEs on manifolds |
