# V27 — Fractal Geometry: Self-Similarity Across Scales
...
> **Cross-References:** [V24 — Differential Equations](V24_Differential_Equations_Modeling_Change.md) · [V25 — Topology](V25_Topology_Shape_Continuity_Invariants.md) · V01 — Sacred Geometry · O08 — Earth Grid · [Q13 — Cosmic Inflation](../Q_Cosmology_Physics/Q13_Cosmic_Inflation_First_Second.md)
...
2. Mandelbrot, B. B. "How Long Is the Coast of Britain? Statistical Self-Similarity and Fractional Dimension." *Science*, vol. 156, 1967, pp. 636–638.
3. Douady, A. and Hubbard, J. H. "Itération des polynômes quadratiques complexes." *Comptes Rendus de l'Académie des Sciences*, vol. 294, 1982, pp. 123–126.
4. Shishikura, M. "The Hausdorff Dimension of the Boundary of the Mandelbrot Set and Julia Sets." *Annals of Mathematics*, vol. 147, 1998, pp. 225–267.
5. Barnsley, M. F. *Fractals Everywhere.* 2nd ed., Academic Press, 1993.
6. Falconer, K. *Fractal Geometry: Mathematical Foundations and Applications.* 3rd ed., Wiley, 2014.
...
|-------------|-----------|
| [V24 — Differential Equations](V24_Differential_Equations_Modeling_Change.md) | Chaotic differential equations produce fractal strange attractors (Lorenz, Rössler) |
| [V25 — Topology](V25_Topology_Shape_Continuity_Invariants.md) | Fractal dimension extends topological dimension to non-integer values |
| V01 — Sacred Geometry | Self-similar patterns in nature vs. mystical geometry claims |
| [Q13 — Cosmic Inflation](../Q_Cosmology_Physics/Q13_Cosmic_Inflation_First_Second.md) | Galaxy clustering shows fractal structure at scales below ~100 Mpc |
| O08 — Earth Grid | Fractal geometry in natural terrain vs. claimed geometric patterns |
