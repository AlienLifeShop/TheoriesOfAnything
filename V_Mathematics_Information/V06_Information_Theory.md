# V06 — Information Theory — Shannon, Entropy, and the Bit
...
> **Cross-References:** [V07](V07_Cryptography.md) · [V03](V03_Algorithms_Computation_Limits.md) · [Q21](../Q_Cosmology_Physics/Q21_Standard_Model_Particle_Physics.md) · [K31](../K_Consciousness/K31_Machine_Consciousness_AI_Awareness.md) · [G26](../G_Modern_Frameworks/G26_Chaos_Theory_Fractals_Nonlinear_Dynamics.md)
...
8. Bérut, A., et al. (2012). "Experimental verification of Landauer's principle linking information and thermodynamics." *Nature*, 483, 187-189.
9. Wheeler, J. A. (1990). "Information, Physics, Quantum: The Search for Links." In W. H. Zurek (ed.), *Complexity, Entropy, and the Physics of Information*. Addison-Wesley.
...
|-------------|-----------|
| [V07 — Cryptography](V07_Cryptography.md) | Shannon's secrecy theory and information-theoretic security |
| [V03 — Algorithms and Computation](V03_Algorithms_Computation_Limits.md) | Kolmogorov complexity and computability theory |
| [Q21 — Standard Model](../Q_Cosmology_Physics/Q21_Standard_Model_Particle_Physics.md) | Quantum information and fundamental physics |
| [K31 — Machine Consciousness](../K_Consciousness/K31_Machine_Consciousness_AI_Awareness.md) | IIT and computational theories of mind |
| [G26 — Chaos Theory](../G_Modern_Frameworks/G26_Chaos_Theory_Fractals_Nonlinear_Dynamics.md) | Entropy, predictability, and dynamical systems |
| [V04 — Infinity and Paradoxes](V04_Infinity_Paradoxes_Mathematical_Philosophy.md) | Information content of infinite sets |
