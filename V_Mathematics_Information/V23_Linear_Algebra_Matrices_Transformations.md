# V23 — Linear Algebra: Matrices, Vectors, and Transformations
...
> **Cross-References:** [V22 — Number Theory](V22_Number_Theory_Primes_Patterns.md) · V08 — Information Theory · [ZA06 — Quantum Entanglement](../ZA_Physics_Quantum/ZA06_Quantum_Entanglement_Nonlocality.md) · [ZA07 — Standard Model](../ZA_Physics_Quantum/ZA07_Standard_Model_Particle_Physics.md) · S07 — Artificial Intelligence
...
1. Strang, G. *Linear Algebra and Its Applications.* 4th ed., Cengage Learning, 2006.
2. Halmos, P. R. *Finite-Dimensional Vector Spaces.* 2nd ed., Springer, 1958.
3. Golub, G. H. and Van Loan, C. F. *Matrix Computations.* 4th ed., Johns Hopkins University Press, 2013.
4. Strassen, V. "Gaussian Elimination Is Not Optimal." *Numerische Mathematik*, vol. 13, 1969, pp. 354–356.
5. Hotelling, H. "Analysis of a Complex of Statistical Variables into Principal Components." *Journal of Educational Psychology*, vol. 24, 1933, pp. 417–441.
6. Eckart, C. and Young, G. "The Approximation of One Matrix by Another of Lower Rank." *Psychometrika*, vol. 1, 1936, pp. 211–218.
...
|-------------|-----------|
| [V22 — Number Theory](V22_Number_Theory_Primes_Patterns.md) | Algebraic number theory uses linear algebra over number fields |
| [ZA06 — Quantum Entanglement](../ZA_Physics_Quantum/ZA06_Quantum_Entanglement_Nonlocality.md) | Quantum states are vectors in Hilbert space; entanglement is tensor product structure |
| [ZA07 — Standard Model](../ZA_Physics_Quantum/ZA07_Standard_Model_Particle_Physics.md) | Particle physics uses representation theory of Lie groups — linear algebra on symmetry groups |
| S07 — AI/ML | Modern AI is built on matrix operations — neural networks, attention, PCA |
| V08 — Information Theory | Channel capacity involves eigenvalue analysis of channel matrices |
