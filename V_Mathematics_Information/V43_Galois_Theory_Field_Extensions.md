# V43 — Galois Theory and Field Extensions
...
> **Cross-References:** V02 — Abstract Algebra · V01 — Number Theory · [V52 — Unsolved Problems](V52_Unsolved_Problems_Mathematics.md) · [V48 — Ancient Greek Math](V48_Ancient_Greek_Mathematics.md) · [ZA39 — Unification Physics](../ZA_Physics_Quantum/ZA39_Unification_Physics_Theory_of_Everything.md)
...
1. Artin, E. (1942). "Galois Theory." *Notre Dame Mathematical Lectures*, No. 2. University of Notre Dame.
2. Stewart, I. (2015). *Galois Theory*, 4th ed. CRC Press.
3. Edwards, H. M. (1984). *Galois Theory*. Springer-Verlag.
4. Tignol, J.-P. (2016). *Galois' Theory of Algebraic Equations*, 2nd ed. World Scientific.
5. Abel, N. H. (1824). "Mémoire sur les équations algébriques." Christiania.
6. Galois, É. (1846). "Mémoire sur les conditions de résolubilité des équations par radicaux." *Journal de Mathématiques Pures et Appliquées*, 11, 417–433. (Posthumous publication by Liouville.)
7. Cox, D. A. (2012). *Galois Theory*, 2nd ed. Wiley.
8. Rotman, J. J. (1998). *Galois Theory*, 2nd ed. Springer.
9. Serre, J.-P. (2008). *Topics in Galois Theory*, 2nd ed. A K Peters.
...
- **V02 — Abstract Algebra:** Group theory foundations essential for Galois theory
- **V01 — Number Theory:** Number-theoretic applications of Galois groups
- **[V48 — Ancient Greek Mathematics](V48_Ancient_Greek_Mathematics.md):** Classical construction problems resolved by Galois theory
- **[V52 — Unsolved Problems](V52_Unsolved_Problems_Mathematics.md):** Inverse Galois problem and related open questions
- **[ZA39 — Unification Physics](../ZA_Physics_Quantum/ZA39_Unification_Physics_Theory_of_Everything.md):** Symmetry group concepts in physics parallel Galois symmetry
- **V11 — Algebraic Geometry:** Étale cohomology and Galois actions in algebraic geometry
