...
> **Cross-References:** [V_2_04 — Geometry](../V2_Pure_Mathematics/V_2_04_Geometry_Euclid_NonEuclidean.md) · [V_2_05 — Calculus](../V2_Pure_Mathematics/V_2_05_Calculus_Infinitesimals.md) · [V_2_08 — Mathematical Proof](../V2_Pure_Mathematics/V_2_08_Mathematical_Proof.md) · [V_1_09 — Egyptian Babylonian Mathematics](V_1_09_Egyptian_Babylonian_Mathematics.md) · [A_2_05 — Hermetic Tradition](../../A_Foundations/A2_Biblical_Gnostic_Western_Esoteric/A_2_05_Hermetic_Tradition.md)
...
1. Heath, T. L. (1921). *A History of Greek Mathematics*. 2 vols. Oxford University Press. [Reprint: Dover, 1981]. DOI: 10.1017/s0009840x0004169x
2. Euclid. (c. 300 BCE). *The Thirteen Books of Euclid's Elements*. Trans. T. L. Heath. Cambridge University Press, 1908. [Reprint: Dover, 1956]. DOI: 10.2307/3603363
...
4. Fried, M. N., & Unguru, S. (2001). *Apollonius of Perga's Conica: Text, Context, Subtext*. Brill. DOI: 10.1163/9789004350991
...
- **[V_2_04 — Geometry](../V2_Pure_Mathematics/V_2_04_Geometry_Euclid_NonEuclidean.md):** Euclidean axioms and non-Euclidean descendants
- **[V_2_05 — Calculus](../V2_Pure_Mathematics/V_2_05_Calculus_Infinitesimals.md):** Method of exhaustion as precursor to integral calculus
- **[V_2_08 — Mathematical Proof](../V2_Pure_Mathematics/V_2_08_Mathematical_Proof.md):** Greek invention of deductive proof as mathematical standard
- **[V_1_09 — Egyptian Babylonian Mathematics](V_1_09_Egyptian_Babylonian_Mathematics.md):** Prior mathematical traditions that influenced Greek work
- **[V_2_09 — Number Theory](../V2_Pure_Mathematics/V_2_09_Number_Theory_Primes_Patterns.md):** Prime number results from Euclid through Diophantus
- **[V_1_04 — Sacred Geometry](V_1_04_Sacred_Geometry_Mathematical_Patterns.md):** Platonic solids and geometric mysticism
